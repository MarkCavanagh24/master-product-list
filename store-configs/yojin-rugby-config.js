// Configuration for Yojin Rugby
// Store ID: 6855423c21bb01b10405e6d5
// Location: Rugby, CV22 5QD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423c21bb01b10405e6d5',
    storeName: 'Yojin Rugby',
    city: 'Rugby',
    postcode: 'CV22 5QD',
...
// Product API Service for Yojin Rugby
class YojinRugbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rugby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRugbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRugbyProductService };
