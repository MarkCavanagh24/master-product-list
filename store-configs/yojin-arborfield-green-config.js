// Configuration for Yojin Arborfield Green
// Store ID: 6855428921bb01b10405e7eb
// Location: Arborfield Green, RG2 9QY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428921bb01b10405e7eb',
    storeName: 'Yojin Arborfield Green',
    city: 'Arborfield Green',
    postcode: 'RG2 9QY',
...
// Product API Service for Yojin Arborfield Green
class YojinArborfieldGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Arborfield Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinArborfieldGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinArborfieldGreenProductService };
