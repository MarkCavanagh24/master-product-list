// Configuration for Yojin Wychbold
// Store ID: 6855427e21bb01b10405e7c4
// Location: Wychbold, B61 7ER

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427e21bb01b10405e7c4',
    storeName: 'Yojin Wychbold',
    city: 'Wychbold',
    postcode: 'B61 7ER',
...
// Product API Service for Yojin Wychbold
class YojinWychboldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wychbold:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWychboldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWychboldProductService };
