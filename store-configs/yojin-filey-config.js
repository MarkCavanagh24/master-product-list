// Configuration for Yojin Filey
// Store ID: 6855426a21bb01b10405e77b
// Location: Filey, YO14 9QW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426a21bb01b10405e77b',
    storeName: 'Yojin Filey',
    city: 'Filey',
    postcode: 'YO14 9QW',
...
// Product API Service for Yojin Filey
class YojinFileyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Filey:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFileyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFileyProductService };
