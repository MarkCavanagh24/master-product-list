// Configuration for Yojin Catworth
// Store ID: 6855427621bb01b10405e7a8
// Location: Catworth, PE28 0PD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427621bb01b10405e7a8',
    storeName: 'Yojin Catworth',
    city: 'Catworth',
    postcode: 'PE28 0PD',
...
// Product API Service for Yojin Catworth
class YojinCatworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Catworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCatworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCatworthProductService };
