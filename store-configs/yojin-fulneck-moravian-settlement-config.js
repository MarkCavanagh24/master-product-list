// Configuration for Yojin Fulneck Moravian Settlement
// Store ID: 685541c321bb01b10405e519
// Location: Fulneck Moravian Settlement, LS28 8DU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c321bb01b10405e519',
    storeName: 'Yojin Fulneck Moravian Settlement',
    city: 'Fulneck Moravian Settlement',
    postcode: 'LS28 8DU',
...
// Product API Service for Yojin Fulneck Moravian Settlement
class YojinFulneckMoravianSettlementProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fulneck Moravian Settlement:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFulneckMoravianSettlementProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFulneckMoravianSettlementProductService };
