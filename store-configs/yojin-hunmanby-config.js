// Configuration for Yojin Hunmanby
// Store ID: 6855426a21bb01b10405e77a
// Location: Hunmanby, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426a21bb01b10405e77a',
    storeName: 'Yojin Hunmanby',
    city: 'Hunmanby',
    postcode: 'N/A',
...
// Product API Service for Yojin Hunmanby
class YojinHunmanbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hunmanby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHunmanbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHunmanbyProductService };
