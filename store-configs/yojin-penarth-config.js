// Configuration for Yojin Penarth
// Store ID: 6855424321bb01b10405e6eb
// Location: Penarth, CF64 3WX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424321bb01b10405e6eb',
    storeName: 'Yojin Penarth',
    city: 'Penarth',
    postcode: 'CF64 3WX',
...
// Product API Service for Yojin Penarth
class YojinPenarthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Penarth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPenarthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPenarthProductService };
