// Configuration for Yojin Giggleswick
// Store ID: 6855427421bb01b10405e7a2
// Location: Giggleswick, BD24 0AJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427421bb01b10405e7a2',
    storeName: 'Yojin Giggleswick',
    city: 'Giggleswick',
    postcode: 'BD24 0AJ',
...
// Product API Service for Yojin Giggleswick
class YojinGiggleswickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Giggleswick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGiggleswickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGiggleswickProductService };
