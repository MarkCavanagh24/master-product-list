// Configuration for Yojin Asenby
// Store ID: 6855423021bb01b10405e6a7
// Location: Asenby, YO7 3QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423021bb01b10405e6a7',
    storeName: 'Yojin Asenby',
    city: 'Asenby',
    postcode: 'YO7 3QT',
...
// Product API Service for Yojin Asenby
class YojinAsenbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Asenby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAsenbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAsenbyProductService };
