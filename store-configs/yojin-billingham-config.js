// Configuration for Yojin Billingham
// Store ID: 685541ab21bb01b10405e4c0
// Location: Billingham, TS22 5RN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ab21bb01b10405e4c0',
    storeName: 'Yojin Billingham',
    city: 'Billingham',
    postcode: 'TS22 5RN',
...
// Product API Service for Yojin Billingham
class YojinBillinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Billingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBillinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBillinghamProductService };
