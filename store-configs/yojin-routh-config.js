// Configuration for Yojin Routh
// Store ID: 685541b821bb01b10405e4f2
// Location: Routh, HU17 9SN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b821bb01b10405e4f2',
    storeName: 'Yojin Routh',
    city: 'Routh',
    postcode: 'HU17 9SN',
...
// Product API Service for Yojin Routh
class YojinRouthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Routh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRouthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRouthProductService };
