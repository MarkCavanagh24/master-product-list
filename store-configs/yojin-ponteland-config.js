// Configuration for Yojin Ponteland
// Store ID: 6855419921bb01b10405e47f
// Location: Ponteland, NE20 9HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419921bb01b10405e47f',
    storeName: 'Yojin Ponteland',
    city: 'Ponteland',
    postcode: 'NE20 9HU',
...
// Product API Service for Yojin Ponteland
class YojinPontelandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ponteland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPontelandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPontelandProductService };
