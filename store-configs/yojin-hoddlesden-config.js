// Configuration for Yojin Hoddlesden
// Store ID: 6855421421bb01b10405e63c
// Location: Hoddlesden, BB3 3QD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421421bb01b10405e63c',
    storeName: 'Yojin Hoddlesden',
    city: 'Hoddlesden',
    postcode: 'BB3 3QD',
...
// Product API Service for Yojin Hoddlesden
class YojinHoddlesdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hoddlesden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHoddlesdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHoddlesdenProductService };
