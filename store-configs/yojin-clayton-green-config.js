// Configuration for Yojin Clayton Green
// Store ID: 6855421321bb01b10405e63a
// Location: Clayton Green, PR6 7QE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421321bb01b10405e63a',
    storeName: 'Yojin Clayton Green',
    city: 'Clayton Green',
    postcode: 'PR6 7QE',
...
// Product API Service for Yojin Clayton Green
class YojinClaytonGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clayton Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClaytonGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClaytonGreenProductService };
