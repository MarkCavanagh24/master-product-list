// Configuration for Yojin Perivale
// Store ID: 685541f021bb01b10405e5bd
// Location: Perivale, W5 1TA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f021bb01b10405e5bd',
    storeName: 'Yojin Perivale',
    city: 'Perivale',
    postcode: 'W5 1TA',
...
// Product API Service for Yojin Perivale
class YojinPerivaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Perivale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPerivaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPerivaleProductService };
