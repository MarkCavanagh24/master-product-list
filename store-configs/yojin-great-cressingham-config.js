// Configuration for Yojin Great Cressingham
// Store ID: 685541c521bb01b10405e520
// Location: Great Cressingham, IP25 6NR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c521bb01b10405e520',
    storeName: 'Yojin Great Cressingham',
    city: 'Great Cressingham',
    postcode: 'IP25 6NR',
...
// Product API Service for Yojin Great Cressingham
class YojinGreatCressinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Cressingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatCressinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatCressinghamProductService };
