// Configuration for Yojin Ramsey Forty Foot
// Store ID: 6855422021bb01b10405e66a
// Location: Ramsey Forty Foot, PE26 2XL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422021bb01b10405e66a',
    storeName: 'Yojin Ramsey Forty Foot',
    city: 'Ramsey Forty Foot',
    postcode: 'PE26 2XL',
...
// Product API Service for Yojin Ramsey Forty Foot
class YojinRamseyFortyFootProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ramsey Forty Foot:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRamseyFortyFootProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRamseyFortyFootProductService };
