// Configuration for Yojin Beanacre
// Store ID: 6855428721bb01b10405e7e2
// Location: Beanacre, SN12 7JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428721bb01b10405e7e2',
    storeName: 'Yojin Beanacre',
    city: 'Beanacre',
    postcode: 'SN12 7JB',
...
// Product API Service for Yojin Beanacre
class YojinBeanacreProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Beanacre:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBeanacreProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBeanacreProductService };
