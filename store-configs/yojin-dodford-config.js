// Configuration for Yojin Dodford
// Store ID: 6855423921bb01b10405e6c9
// Location: Dodford, B61 9AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423921bb01b10405e6c9',
    storeName: 'Yojin Dodford',
    city: 'Dodford',
    postcode: 'B61 9AP',
...
// Product API Service for Yojin Dodford
class YojinDodfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dodford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDodfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDodfordProductService };
