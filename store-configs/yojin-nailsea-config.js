// Configuration for Yojin Nailsea
// Store ID: 6855424321bb01b10405e6ed
// Location: Nailsea, BS48 2BH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424321bb01b10405e6ed',
    storeName: 'Yojin Nailsea',
    city: 'Nailsea',
    postcode: 'BS48 2BH',
...
// Product API Service for Yojin Nailsea
class YojinNailseaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Nailsea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNailseaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNailseaProductService };
