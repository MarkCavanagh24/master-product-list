// Configuration for Yojin Preston-under-Scar
// Store ID: 685541da21bb01b10405e56f
// Location: Preston-under-Scar, DL8 4AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541da21bb01b10405e56f',
    storeName: 'Yojin Preston-under-Scar',
    city: 'Preston-under-Scar',
    postcode: 'DL8 4AT',
...
// Product API Service for Yojin Preston-under-Scar
class YojinPrestonunderScarProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Preston-under-Scar:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPrestonunderScarProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPrestonunderScarProductService };
