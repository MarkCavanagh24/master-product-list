// Configuration for Yojin Wortley
// Store ID: 6855420921bb01b10405e614
// Location: Wortley, LS12 4PX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420921bb01b10405e614',
    storeName: 'Yojin Wortley',
    city: 'Wortley',
    postcode: 'LS12 4PX',
...
// Product API Service for Yojin Wortley
class YojinWortleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wortley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWortleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWortleyProductService };
