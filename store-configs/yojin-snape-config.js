// Configuration for Yojin Snape
// Store ID: 6855422721bb01b10405e684
// Location: Snape, DL8 2PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422721bb01b10405e684',
    storeName: 'Yojin Snape',
    city: 'Snape',
    postcode: 'DL8 2PR',
...
// Product API Service for Yojin Snape
class YojinSnapeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Snape:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSnapeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSnapeProductService };
