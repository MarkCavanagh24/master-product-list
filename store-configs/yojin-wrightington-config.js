// Configuration for Yojin Wrightington
// Store ID: 6855426321bb01b10405e762
// Location: Wrightington, WN6 9PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426321bb01b10405e762',
    storeName: 'Yojin Wrightington',
    city: 'Wrightington',
    postcode: 'WN6 9PR',
...
// Product API Service for Yojin Wrightington
class YojinWrightingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrightington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWrightingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWrightingtonProductService };
