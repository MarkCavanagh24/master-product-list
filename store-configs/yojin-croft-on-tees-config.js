// Configuration for Yojin Croft-on-Tees
// Store ID: 685541d221bb01b10405e54d
// Location: Croft-on-Tees, DL2 2TQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d221bb01b10405e54d',
    storeName: 'Yojin Croft-on-Tees',
    city: 'Croft-on-Tees',
    postcode: 'DL2 2TQ',
...
// Product API Service for Yojin Croft-on-Tees
class YojinCroftonTeesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Croft-on-Tees:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCroftonTeesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCroftonTeesProductService };
