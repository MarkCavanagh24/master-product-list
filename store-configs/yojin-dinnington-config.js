// Configuration for Yojin Dinnington
// Store ID: 6855419a21bb01b10405e480
// Location: Dinnington, NE13 8BZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419a21bb01b10405e480',
    storeName: 'Yojin Dinnington',
    city: 'Dinnington',
    postcode: 'NE13 8BZ',
...
// Product API Service for Yojin Dinnington
class YojinDinningtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dinnington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDinningtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDinningtonProductService };
