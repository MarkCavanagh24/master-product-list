// Configuration for Yojin Jacobs Well
// Store ID: 6855424f21bb01b10405e716
// Location: Jacobs Well, GU1 1SD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424f21bb01b10405e716',
    storeName: 'Yojin Jacobs Well',
    city: 'Jacobs Well',
    postcode: 'GU1 1SD',
...
// Product API Service for Yojin Jacobs Well
class YojinJacobsWellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Jacobs Well:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinJacobsWellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinJacobsWellProductService };
