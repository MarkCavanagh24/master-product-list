// Configuration for Yojin Silsden
// Store ID: 685541a421bb01b10405e4a6
// Location: Silsden, BD20 0BU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a421bb01b10405e4a6',
    storeName: 'Yojin Silsden',
    city: 'Silsden',
    postcode: 'BD20 0BU',
...
// Product API Service for Yojin Silsden
class YojinSilsdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Silsden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSilsdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSilsdenProductService };
