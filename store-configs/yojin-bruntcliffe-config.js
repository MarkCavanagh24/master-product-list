// Configuration for Yojin Bruntcliffe
// Store ID: 6855420f21bb01b10405e62d
// Location: Bruntcliffe, LS27 0RF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420f21bb01b10405e62d',
    storeName: 'Yojin Bruntcliffe',
    city: 'Bruntcliffe',
    postcode: 'LS27 0RF',
...
// Product API Service for Yojin Bruntcliffe
class YojinBruntcliffeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bruntcliffe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBruntcliffeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBruntcliffeProductService };
