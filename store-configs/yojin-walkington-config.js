// Configuration for Yojin Walkington
// Store ID: 685541be21bb01b10405e508
// Location: Walkington, HU17 8RU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541be21bb01b10405e508',
    storeName: 'Yojin Walkington',
    city: 'Walkington',
    postcode: 'HU17 8RU',
...
// Product API Service for Yojin Walkington
class YojinWalkingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walkington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWalkingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWalkingtonProductService };
