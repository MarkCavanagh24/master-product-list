// Configuration for Yojin Church Brough
// Store ID: 685541b121bb01b10405e4d7
// Location: Church Brough, CA17 4DE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b121bb01b10405e4d7',
    storeName: 'Yojin Church Brough',
    city: 'Church Brough',
    postcode: 'CA17 4DE',
...
// Product API Service for Yojin Church Brough
class YojinChurchBroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Church Brough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChurchBroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChurchBroughProductService };
