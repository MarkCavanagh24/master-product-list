// Configuration for Yojin Lockton
// Store ID: 6855422921bb01b10405e68d
// Location: Lockton, YO18 7LN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422921bb01b10405e68d',
    storeName: 'Yojin Lockton',
    city: 'Lockton',
    postcode: 'YO18 7LN',
...
// Product API Service for Yojin Lockton
class YojinLocktonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lockton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLocktonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLocktonProductService };
