// Configuration for Yojin West Ashton
// Store ID: 685541fc21bb01b10405e5e8
// Location: West Ashton, BA14 6BJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fc21bb01b10405e5e8',
    storeName: 'Yojin West Ashton',
    city: 'West Ashton',
    postcode: 'BA14 6BJ',
...
// Product API Service for Yojin West Ashton
class YojinWestAshtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Ashton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestAshtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestAshtonProductService };
