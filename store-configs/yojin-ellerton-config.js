// Configuration for Yojin Ellerton
// Store ID: 685541bd21bb01b10405e505
// Location: Ellerton, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bd21bb01b10405e505',
    storeName: 'Yojin Ellerton',
    city: 'Ellerton',
    postcode: 'N/A',
...
// Product API Service for Yojin Ellerton
class YojinEllertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ellerton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEllertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEllertonProductService };
