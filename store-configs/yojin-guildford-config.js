// Configuration for Yojin Guildford
// Store ID: 6855425821bb01b10405e738
// Location: Guildford, GU2 4EP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425821bb01b10405e738',
    storeName: 'Yojin Guildford',
    city: 'Guildford',
    postcode: 'GU2 4EP',
...
// Product API Service for Yojin Guildford
class YojinGuildfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Guildford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGuildfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGuildfordProductService };
