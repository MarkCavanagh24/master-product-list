// Configuration for Yojin Wateringbury
// Store ID: 6855425121bb01b10405e720
// Location: Wateringbury, ME18 5PH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425121bb01b10405e720',
    storeName: 'Yojin Wateringbury',
    city: 'Wateringbury',
    postcode: 'ME18 5PH',
...
// Product API Service for Yojin Wateringbury
class YojinWateringburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wateringbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWateringburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWateringburyProductService };
