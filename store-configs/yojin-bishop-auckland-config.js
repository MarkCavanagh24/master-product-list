// Configuration for Yojin Bishop Auckland
// Store ID: 6855419521bb01b10405e470
// Location: Bishop Auckland, DL14 6LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419521bb01b10405e470',
    storeName: 'Yojin Bishop Auckland',
...
// Product API Service for Yojin Bishop Auckland
class YojinBishopAucklandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bishop Auckland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBishopAucklandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBishopAucklandProductService };
