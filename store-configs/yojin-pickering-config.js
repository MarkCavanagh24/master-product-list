// Configuration for Yojin Pickering
// Store ID: 6855422d21bb01b10405e69c
// Location: Pickering, YO18 8ED

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422d21bb01b10405e69c',
    storeName: 'Yojin Pickering',
    city: 'Pickering',
    postcode: 'YO18 8ED',
...
// Product API Service for Yojin Pickering
class YojinPickeringProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pickering:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPickeringProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPickeringProductService };
