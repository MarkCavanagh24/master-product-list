// Configuration for Yojin Up Nately
// Store ID: 6855424d21bb01b10405e711
// Location: Up Nately, RG27 9GT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424d21bb01b10405e711',
    storeName: 'Yojin Up Nately',
    city: 'Up Nately',
    postcode: 'RG27 9GT',
...
// Product API Service for Yojin Up Nately
class YojinUpNatelyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Up Nately:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpNatelyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpNatelyProductService };
