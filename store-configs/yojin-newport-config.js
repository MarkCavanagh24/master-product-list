// Configuration for Yojin Newport
// Store ID: 6855420b21bb01b10405e61c
// Location: Newport, HU15 2RX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420b21bb01b10405e61c',
    storeName: 'Yojin Newport',
    city: 'Newport',
    postcode: 'HU15 2RX',
...
// Product API Service for Yojin Newport
class YojinNewportProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newport:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewportProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewportProductService };
