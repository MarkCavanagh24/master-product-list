// Configuration for Yojin Low Grantley
// Store ID: 6855426c21bb01b10405e781
// Location: Low Grantley, HG4 3PG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426c21bb01b10405e781',
    storeName: 'Yojin Low Grantley',
    city: 'Low Grantley',
    postcode: 'HG4 3PG',
...
// Product API Service for Yojin Low Grantley
class YojinLowGrantleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Low Grantley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowGrantleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowGrantleyProductService };
