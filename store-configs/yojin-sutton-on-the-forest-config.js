// Configuration for Yojin Sutton on the Forest
// Store ID: 6855427121bb01b10405e797
// Location: Sutton on the Forest, YO61 1NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427121bb01b10405e797',
    storeName: 'Yojin Sutton on the Forest',
...
// Product API Service for Yojin Sutton on the Forest
class YojinSuttonontheForestProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sutton on the Forest:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSuttonontheForestProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSuttonontheForestProductService };
