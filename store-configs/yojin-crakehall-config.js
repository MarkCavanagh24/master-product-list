// Configuration for Yojin Crakehall
// Store ID: 6855422421bb01b10405e67a
// Location: Crakehall, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422421bb01b10405e67a',
    storeName: 'Yojin Crakehall',
    city: 'Crakehall',
    postcode: 'N/A',
...
// Product API Service for Yojin Crakehall
class YojinCrakehallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crakehall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCrakehallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCrakehallProductService };
