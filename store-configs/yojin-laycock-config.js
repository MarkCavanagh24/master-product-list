// Configuration for Yojin Laycock
// Store ID: 685541b621bb01b10405e4e8
// Location: Laycock, BD20 6QY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b621bb01b10405e4e8',
    storeName: 'Yojin Laycock',
    city: 'Laycock',
    postcode: 'BD20 6QY',
...
// Product API Service for Yojin Laycock
class YojinLaycockProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Laycock:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLaycockProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLaycockProductService };
