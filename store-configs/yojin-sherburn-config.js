// Configuration for Yojin Sherburn
// Store ID: 6855426921bb01b10405e778
// Location: Sherburn, YO12 4PF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426921bb01b10405e778',
    storeName: 'Yojin Sherburn',
    city: 'Sherburn',
    postcode: 'YO12 4PF',
...
// Product API Service for Yojin Sherburn
class YojinSherburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sherburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSherburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSherburnProductService };
