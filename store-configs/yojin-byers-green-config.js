// Configuration for Yojin Byers Green
// Store ID: 6855419221bb01b10405e466
// Location: Byers Green, DL14 8DQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419221bb01b10405e466',
    storeName: 'Yojin Byers Green',
    city: 'Byers Green',
    postcode: 'DL14 8DQ',
...
// Product API Service for Yojin Byers Green
class YojinByersGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Byers Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinByersGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinByersGreenProductService };
