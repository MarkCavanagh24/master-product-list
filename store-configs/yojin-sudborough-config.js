// Configuration for Yojin Sudborough
// Store ID: 685541e321bb01b10405e58e
// Location: Sudborough, NN14 3BX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e321bb01b10405e58e',
    storeName: 'Yojin Sudborough',
    city: 'Sudborough',
    postcode: 'NN14 3BX',
...
// Product API Service for Yojin Sudborough
class YojinSudboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sudborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSudboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSudboroughProductService };
