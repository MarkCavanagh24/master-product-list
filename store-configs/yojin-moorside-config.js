// Configuration for Yojin Moorside
// Store ID: 6855418921bb01b10405e444
// Location: Moorside, SR3 2PP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418921bb01b10405e444',
    storeName: 'Yojin Moorside',
    city: 'Moorside',
    postcode: 'SR3 2PP',
...
// Product API Service for Yojin Moorside
class YojinMoorsideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Moorside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMoorsideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMoorsideProductService };
