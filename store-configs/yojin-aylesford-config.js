// Configuration for Yojin Aylesford
// Store ID: 6855420321bb01b10405e601
// Location: Aylesford, ME20 7BW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420321bb01b10405e601',
    storeName: 'Yojin Aylesford',
    city: 'Aylesford',
    postcode: 'ME20 7BW',
...
// Product API Service for Yojin Aylesford
class YojinAylesfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Aylesford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAylesfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAylesfordProductService };
