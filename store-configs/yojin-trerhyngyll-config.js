// Configuration for Yojin Trerhyngyll
// Store ID: 685541f321bb01b10405e5ca
// Location: Trerhyngyll, CF71 7DB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f321bb01b10405e5ca',
    storeName: 'Yojin Trerhyngyll',
    city: 'Trerhyngyll',
    postcode: 'CF71 7DB',
...
// Product API Service for Yojin Trerhyngyll
class YojinTrerhyngyllProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Trerhyngyll:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTrerhyngyllProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTrerhyngyllProductService };
