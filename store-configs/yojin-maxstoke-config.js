// Configuration for Yojin Maxstoke
// Store ID: 6855421b21bb01b10405e659
// Location: Maxstoke, CV7 8EN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421b21bb01b10405e659',
    storeName: 'Yojin Maxstoke',
    city: 'Maxstoke',
    postcode: 'CV7 8EN',
...
// Product API Service for Yojin Maxstoke
class YojinMaxstokeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Maxstoke:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMaxstokeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMaxstokeProductService };
