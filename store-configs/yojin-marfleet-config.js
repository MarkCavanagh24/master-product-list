// Configuration for Yojin Marfleet
// Store ID: 6855421221bb01b10405e637
// Location: Marfleet, HU9 5PS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421221bb01b10405e637',
    storeName: 'Yojin Marfleet',
    city: 'Marfleet',
    postcode: 'HU9 5PS',
...
// Product API Service for Yojin Marfleet
class YojinMarfleetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Marfleet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarfleetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarfleetProductService };
