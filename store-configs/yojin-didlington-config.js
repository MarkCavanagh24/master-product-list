// Configuration for Yojin Didlington
// Store ID: 6855421721bb01b10405e649
// Location: Didlington, IP26 5HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421721bb01b10405e649',
    storeName: 'Yojin Didlington',
    city: 'Didlington',
    postcode: 'IP26 5HU',
...
// Product API Service for Yojin Didlington
class YojinDidlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Didlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDidlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDidlingtonProductService };
