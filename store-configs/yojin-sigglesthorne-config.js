// Configuration for Yojin Sigglesthorne
// Store ID: 685541a721bb01b10405e4b2
// Location: Sigglesthorne, HU11 5SN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a721bb01b10405e4b2',
    storeName: 'Yojin Sigglesthorne',
    city: 'Sigglesthorne',
    postcode: 'HU11 5SN',
...
// Product API Service for Yojin Sigglesthorne
class YojinSigglesthorneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sigglesthorne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSigglesthorneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSigglesthorneProductService };
