// Configuration for Yojin Charlton
// Store ID: 6855424021bb01b10405e6e2
// Location: Charlton, SE7 7EX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424021bb01b10405e6e2',
    storeName: 'Yojin Charlton',
    city: 'Charlton',
    postcode: 'SE7 7EX',
...
// Product API Service for Yojin Charlton
class YojinCharltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Charlton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCharltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCharltonProductService };
