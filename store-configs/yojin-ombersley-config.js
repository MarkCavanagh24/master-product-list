// Configuration for Yojin Ombersley
// Store ID: 6855427e21bb01b10405e7c2
// Location: Ombersley, DY13 9ST

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427e21bb01b10405e7c2',
    storeName: 'Yojin Ombersley',
    city: 'Ombersley',
    postcode: 'DY13 9ST',
...
// Product API Service for Yojin Ombersley
class YojinOmbersleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ombersley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOmbersleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOmbersleyProductService };
