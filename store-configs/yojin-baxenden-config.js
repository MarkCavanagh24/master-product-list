// Configuration for Yojin Baxenden
// Store ID: 6855420e21bb01b10405e626
// Location: Baxenden, BB5 2EA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420e21bb01b10405e626',
    storeName: 'Yojin Baxenden',
    city: 'Baxenden',
    postcode: 'BB5 2EA',
...
// Product API Service for Yojin Baxenden
class YojinBaxendenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Baxenden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBaxendenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBaxendenProductService };
