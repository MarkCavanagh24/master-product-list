// Configuration for Yojin Lower Mickletown
// Store ID: 6855421021bb01b10405e630
// Location: Lower Mickletown, LS26 9AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421021bb01b10405e630',
    storeName: 'Yojin Lower Mickletown',
    city: 'Lower Mickletown',
    postcode: 'LS26 9AT',
...
// Product API Service for Yojin Lower Mickletown
class YojinLowerMickletownProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lower Mickletown:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowerMickletownProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowerMickletownProductService };
