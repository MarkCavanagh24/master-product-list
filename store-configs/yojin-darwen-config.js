// Configuration for Yojin Darwen
// Store ID: 6855421321bb01b10405e63b
// Location: Darwen, BB3 1JX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421321bb01b10405e63b',
    storeName: 'Yojin Darwen',
    city: 'Darwen',
    postcode: 'BB3 1JX',
...
// Product API Service for Yojin Darwen
class YojinDarwenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Darwen:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDarwenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDarwenProductService };
