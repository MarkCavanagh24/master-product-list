// Configuration for Yojin Rushton
// Store ID: 685541e221bb01b10405e58b
// Location: Rushton, NN14 2QN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e221bb01b10405e58b',
    storeName: 'Yojin Rushton',
    city: 'Rushton',
    postcode: 'NN14 2QN',
...
// Product API Service for Yojin Rushton
class YojinRushtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rushton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRushtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRushtonProductService };
