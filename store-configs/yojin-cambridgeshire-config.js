// Configuration for Yojin Cambridgeshire
// Store ID: 6855423621bb01b10405e6bd
// Location: Cambridgeshire, CB7 4DJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423621bb01b10405e6bd',
    storeName: 'Yojin Cambridgeshire',
    city: 'Cambridgeshire',
    postcode: 'CB7 4DJ',
...
// Product API Service for Yojin Cambridgeshire
class YojinCambridgeshireProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cambridgeshire:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCambridgeshireProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCambridgeshireProductService };
