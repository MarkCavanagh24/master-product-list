// Configuration for Yojin Kitts Green
// Store ID: 6855421b21bb01b10405e657
// Location: Kitts Green, B33 8LG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421b21bb01b10405e657',
    storeName: 'Yojin Kitts Green',
    city: 'Kitts Green',
    postcode: 'B33 8LG',
...
// Product API Service for Yojin Kitts Green
class YojinKittsGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kitts Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKittsGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKittsGreenProductService };
