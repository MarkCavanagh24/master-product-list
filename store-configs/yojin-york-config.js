// Configuration for Yojin York
// Store ID: 6804ed7f609167bd23094bba
// Location: York, YO31 7US

const STORE_CONFIG = {
    // Store Identity
    storeId: '6804ed7f609167bd23094bba',
    storeName: 'Yojin York',
    city: 'York',
    postcode: 'YO31 7US',
...
// Product API Service for Yojin York
class YojinYorkProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin York:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinYorkProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinYorkProductService };
