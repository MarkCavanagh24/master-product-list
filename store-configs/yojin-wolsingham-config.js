// Configuration for Yojin Wolsingham
// Store ID: 6855419221bb01b10405e464
// Location: Wolsingham, DL13 3PD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419221bb01b10405e464',
    storeName: 'Yojin Wolsingham',
    city: 'Wolsingham',
    postcode: 'DL13 3PD',
...
// Product API Service for Yojin Wolsingham
class YojinWolsinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wolsingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWolsinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWolsinghamProductService };
