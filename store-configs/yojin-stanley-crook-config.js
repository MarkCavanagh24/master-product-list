// Configuration for Yojin Stanley Crook
// Store ID: 6855418f21bb01b10405e45b
// Location: Stanley Crook, DL15 9QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418f21bb01b10405e45b',
    storeName: 'Yojin Stanley Crook',
    city: 'Stanley Crook',
    postcode: 'DL15 9QT',
...
// Product API Service for Yojin Stanley Crook
class YojinStanleyCrookProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stanley Crook:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStanleyCrookProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStanleyCrookProductService };
