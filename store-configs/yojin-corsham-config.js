// Configuration for Yojin Corsham
// Store ID: 6855424521bb01b10405e6f3
// Location: Corsham, SN14 0ZD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424521bb01b10405e6f3',
    storeName: 'Yojin Corsham',
    city: 'Corsham',
    postcode: 'SN14 0ZD',
...
// Product API Service for Yojin Corsham
class YojinCorshamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Corsham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCorshamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCorshamProductService };
