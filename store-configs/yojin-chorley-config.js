// Configuration for Yojin Chorley
// Store ID: 6855425e21bb01b10405e74f
// Location: Chorley, PR7 2QN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425e21bb01b10405e74f',
    storeName: 'Yojin Chorley',
    city: 'Chorley',
    postcode: 'PR7 2QN',
...
// Product API Service for Yojin Chorley
class YojinChorleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chorley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChorleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChorleyProductService };
