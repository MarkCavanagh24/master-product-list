// Configuration for Yojin Elland
// Store ID: 6855421521bb01b10405e642
// Location: Elland, HX5 9HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421521bb01b10405e642',
    storeName: 'Yojin Elland',
    city: 'Elland',
    postcode: 'HX5 9HZ',
...
// Product API Service for Yojin Elland
class YojinEllandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Elland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEllandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEllandProductService };
