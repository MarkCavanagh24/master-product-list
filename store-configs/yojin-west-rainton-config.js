// Configuration for Yojin West Rainton
// Store ID: 6855418b21bb01b10405e44b
// Location: West Rainton, DH4 6QG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418b21bb01b10405e44b',
    storeName: 'Yojin West Rainton',
    city: 'West Rainton',
    postcode: 'DH4 6QG',
...
// Product API Service for Yojin West Rainton
class YojinWestRaintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Rainton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestRaintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestRaintonProductService };
