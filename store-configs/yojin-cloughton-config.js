// Configuration for Yojin Cloughton
// Store ID: 685541dd21bb01b10405e578
// Location: Cloughton, YO13 0AW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dd21bb01b10405e578',
    storeName: 'Yojin Cloughton',
    city: 'Cloughton',
    postcode: 'YO13 0AW',
...
// Product API Service for Yojin Cloughton
class YojinCloughtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cloughton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCloughtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCloughtonProductService };
