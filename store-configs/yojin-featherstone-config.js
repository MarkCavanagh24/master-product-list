// Configuration for Yojin Featherstone
// Store ID: 6855417f21bb01b10405e421
// Location: Featherstone, NE49 0HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417f21bb01b10405e421',
    storeName: 'Yojin Featherstone',
    city: 'Featherstone',
    postcode: 'NE49 0HZ',
...
// Product API Service for Yojin Featherstone
class YojinFeatherstoneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Featherstone:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFeatherstoneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFeatherstoneProductService };
