// Configuration for Yojin Gould's Green
// Store ID: 685541ef21bb01b10405e5bb
// Location: Gould's Green, UB8 3LH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ef21bb01b10405e5bb',
    storeName: 'Yojin Gould's Green',
    city: 'Gould's Green',
    postcode: 'UB8 3LH',
...
// Product API Service for Yojin Gould's Green
class YojinGouldsGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gould's Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGouldsGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGouldsGreenProductService };
