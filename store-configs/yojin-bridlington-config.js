// Configuration for Yojin Bridlington
// Store ID: 6855427421bb01b10405e79f
// Location: Bridlington, YO16 4TX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427421bb01b10405e79f',
    storeName: 'Yojin Bridlington',
    city: 'Bridlington',
    postcode: 'YO16 4TX',
...
// Product API Service for Yojin Bridlington
class YojinBridlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bridlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBridlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBridlingtonProductService };
