// Configuration for Yojin Norton-on-Derwent
// Store ID: 6855426d21bb01b10405e788
// Location: Norton-on-Derwent, YO17 9RB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426d21bb01b10405e788',
    storeName: 'Yojin Norton-on-Derwent',
...
// Product API Service for Yojin Norton-on-Derwent
class YojinNortononDerwentProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Norton-on-Derwent:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNortononDerwentProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNortononDerwentProductService };
