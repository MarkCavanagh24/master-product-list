// Configuration for Yojin Stoneleigh
// Store ID: 6855423b21bb01b10405e6d1
// Location: Stoneleigh, CV8 2LG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423b21bb01b10405e6d1',
    storeName: 'Yojin Stoneleigh',
    city: 'Stoneleigh',
    postcode: 'CV8 2LG',
...
// Product API Service for Yojin Stoneleigh
class YojinStoneleighProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stoneleigh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStoneleighProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStoneleighProductService };
