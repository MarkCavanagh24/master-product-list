// Configuration for Yojin Blackburn
// Store ID: 6855420d21bb01b10405e624
// Location: Blackburn, BB2 3QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420d21bb01b10405e624',
    storeName: 'Yojin Blackburn',
    city: 'Blackburn',
    postcode: 'BB2 3QJ',
...
// Product API Service for Yojin Blackburn
class YojinBlackburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blackburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlackburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlackburnProductService };
