// Configuration for Yojin Darlington
// Store ID: 685541b221bb01b10405e4db
// Location: Darlington, DL1 5PJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b221bb01b10405e4db',
    storeName: 'Yojin Darlington',
    city: 'Darlington',
    postcode: 'DL1 5PJ',
...
// Product API Service for Yojin Darlington
class YojinDarlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Darlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDarlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDarlingtonProductService };
