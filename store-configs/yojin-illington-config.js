// Configuration for Yojin Illington
// Store ID: 6855422121bb01b10405e66e
// Location: Illington, IP24 1RP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422121bb01b10405e66e',
    storeName: 'Yojin Illington',
    city: 'Illington',
    postcode: 'IP24 1RP',
...
// Product API Service for Yojin Illington
class YojinIllingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Illington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIllingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIllingtonProductService };
