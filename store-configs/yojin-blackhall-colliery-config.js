// Configuration for Yojin Blackhall Colliery
// Store ID: 6855419121bb01b10405e461
// Location: Blackhall Colliery, TS27 4QD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419121bb01b10405e461',
    storeName: 'Yojin Blackhall Colliery',
...
// Product API Service for Yojin Blackhall Colliery
class YojinBlackhallCollieryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blackhall Colliery:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlackhallCollieryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlackhallCollieryProductService };
