// Configuration for Yojin South Crosland
// Store ID: 6855426621bb01b10405e76c
// Location: South Crosland, HD7 5JW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426621bb01b10405e76c',
    storeName: 'Yojin South Crosland',
    city: 'South Crosland',
    postcode: 'HD7 5JW',
...
// Product API Service for Yojin South Crosland
class YojinSouthCroslandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin South Crosland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSouthCroslandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSouthCroslandProductService };
