// Configuration for Yojin Kendal
// Store ID: 685541da21bb01b10405e56d
// Location: Kendal, LA9 6PL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541da21bb01b10405e56d',
    storeName: 'Yojin Kendal',
    city: 'Kendal',
    postcode: 'LA9 6PL',
...
// Product API Service for Yojin Kendal
class YojinKendalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kendal:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKendalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKendalProductService };
