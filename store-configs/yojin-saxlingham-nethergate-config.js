// Configuration for Yojin Saxlingham Nethergate
// Store ID: 6855421821bb01b10405e64d
// Location: Saxlingham Nethergate, NR15 1TE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421821bb01b10405e64d',
    storeName: 'Yojin Saxlingham Nethergate',
    city: 'Saxlingham Nethergate',
    postcode: 'NR15 1TE',
...
// Product API Service for Yojin Saxlingham Nethergate
class YojinSaxlinghamNethergateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Saxlingham Nethergate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSaxlinghamNethergateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSaxlinghamNethergateProductService };
