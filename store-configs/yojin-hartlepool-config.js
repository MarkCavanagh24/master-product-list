// Configuration for Yojin Hartlepool
// Store ID: 6855419421bb01b10405e46b
// Location: Hartlepool, TS24 8HT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419421bb01b10405e46b',
    storeName: 'Yojin Hartlepool',
    city: 'Hartlepool',
    postcode: 'TS24 8HT',
...
// Product API Service for Yojin Hartlepool
class YojinHartlepoolProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hartlepool:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHartlepoolProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHartlepoolProductService };
