// Configuration for Yojin Hurstbourne Tarrant
// Store ID: 6855420821bb01b10405e612
// Location: Hurstbourne Tarrant, SP11 0DG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420821bb01b10405e612',
    storeName: 'Yojin Hurstbourne Tarrant',
...
// Product API Service for Yojin Hurstbourne Tarrant
class YojinHurstbourneTarrantProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hurstbourne Tarrant:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHurstbourneTarrantProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHurstbourneTarrantProductService };
