// Configuration for Yojin Thetford
// Store ID: 6855427921bb01b10405e7b1
// Location: Thetford, CB6 3HR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427921bb01b10405e7b1',
    storeName: 'Yojin Thetford',
    city: 'Thetford',
    postcode: 'CB6 3HR',
...
// Product API Service for Yojin Thetford
class YojinThetfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thetford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThetfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThetfordProductService };
