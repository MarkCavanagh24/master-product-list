// Configuration for Yojin Hornby
// Store ID: 685541d521bb01b10405e55b
// Location: Hornby, DL6 2JN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d521bb01b10405e55b',
    storeName: 'Yojin Hornby',
    city: 'Hornby',
    postcode: 'DL6 2JN',
...
// Product API Service for Yojin Hornby
class YojinHornbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hornby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHornbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHornbyProductService };
