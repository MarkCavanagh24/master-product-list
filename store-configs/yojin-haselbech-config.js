// Configuration for Yojin Haselbech
// Store ID: 6855423321bb01b10405e6b1
// Location: Haselbech, NN6 9LF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423321bb01b10405e6b1',
    storeName: 'Yojin Haselbech',
    city: 'Haselbech',
    postcode: 'NN6 9LF',
...
// Product API Service for Yojin Haselbech
class YojinHaselbechProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Haselbech:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaselbechProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaselbechProductService };
