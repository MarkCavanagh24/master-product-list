// Configuration for Yojin Newbiggin by the Sea
// Store ID: 6855419721bb01b10405e478
// Location: Newbiggin by the Sea, NE63 9YB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419721bb01b10405e478',
    storeName: 'Yojin Newbiggin by the Sea',
...
// Product API Service for Yojin Newbiggin by the Sea
class YojinNewbigginbytheSeaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newbiggin by the Sea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewbigginbytheSeaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewbigginbytheSeaProductService };
