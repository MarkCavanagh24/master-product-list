// Configuration for Yojin Habton
// Store ID: 6855426821bb01b10405e774
// Location: Habton, YO17 6RZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426821bb01b10405e774',
    storeName: 'Yojin Habton',
    city: 'Habton',
    postcode: 'YO17 6RZ',
...
// Product API Service for Yojin Habton
class YojinHabtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Habton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHabtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHabtonProductService };
