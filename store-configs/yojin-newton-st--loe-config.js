// Configuration for Yojin Newton St. Loe
// Store ID: 6855428621bb01b10405e7df
// Location: Newton St. Loe, BA2 9EP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428621bb01b10405e7df',
    storeName: 'Yojin Newton St. Loe',
    city: 'Newton St. Loe',
    postcode: 'BA2 9EP',
...
// Product API Service for Yojin Newton St. Loe
class YojinNewtonStLoeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newton St. Loe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewtonStLoeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewtonStLoeProductService };
