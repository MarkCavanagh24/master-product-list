// Configuration for Yojin West Clandon
// Store ID: 6855424f21bb01b10405e717
// Location: West Clandon, GU4 7TT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424f21bb01b10405e717',
    storeName: 'Yojin West Clandon',
    city: 'West Clandon',
    postcode: 'GU4 7TT',
...
// Product API Service for Yojin West Clandon
class YojinWestClandonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Clandon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestClandonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestClandonProductService };
