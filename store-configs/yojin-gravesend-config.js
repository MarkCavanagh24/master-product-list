// Configuration for Yojin Gravesend
// Store ID: 6855424c21bb01b10405e70c
// Location: Gravesend, DA12 1LQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424c21bb01b10405e70c',
    storeName: 'Yojin Gravesend',
    city: 'Gravesend',
    postcode: 'DA12 1LQ',
...
// Product API Service for Yojin Gravesend
class YojinGravesendProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gravesend:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGravesendProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGravesendProductService };
