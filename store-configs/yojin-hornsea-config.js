// Configuration for Yojin Hornsea
// Store ID: 685541a721bb01b10405e4b3
// Location: Hornsea, HU18 1DW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a721bb01b10405e4b3',
    storeName: 'Yojin Hornsea',
    city: 'Hornsea',
    postcode: 'HU18 1DW',
...
// Product API Service for Yojin Hornsea
class YojinHornseaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hornsea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHornseaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHornseaProductService };
