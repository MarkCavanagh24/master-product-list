// Configuration for Yojin Soham
// Store ID: 6855427921bb01b10405e7b2
// Location: Soham, CB7 5DE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427921bb01b10405e7b2',
    storeName: 'Yojin Soham',
    city: 'Soham',
    postcode: 'CB7 5DE',
...
// Product API Service for Yojin Soham
class YojinSohamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Soham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSohamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSohamProductService };
