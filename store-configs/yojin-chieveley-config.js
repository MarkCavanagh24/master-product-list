// Configuration for Yojin Chieveley
// Store ID: 6855424621bb01b10405e6f6
// Location: Chieveley, RG18 9EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424621bb01b10405e6f6',
    storeName: 'Yojin Chieveley',
    city: 'Chieveley',
    postcode: 'RG18 9EF',
...
// Product API Service for Yojin Chieveley
class YojinChieveleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chieveley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChieveleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChieveleyProductService };
