// Configuration for Yojin Wretton
// Store ID: 685541c421bb01b10405e51e
// Location: Wretton, PE33 9SH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c421bb01b10405e51e',
    storeName: 'Yojin Wretton',
    city: 'Wretton',
    postcode: 'PE33 9SH',
...
// Product API Service for Yojin Wretton
class YojinWrettonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wretton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWrettonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWrettonProductService };
