// Configuration for Yojin Basingstoke
// Store ID: 6855424d21bb01b10405e710
// Location: Basingstoke, RG22 6NU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424d21bb01b10405e710',
    storeName: 'Yojin Basingstoke',
    city: 'Basingstoke',
    postcode: 'RG22 6NU',
...
// Product API Service for Yojin Basingstoke
class YojinBasingstokeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Basingstoke:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBasingstokeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBasingstokeProductService };
