// Configuration for Yojin Bungay
// Store ID: 685541e821bb01b10405e5a1
// Location: Bungay, NR35 1PD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e821bb01b10405e5a1',
    storeName: 'Yojin Bungay',
    city: 'Bungay',
    postcode: 'NR35 1PD',
...
// Product API Service for Yojin Bungay
class YojinBungayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bungay:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBungayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBungayProductService };
