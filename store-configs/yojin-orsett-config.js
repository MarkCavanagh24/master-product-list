// Configuration for Yojin Orsett
// Store ID: 685541f321bb01b10405e5c7
// Location: Orsett, RM16 3HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f321bb01b10405e5c7',
    storeName: 'Yojin Orsett',
    city: 'Orsett',
    postcode: 'RM16 3HU',
...
// Product API Service for Yojin Orsett
class YojinOrsettProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Orsett:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOrsettProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOrsettProductService };
