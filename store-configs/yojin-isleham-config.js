// Configuration for Yojin Isleham
// Store ID: 6855427921bb01b10405e7b3
// Location: Isleham, CB7 5RD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427921bb01b10405e7b3',
    storeName: 'Yojin Isleham',
    city: 'Isleham',
    postcode: 'CB7 5RD',
...
// Product API Service for Yojin Isleham
class YojinIslehamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Isleham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIslehamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIslehamProductService };
