// Configuration for Yojin Seaham
// Store ID: 6855418c21bb01b10405e44d
// Location: Seaham, SR7 8QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418c21bb01b10405e44d',
    storeName: 'Yojin Seaham',
    city: 'Seaham',
    postcode: 'SR7 8QP',
...
// Product API Service for Yojin Seaham
class YojinSeahamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Seaham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSeahamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSeahamProductService };
