// Configuration for Yojin Holton
// Store ID: 6855427d21bb01b10405e7bf
// Location: Holton, IP19 8PA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427d21bb01b10405e7bf',
    storeName: 'Yojin Holton',
    city: 'Holton',
    postcode: 'IP19 8PA',
...
// Product API Service for Yojin Holton
class YojinHoltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Holton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHoltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHoltonProductService };
