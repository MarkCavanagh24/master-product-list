// Configuration for Yojin Ramsey Heights
// Store ID: 685541e421bb01b10405e592
// Location: Ramsey Heights, PE26 2AA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e421bb01b10405e592',
    storeName: 'Yojin Ramsey Heights',
    city: 'Ramsey Heights',
    postcode: 'PE26 2AA',
...
// Product API Service for Yojin Ramsey Heights
class YojinRamseyHeightsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ramsey Heights:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRamseyHeightsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRamseyHeightsProductService };
