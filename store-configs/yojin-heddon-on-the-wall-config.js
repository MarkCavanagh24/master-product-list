// Configuration for Yojin Heddon-on-the-Wall
// Store ID: 6855417d21bb01b10405e417
// Location: Heddon-on-the-Wall, NE15 0ED

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417d21bb01b10405e417',
    storeName: 'Yojin Heddon-on-the-Wall',
    city: 'Heddon-on-the-Wall',
    postcode: 'NE15 0ED',
...
// Product API Service for Yojin Heddon-on-the-Wall
class YojinHeddonontheWallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heddon-on-the-Wall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeddonontheWallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeddonontheWallProductService };
