// Configuration for Yojin Gisleham
// Store ID: 685541e921bb01b10405e5a4
// Location: Gisleham, NR33 8DX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e921bb01b10405e5a4',
    storeName: 'Yojin Gisleham',
    city: 'Gisleham',
    postcode: 'NR33 8DX',
...
// Product API Service for Yojin Gisleham
class YojinGislehamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gisleham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGislehamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGislehamProductService };
