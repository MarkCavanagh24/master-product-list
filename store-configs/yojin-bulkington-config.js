// Configuration for Yojin Bulkington
// Store ID: 6855421c21bb01b10405e65b
// Location: Bulkington, CV12 9PN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421c21bb01b10405e65b',
    storeName: 'Yojin Bulkington',
    city: 'Bulkington',
    postcode: 'CV12 9PN',
...
// Product API Service for Yojin Bulkington
class YojinBulkingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bulkington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBulkingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBulkingtonProductService };
