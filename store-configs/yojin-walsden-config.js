// Configuration for Yojin Walsden
// Store ID: 6855421521bb01b10405e640
// Location: Walsden, OL14 7RH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421521bb01b10405e640',
    storeName: 'Yojin Walsden',
    city: 'Walsden',
    postcode: 'OL14 7RH',
...
// Product API Service for Yojin Walsden
class YojinWalsdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walsden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWalsdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWalsdenProductService };
