// Configuration for Yojin Gatebeck
// Store ID: 6855422621bb01b10405e680
// Location: Gatebeck, LA8 0EP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422621bb01b10405e680',
    storeName: 'Yojin Gatebeck',
    city: 'Gatebeck',
    postcode: 'LA8 0EP',
...
// Product API Service for Yojin Gatebeck
class YojinGatebeckProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gatebeck:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGatebeckProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGatebeckProductService };
