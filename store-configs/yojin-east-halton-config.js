// Configuration for Yojin East Halton
// Store ID: 6855426221bb01b10405e75d
// Location: East Halton, DN40 3PW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426221bb01b10405e75d',
    storeName: 'Yojin East Halton',
    city: 'East Halton',
    postcode: 'DN40 3PW',
...
// Product API Service for Yojin East Halton
class YojinEastHaltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Halton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastHaltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastHaltonProductService };
