// Configuration for Yojin Austhorpe
// Store ID: 6855420921bb01b10405e616
// Location: Austhorpe, LS15 8QL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420921bb01b10405e616',
    storeName: 'Yojin Austhorpe',
    city: 'Austhorpe',
    postcode: 'LS15 8QL',
...
// Product API Service for Yojin Austhorpe
class YojinAusthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Austhorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAusthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAusthorpeProductService };
