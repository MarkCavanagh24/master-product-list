// Configuration for Yojin Kirby Cane
// Store ID: 6855422221bb01b10405e672
// Location: Kirby Cane, NR35 2PP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422221bb01b10405e672',
    storeName: 'Yojin Kirby Cane',
    city: 'Kirby Cane',
    postcode: 'NR35 2PP',
...
// Product API Service for Yojin Kirby Cane
class YojinKirbyCaneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirby Cane:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirbyCaneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirbyCaneProductService };
