// Configuration for Yojin Maidenhead
// Store ID: 685541ee21bb01b10405e5b7
// Location: Maidenhead, SL6 4JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ee21bb01b10405e5b7',
    storeName: 'Yojin Maidenhead',
    city: 'Maidenhead',
    postcode: 'SL6 4JD',
...
// Product API Service for Yojin Maidenhead
class YojinMaidenheadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Maidenhead:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMaidenheadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMaidenheadProductService };
