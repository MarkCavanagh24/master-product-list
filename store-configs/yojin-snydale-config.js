// Configuration for Yojin Snydale
// Store ID: 6855425b21bb01b10405e742
// Location: Snydale, WF6 1WG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425b21bb01b10405e742',
    storeName: 'Yojin Snydale',
    city: 'Snydale',
    postcode: 'WF6 1WG',
...
// Product API Service for Yojin Snydale
class YojinSnydaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Snydale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSnydaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSnydaleProductService };
