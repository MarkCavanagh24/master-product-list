// Configuration for Yojin Howden
// Store ID: 6855421121bb01b10405e632
// Location: Howden, DN14 7GL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421121bb01b10405e632',
    storeName: 'Yojin Howden',
    city: 'Howden',
    postcode: 'DN14 7GL',
...
// Product API Service for Yojin Howden
class YojinHowdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Howden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHowdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHowdenProductService };
