// Configuration for Yojin Hesket
// Store ID: 6855418921bb01b10405e445
// Location: Hesket, CA4 0DA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418921bb01b10405e445',
    storeName: 'Yojin Hesket',
    city: 'Hesket',
    postcode: 'CA4 0DA',
...
// Product API Service for Yojin Hesket
class YojinHesketProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hesket:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHesketProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHesketProductService };
