// Configuration for Yojin Thormanby
// Store ID: 6855423121bb01b10405e6a9
// Location: Thormanby, YO61 4NA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423121bb01b10405e6a9',
    storeName: 'Yojin Thormanby',
    city: 'Thormanby',
    postcode: 'YO61 4NA',
...
// Product API Service for Yojin Thormanby
class YojinThormanbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thormanby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThormanbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThormanbyProductService };
