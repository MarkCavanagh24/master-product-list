// Configuration for Yojin Great Oxendon
// Store ID: 685541e221bb01b10405e589
// Location: Great Oxendon, LE16 9RQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e221bb01b10405e589',
    storeName: 'Yojin Great Oxendon',
    city: 'Great Oxendon',
    postcode: 'LE16 9RQ',
...
// Product API Service for Yojin Great Oxendon
class YojinGreatOxendonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Oxendon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatOxendonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatOxendonProductService };
