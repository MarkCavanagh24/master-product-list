// Configuration for Yojin Worsthorne
// Store ID: 685541c121bb01b10405e514
// Location: Worsthorne, BB10 3LF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c121bb01b10405e514',
    storeName: 'Yojin Worsthorne',
    city: 'Worsthorne',
    postcode: 'BB10 3LF',
...
// Product API Service for Yojin Worsthorne
class YojinWorsthorneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Worsthorne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWorsthorneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWorsthorneProductService };
