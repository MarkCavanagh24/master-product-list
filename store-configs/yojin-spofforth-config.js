// Configuration for Yojin Spofforth
// Store ID: 685541a021bb01b10405e497
// Location: Spofforth, HG3 1EQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a021bb01b10405e497',
    storeName: 'Yojin Spofforth',
    city: 'Spofforth',
    postcode: 'HG3 1EQ',
...
// Product API Service for Yojin Spofforth
class YojinSpofforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Spofforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSpofforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSpofforthProductService };
