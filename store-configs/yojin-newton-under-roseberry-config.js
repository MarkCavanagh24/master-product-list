// Configuration for Yojin Newton Under Roseberry
// Store ID: 685541b421bb01b10405e4e1
// Location: Newton Under Roseberry, TS14 8HG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b421bb01b10405e4e1',
    storeName: 'Yojin Newton Under Roseberry',
    city: 'Newton Under Roseberry',
    postcode: 'TS14 8HG',
...
// Product API Service for Yojin Newton Under Roseberry
class YojinNewtonUnderRoseberryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newton Under Roseberry:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewtonUnderRoseberryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewtonUnderRoseberryProductService };
