// Configuration for Yojin Wilburton
// Store ID: 6855427921bb01b10405e7b0
// Location: Wilburton, CB6 3SD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427921bb01b10405e7b0',
    storeName: 'Yojin Wilburton',
    city: 'Wilburton',
    postcode: 'CB6 3SD',
...
// Product API Service for Yojin Wilburton
class YojinWilburtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wilburton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWilburtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWilburtonProductService };
