// Configuration for Yojin Wighill
// Store ID: 685541a621bb01b10405e4ad
// Location: Wighill, LS24 8BH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a621bb01b10405e4ad',
    storeName: 'Yojin Wighill',
    city: 'Wighill',
    postcode: 'LS24 8BH',
...
// Product API Service for Yojin Wighill
class YojinWighillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wighill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWighillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWighillProductService };
