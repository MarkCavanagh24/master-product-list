// Configuration for Yojin Reedham
// Store ID: 685541c821bb01b10405e52a
// Location: Reedham, NR13 3UH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c821bb01b10405e52a',
    storeName: 'Yojin Reedham',
    city: 'Reedham',
    postcode: 'NR13 3UH',
...
// Product API Service for Yojin Reedham
class YojinReedhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Reedham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinReedhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinReedhamProductService };
