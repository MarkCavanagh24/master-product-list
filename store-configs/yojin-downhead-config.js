// Configuration for Yojin Downhead
// Store ID: 6855425521bb01b10405e72c
// Location: Downhead, BA3 5GU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425521bb01b10405e72c',
    storeName: 'Yojin Downhead',
    city: 'Downhead',
    postcode: 'BA3 5GU',
...
// Product API Service for Yojin Downhead
class YojinDownheadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Downhead:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDownheadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDownheadProductService };
