// Configuration for Yojin Great Creaton
// Store ID: 6855423e21bb01b10405e6d9
// Location: Great Creaton, NN6 8NE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423e21bb01b10405e6d9',
    storeName: 'Yojin Great Creaton',
    city: 'Great Creaton',
    postcode: 'NN6 8NE',
...
// Product API Service for Yojin Great Creaton
class YojinGreatCreatonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Creaton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatCreatonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatCreatonProductService };
