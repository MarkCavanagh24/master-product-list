// Configuration for Yojin Low Row
// Store ID: 6855417f21bb01b10405e420
// Location: Low Row, CA8 2JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417f21bb01b10405e420',
    storeName: 'Yojin Low Row',
    city: 'Low Row',
    postcode: 'CA8 2JB',
...
// Product API Service for Yojin Low Row
class YojinLowRowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Low Row:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowRowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowRowProductService };
