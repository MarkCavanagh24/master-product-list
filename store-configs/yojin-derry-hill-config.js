// Configuration for Yojin Derry Hill
// Store ID: 6855424521bb01b10405e6f4
// Location: Derry Hill, SN15 3RX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424521bb01b10405e6f4',
    storeName: 'Yojin Derry Hill',
    city: 'Derry Hill',
    postcode: 'SN15 3RX',
...
// Product API Service for Yojin Derry Hill
class YojinDerryHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Derry Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDerryHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDerryHillProductService };
