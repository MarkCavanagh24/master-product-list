// Configuration for Yojin Solihull
// Store ID: 685541df21bb01b10405e57e
// Location: Solihull, B92 0ED

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541df21bb01b10405e57e',
    storeName: 'Yojin Solihull',
    city: 'Solihull',
    postcode: 'B92 0ED',
...
// Product API Service for Yojin Solihull
class YojinSolihullProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Solihull:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSolihullProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSolihullProductService };
