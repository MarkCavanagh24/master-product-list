// Configuration for Yojin Whitchurch
// Store ID: 6855425621bb01b10405e733
// Location: Whitchurch, RG28 7FS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425621bb01b10405e733',
    storeName: 'Yojin Whitchurch',
    city: 'Whitchurch',
    postcode: 'RG28 7FS',
...
// Product API Service for Yojin Whitchurch
class YojinWhitchurchProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whitchurch:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhitchurchProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhitchurchProductService };
