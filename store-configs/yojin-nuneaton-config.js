// Configuration for Yojin Nuneaton
// Store ID: 685541cd21bb01b10405e53c
// Location: Nuneaton, CV11 6PF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cd21bb01b10405e53c',
    storeName: 'Yojin Nuneaton',
    city: 'Nuneaton',
    postcode: 'CV11 6PF',
...
// Product API Service for Yojin Nuneaton
class YojinNuneatonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Nuneaton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNuneatonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNuneatonProductService };
