// Configuration for Yojin Sadberge
// Store ID: 685541ae21bb01b10405e4cc
// Location: Sadberge, DL2 1SN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ae21bb01b10405e4cc',
    storeName: 'Yojin Sadberge',
    city: 'Sadberge',
    postcode: 'DL2 1SN',
...
// Product API Service for Yojin Sadberge
class YojinSadbergeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sadberge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSadbergeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSadbergeProductService };
