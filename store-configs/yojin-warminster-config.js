// Configuration for Yojin Warminster
// Store ID: 6855425621bb01b10405e730
// Location: Warminster, BA12 0AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425621bb01b10405e730',
    storeName: 'Yojin Warminster',
    city: 'Warminster',
    postcode: 'BA12 0AY',
...
// Product API Service for Yojin Warminster
class YojinWarminsterProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Warminster:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWarminsterProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWarminsterProductService };
