// Configuration for Yojin Gilmorton
// Store ID: 6855421d21bb01b10405e65e
// Location: Gilmorton, LE17 5RY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421d21bb01b10405e65e',
    storeName: 'Yojin Gilmorton',
    city: 'Gilmorton',
    postcode: 'LE17 5RY',
...
// Product API Service for Yojin Gilmorton
class YojinGilmortonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gilmorton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGilmortonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGilmortonProductService };
