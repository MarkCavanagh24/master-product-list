// Configuration for Yojin Aldershot
// Store ID: 6855424e21bb01b10405e713
// Location: Aldershot, GU11 2ET

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424e21bb01b10405e713',
    storeName: 'Yojin Aldershot',
    city: 'Aldershot',
    postcode: 'GU11 2ET',
...
// Product API Service for Yojin Aldershot
class YojinAldershotProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Aldershot:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAldershotProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAldershotProductService };
