// Configuration for Yojin Foulden
// Store ID: 685541c521bb01b10405e51f
// Location: Foulden, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c521bb01b10405e51f',
    storeName: 'Yojin Foulden',
    city: 'Foulden',
    postcode: 'N/A',
...
// Product API Service for Yojin Foulden
class YojinFouldenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Foulden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFouldenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFouldenProductService };
