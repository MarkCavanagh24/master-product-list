// Configuration for Yojin Kirby Sigston
// Store ID: 685541dc21bb01b10405e576
// Location: Kirby Sigston, DL6 3RE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dc21bb01b10405e576',
    storeName: 'Yojin Kirby Sigston',
    city: 'Kirby Sigston',
    postcode: 'DL6 3RE',
...
// Product API Service for Yojin Kirby Sigston
class YojinKirbySigstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirby Sigston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirbySigstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirbySigstonProductService };
