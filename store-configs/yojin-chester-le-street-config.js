// Configuration for Yojin Chester-le-Street
// Store ID: 6855418821bb01b10405e442
// Location: Chester-le-Street, DH3 4AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418821bb01b10405e442',
    storeName: 'Yojin Chester-le-Street',
...
// Product API Service for Yojin Chester-le-Street
class YojinChesterleStreetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chester-le-Street:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChesterleStreetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChesterleStreetProductService };
