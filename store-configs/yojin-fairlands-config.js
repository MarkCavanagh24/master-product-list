// Configuration for Yojin Fairlands
// Store ID: 6855424e21bb01b10405e715
// Location: Fairlands, GU3 3HQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424e21bb01b10405e715',
    storeName: 'Yojin Fairlands',
    city: 'Fairlands',
    postcode: 'GU3 3HQ',
...
// Product API Service for Yojin Fairlands
class YojinFairlandsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fairlands:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFairlandsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFairlandsProductService };
