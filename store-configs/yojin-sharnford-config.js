// Configuration for Yojin Sharnford
// Store ID: 685541cd21bb01b10405e53e
// Location: Sharnford, LE10 3BD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cd21bb01b10405e53e',
    storeName: 'Yojin Sharnford',
    city: 'Sharnford',
    postcode: 'LE10 3BD',
...
// Product API Service for Yojin Sharnford
class YojinSharnfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sharnford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSharnfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSharnfordProductService };
