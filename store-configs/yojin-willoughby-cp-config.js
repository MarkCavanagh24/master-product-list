// Configuration for Yojin Willoughby CP
// Store ID: 6855428121bb01b10405e7ce
// Location: Willoughby CP, CV23 8BZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428121bb01b10405e7ce',
    storeName: 'Yojin Willoughby CP',
    city: 'Willoughby CP',
    postcode: 'CV23 8BZ',
...
// Product API Service for Yojin Willoughby CP
class YojinWilloughbyCPProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Willoughby CP:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWilloughbyCPProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWilloughbyCPProductService };
