// Configuration for Yojin Ashington
// Store ID: 6855419721bb01b10405e477
// Location: Ashington, NE62 5NQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419721bb01b10405e477',
    storeName: 'Yojin Ashington',
    city: 'Ashington',
    postcode: 'NE62 5NQ',
...
// Product API Service for Yojin Ashington
class YojinAshingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ashington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshingtonProductService };
