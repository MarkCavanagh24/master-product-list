// Configuration for Yojin Painter's Forstal
// Store ID: 6855420321bb01b10405e603
// Location: Painter's Forstal, ME13 0RL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420321bb01b10405e603',
    storeName: 'Yojin Painter's Forstal',
    city: 'Painter's Forstal',
    postcode: 'ME13 0RL',
...
// Product API Service for Yojin Painter's Forstal
class YojinPaintersForstalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Painter's Forstal:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPaintersForstalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPaintersForstalProductService };
