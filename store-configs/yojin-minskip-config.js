// Configuration for Yojin Minskip
// Store ID: 6855427121bb01b10405e795
// Location: Minskip, YO51 9PA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427121bb01b10405e795',
    storeName: 'Yojin Minskip',
    city: 'Minskip',
    postcode: 'YO51 9PA',
...
// Product API Service for Yojin Minskip
class YojinMinskipProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Minskip:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMinskipProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMinskipProductService };
