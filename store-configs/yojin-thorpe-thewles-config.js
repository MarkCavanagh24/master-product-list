// Configuration for Yojin Thorpe Thewles
// Store ID: 685541ab21bb01b10405e4bf
// Location: Thorpe Thewles, TS21 3FJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ab21bb01b10405e4bf',
    storeName: 'Yojin Thorpe Thewles',
    city: 'Thorpe Thewles',
    postcode: 'TS21 3FJ',
...
// Product API Service for Yojin Thorpe Thewles
class YojinThorpeThewlesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thorpe Thewles:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThorpeThewlesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThorpeThewlesProductService };
