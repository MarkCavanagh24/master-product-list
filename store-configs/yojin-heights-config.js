// Configuration for Yojin Heights
// Store ID: 685541b021bb01b10405e4d5
// Location: Heights, CA16 6QA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b021bb01b10405e4d5',
    storeName: 'Yojin Heights',
    city: 'Heights',
    postcode: 'CA16 6QA',
...
// Product API Service for Yojin Heights
class YojinHeightsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heights:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeightsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeightsProductService };
