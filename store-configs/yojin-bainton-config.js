// Configuration for Yojin Bainton
// Store ID: 685541a221bb01b10405e4a0
// Location: Bainton, YO25 9NW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a221bb01b10405e4a0',
    storeName: 'Yojin Bainton',
    city: 'Bainton',
    postcode: 'YO25 9NW',
...
// Product API Service for Yojin Bainton
class YojinBaintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bainton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBaintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBaintonProductService };
