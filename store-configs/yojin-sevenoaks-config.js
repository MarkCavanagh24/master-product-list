// Configuration for Yojin Sevenoaks
// Store ID: 6855425a21bb01b10405e73f
// Location: Sevenoaks, TN11 8PL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425a21bb01b10405e73f',
    storeName: 'Yojin Sevenoaks',
    city: 'Sevenoaks',
    postcode: 'TN11 8PL',
...
// Product API Service for Yojin Sevenoaks
class YojinSevenoaksProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sevenoaks:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSevenoaksProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSevenoaksProductService };
