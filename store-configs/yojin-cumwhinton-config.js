// Configuration for Yojin Cumwhinton
// Store ID: 6855418621bb01b10405e43c
// Location: Cumwhinton, CA4 8DP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418621bb01b10405e43c',
    storeName: 'Yojin Cumwhinton',
    city: 'Cumwhinton',
    postcode: 'CA4 8DP',
...
// Product API Service for Yojin Cumwhinton
class YojinCumwhintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cumwhinton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCumwhintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCumwhintonProductService };
