// Configuration for Yojin Crazies Hill
// Store ID: 685541ed21bb01b10405e5b5
// Location: Crazies Hill, RG10 8PD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ed21bb01b10405e5b5',
    storeName: 'Yojin Crazies Hill',
    city: 'Crazies Hill',
    postcode: 'RG10 8PD',
...
// Product API Service for Yojin Crazies Hill
class YojinCraziesHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crazies Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCraziesHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCraziesHillProductService };
