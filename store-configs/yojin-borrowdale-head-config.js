// Configuration for Yojin Borrowdale Head
// Store ID: 685541d421bb01b10405e555
// Location: Borrowdale Head, LA8 9LG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d421bb01b10405e555',
    storeName: 'Yojin Borrowdale Head',
    city: 'Borrowdale Head',
    postcode: 'LA8 9LG',
...
// Product API Service for Yojin Borrowdale Head
class YojinBorrowdaleHeadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Borrowdale Head:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBorrowdaleHeadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBorrowdaleHeadProductService };
