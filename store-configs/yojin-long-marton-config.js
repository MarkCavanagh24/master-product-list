// Configuration for Yojin Long Marton
// Store ID: 685541a921bb01b10405e4b7
// Location: Long Marton, CA16 6JP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a921bb01b10405e4b7',
    storeName: 'Yojin Long Marton',
    city: 'Long Marton',
    postcode: 'CA16 6JP',
...
// Product API Service for Yojin Long Marton
class YojinLongMartonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Long Marton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLongMartonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLongMartonProductService };
