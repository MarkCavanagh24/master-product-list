// Configuration for Yojin Holme
// Store ID: 6855421f21bb01b10405e668
// Location: Holme, PE7 3PW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421f21bb01b10405e668',
    storeName: 'Yojin Holme',
    city: 'Holme',
    postcode: 'PE7 3PW',
...
// Product API Service for Yojin Holme
class YojinHolmeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Holme:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHolmeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHolmeProductService };
