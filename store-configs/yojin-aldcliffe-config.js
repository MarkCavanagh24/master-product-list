// Configuration for Yojin Aldcliffe
// Store ID: 6855427421bb01b10405e7a1
// Location: Aldcliffe, LA1 5EL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427421bb01b10405e7a1',
    storeName: 'Yojin Aldcliffe',
    city: 'Aldcliffe',
    postcode: 'LA1 5EL',
...
// Product API Service for Yojin Aldcliffe
class YojinAldcliffeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Aldcliffe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAldcliffeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAldcliffeProductService };
