// Configuration for Yojin Haddenham
// Store ID: 6855427821bb01b10405e7af
// Location: Haddenham, CB6 3PL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427821bb01b10405e7af',
    storeName: 'Yojin Haddenham',
    city: 'Haddenham',
    postcode: 'CB6 3PL',
...
// Product API Service for Yojin Haddenham
class YojinHaddenhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Haddenham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaddenhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaddenhamProductService };
