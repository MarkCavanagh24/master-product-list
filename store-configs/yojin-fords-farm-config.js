// Configuration for Yojin Fords Farm
// Store ID: 6855424621bb01b10405e6f8
// Location: Fords Farm, RG31 7ZU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424621bb01b10405e6f8',
    storeName: 'Yojin Fords Farm',
    city: 'Fords Farm',
    postcode: 'RG31 7ZU',
...
// Product API Service for Yojin Fords Farm
class YojinFordsFarmProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fords Farm:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFordsFarmProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFordsFarmProductService };
