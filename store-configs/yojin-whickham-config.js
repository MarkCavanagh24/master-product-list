// Configuration for Yojin Whickham
// Store ID: 6855418221bb01b10405e42a
// Location: Whickham, NE11 9DU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418221bb01b10405e42a',
    storeName: 'Yojin Whickham',
    city: 'Whickham',
    postcode: 'NE11 9DU',
...
// Product API Service for Yojin Whickham
class YojinWhickhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whickham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhickhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhickhamProductService };
