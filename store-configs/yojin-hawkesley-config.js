// Configuration for Yojin Hawkesley
// Store ID: 685541ea21bb01b10405e5a9
// Location: Hawkesley, B38 9UX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ea21bb01b10405e5a9',
    storeName: 'Yojin Hawkesley',
    city: 'Hawkesley',
    postcode: 'B38 9UX',
...
// Product API Service for Yojin Hawkesley
class YojinHawkesleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hawkesley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHawkesleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHawkesleyProductService };
