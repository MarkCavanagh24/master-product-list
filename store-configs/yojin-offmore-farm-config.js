// Configuration for Yojin Offmore Farm
// Store ID: 685541e921bb01b10405e5a6
// Location: Offmore Farm, DY10 3AF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e921bb01b10405e5a6',
    storeName: 'Yojin Offmore Farm',
    city: 'Offmore Farm',
    postcode: 'DY10 3AF',
...
// Product API Service for Yojin Offmore Farm
class YojinOffmoreFarmProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Offmore Farm:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOffmoreFarmProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOffmoreFarmProductService };
