// Configuration for Yojin Grayrigg
// Store ID: 685541d721bb01b10405e563
// Location: Grayrigg, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d721bb01b10405e563',
    storeName: 'Yojin Grayrigg',
    city: 'Grayrigg',
    postcode: 'N/A',
...
// Product API Service for Yojin Grayrigg
class YojinGrayriggProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Grayrigg:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGrayriggProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGrayriggProductService };
