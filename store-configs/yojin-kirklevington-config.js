// Configuration for Yojin Kirklevington
// Store ID: 685541d221bb01b10405e54f
// Location: Kirklevington, TS15 9YT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d221bb01b10405e54f',
    storeName: 'Yojin Kirklevington',
    city: 'Kirklevington',
    postcode: 'TS15 9YT',
...
// Product API Service for Yojin Kirklevington
class YojinKirklevingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirklevington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirklevingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirklevingtonProductService };
