// Configuration for Yojin Highley
// Store ID: 6855422221bb01b10405e674
// Location: Highley, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422221bb01b10405e674',
    storeName: 'Yojin Highley',
    city: 'Highley',
    postcode: 'N/A',
...
// Product API Service for Yojin Highley
class YojinHighleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Highley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHighleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHighleyProductService };
