// Configuration for Yojin Whorlton
// Store ID: 685541da21bb01b10405e56c
// Location: Whorlton, DL6 3DW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541da21bb01b10405e56c',
    storeName: 'Yojin Whorlton',
    city: 'Whorlton',
    postcode: 'DL6 3DW',
...
// Product API Service for Yojin Whorlton
class YojinWhorltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whorlton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhorltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhorltonProductService };
