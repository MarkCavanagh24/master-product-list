// Configuration for Yojin Chediston
// Store ID: 6855427d21bb01b10405e7be
// Location: Chediston, IP19 0AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427d21bb01b10405e7be',
    storeName: 'Yojin Chediston',
    city: 'Chediston',
    postcode: 'IP19 0AY',
...
// Product API Service for Yojin Chediston
class YojinChedistonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chediston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChedistonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChedistonProductService };
