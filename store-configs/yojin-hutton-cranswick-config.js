// Configuration for Yojin Hutton Cranswick
// Store ID: 685541a321bb01b10405e4a1
// Location: Hutton Cranswick, YO25 9QF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a321bb01b10405e4a1',
    storeName: 'Yojin Hutton Cranswick',
    city: 'Hutton Cranswick',
    postcode: 'YO25 9QF',
...
// Product API Service for Yojin Hutton Cranswick
class YojinHuttonCranswickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hutton Cranswick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHuttonCranswickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHuttonCranswickProductService };
