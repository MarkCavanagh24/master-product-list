// Configuration for Yojin Orlingbury
// Store ID: 6855427521bb01b10405e7a4
// Location: Orlingbury, NN14 1EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427521bb01b10405e7a4',
    storeName: 'Yojin Orlingbury',
    city: 'Orlingbury',
    postcode: 'NN14 1EF',
...
// Product API Service for Yojin Orlingbury
class YojinOrlingburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Orlingbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOrlingburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOrlingburyProductService };
