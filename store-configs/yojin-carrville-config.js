// Configuration for Yojin Carrville
// Store ID: 6855418d21bb01b10405e453
// Location: Carrville, DH1 2UJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418d21bb01b10405e453',
    storeName: 'Yojin Carrville',
    city: 'Carrville',
    postcode: 'DH1 2UJ',
...
// Product API Service for Yojin Carrville
class YojinCarrvilleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Carrville:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCarrvilleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCarrvilleProductService };
