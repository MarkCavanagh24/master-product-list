// Configuration for Yojin Harmondsworth
// Store ID: 685541fa21bb01b10405e5e1
// Location: Harmondsworth, TW6 2RL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fa21bb01b10405e5e1',
    storeName: 'Yojin Harmondsworth',
    city: 'Harmondsworth',
    postcode: 'TW6 2RL',
...
// Product API Service for Yojin Harmondsworth
class YojinHarmondsworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harmondsworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHarmondsworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHarmondsworthProductService };
