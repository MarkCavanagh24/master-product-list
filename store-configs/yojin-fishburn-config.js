// Configuration for Yojin Fishburn
// Store ID: 6855419321bb01b10405e469
// Location: Fishburn, TS29 6NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419321bb01b10405e469',
    storeName: 'Yojin Fishburn',
    city: 'Fishburn',
    postcode: 'TS29 6NB',
...
// Product API Service for Yojin Fishburn
class YojinFishburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fishburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFishburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFishburnProductService };
