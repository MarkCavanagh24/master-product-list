// Configuration for Yojin Felton
// Store ID: 6855428521bb01b10405e7db
// Location: Felton, BS40 9XB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428521bb01b10405e7db',
    storeName: 'Yojin Felton',
    city: 'Felton',
    postcode: 'BS40 9XB',
...
// Product API Service for Yojin Felton
class YojinFeltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Felton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFeltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFeltonProductService };
