// Configuration for Yojin Wrenthorpe
// Store ID: 6855425a21bb01b10405e740
// Location: Wrenthorpe, WF2 0PE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425a21bb01b10405e740',
    storeName: 'Yojin Wrenthorpe',
    city: 'Wrenthorpe',
    postcode: 'WF2 0PE',
...
// Product API Service for Yojin Wrenthorpe
class YojinWrenthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrenthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWrenthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWrenthorpeProductService };
