// Configuration for Yojin Penrith
// Store ID: 6855419121bb01b10405e462
// Location: Penrith, CA11 8SQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419121bb01b10405e462',
    storeName: 'Yojin Penrith',
    city: 'Penrith',
    postcode: 'CA11 8SQ',
...
// Product API Service for Yojin Penrith
class YojinPenrithProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Penrith:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPenrithProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPenrithProductService };
