// Configuration for Yojin Quidenham
// Store ID: 6855422121bb01b10405e66f
// Location: Quidenham, NR16 2JN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422121bb01b10405e66f',
    storeName: 'Yojin Quidenham',
    city: 'Quidenham',
    postcode: 'NR16 2JN',
...
// Product API Service for Yojin Quidenham
class YojinQuidenhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Quidenham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinQuidenhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinQuidenhamProductService };
