// Configuration for Yojin Newbury
// Store ID: 6855428721bb01b10405e7e5
// Location: Newbury, RG14 7TH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428721bb01b10405e7e5',
    storeName: 'Yojin Newbury',
    city: 'Newbury',
    postcode: 'RG14 7TH',
...
// Product API Service for Yojin Newbury
class YojinNewburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewburyProductService };
