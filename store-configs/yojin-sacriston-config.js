// Configuration for Yojin Sacriston
// Store ID: 6855418a21bb01b10405e449
// Location: Sacriston, DH7 0DZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418a21bb01b10405e449',
    storeName: 'Yojin Sacriston',
    city: 'Sacriston',
    postcode: 'DH7 0DZ',
...
// Product API Service for Yojin Sacriston
class YojinSacristonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sacriston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSacristonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSacristonProductService };
