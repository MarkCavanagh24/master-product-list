// Configuration for Yojin Harton
// Store ID: 6855419c21bb01b10405e488
// Location: Harton, YO60 7RU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419c21bb01b10405e488',
    storeName: 'Yojin Harton',
    city: 'Harton',
    postcode: 'YO60 7RU',
...
// Product API Service for Yojin Harton
class YojinHartonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHartonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHartonProductService };
