// Configuration for Yojin Scarisbrick
// Store ID: 6855426221bb01b10405e75f
// Location: Scarisbrick, L40 9RN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426221bb01b10405e75f',
    storeName: 'Yojin Scarisbrick',
    city: 'Scarisbrick',
    postcode: 'L40 9RN',
...
// Product API Service for Yojin Scarisbrick
class YojinScarisbrickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scarisbrick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScarisbrickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScarisbrickProductService };
