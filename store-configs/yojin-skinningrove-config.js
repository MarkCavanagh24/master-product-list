// Configuration for Yojin Skinningrove
// Store ID: 685541b021bb01b10405e4d4
// Location: Skinningrove, TS13 4JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b021bb01b10405e4d4',
    storeName: 'Yojin Skinningrove',
    city: 'Skinningrove',
    postcode: 'TS13 4JG',
...
// Product API Service for Yojin Skinningrove
class YojinSkinningroveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skinningrove:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkinningroveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkinningroveProductService };
