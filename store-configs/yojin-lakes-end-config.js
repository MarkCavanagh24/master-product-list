// Configuration for Yojin Lakes End
// Store ID: 685541c421bb01b10405e51d
// Location: Lakes End, PE14 9JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c421bb01b10405e51d',
    storeName: 'Yojin Lakes End',
    city: 'Lakes End',
    postcode: 'PE14 9JD',
...
// Product API Service for Yojin Lakes End
class YojinLakesEndProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lakes End:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLakesEndProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLakesEndProductService };
