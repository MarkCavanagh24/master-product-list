// Configuration for Yojin Cranbourne
// Store ID: 6855424821bb01b10405e6fd
// Location: Cranbourne, SL4 2ES

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424821bb01b10405e6fd',
    storeName: 'Yojin Cranbourne',
    city: 'Cranbourne',
    postcode: 'SL4 2ES',
...
// Product API Service for Yojin Cranbourne
class YojinCranbourneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cranbourne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCranbourneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCranbourneProductService };
