// Configuration for Yojin Pelaw
// Store ID: 6855418221bb01b10405e42b
// Location: Pelaw, NE10 0EY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418221bb01b10405e42b',
    storeName: 'Yojin Pelaw',
    city: 'Pelaw',
    postcode: 'NE10 0EY',
...
// Product API Service for Yojin Pelaw
class YojinPelawProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pelaw:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPelawProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPelawProductService };
