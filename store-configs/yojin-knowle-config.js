// Configuration for Yojin Knowle
// Store ID: 685541eb21bb01b10405e5ac
// Location: Knowle, B93 0FD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541eb21bb01b10405e5ac',
    storeName: 'Yojin Knowle',
    city: 'Knowle',
    postcode: 'B93 0FD',
...
// Product API Service for Yojin Knowle
class YojinKnowleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Knowle:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKnowleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKnowleProductService };
