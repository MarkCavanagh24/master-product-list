// Configuration for Yojin New Holland
// Store ID: 6855425d21bb01b10405e74b
// Location: New Holland, DN19 7QA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425d21bb01b10405e74b',
    storeName: 'Yojin New Holland',
    city: 'New Holland',
    postcode: 'DN19 7QA',
...
// Product API Service for Yojin New Holland
class YojinNewHollandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Holland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewHollandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewHollandProductService };
