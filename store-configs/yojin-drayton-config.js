// Configuration for Yojin Drayton
// Store ID: 685541cf21bb01b10405e544
// Location: Drayton, LE16 8ET

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cf21bb01b10405e544',
    storeName: 'Yojin Drayton',
    city: 'Drayton',
    postcode: 'LE16 8ET',
...
// Product API Service for Yojin Drayton
class YojinDraytonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Drayton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDraytonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDraytonProductService };
