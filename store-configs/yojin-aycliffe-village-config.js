// Configuration for Yojin Aycliffe Village
// Store ID: 685541aa21bb01b10405e4be
// Location: Aycliffe Village, DL5 6JH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541aa21bb01b10405e4be',
    storeName: 'Yojin Aycliffe Village',
    city: 'Aycliffe Village',
    postcode: 'DL5 6JH',
...
// Product API Service for Yojin Aycliffe Village
class YojinAycliffeVillageProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Aycliffe Village:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAycliffeVillageProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAycliffeVillageProductService };
