// Configuration for Yojin Cullingworth
// Store ID: 685541bb21bb01b10405e4fb
// Location: Cullingworth, BD13 5JX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bb21bb01b10405e4fb',
    storeName: 'Yojin Cullingworth',
    city: 'Cullingworth',
    postcode: 'BD13 5JX',
...
// Product API Service for Yojin Cullingworth
class YojinCullingworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cullingworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCullingworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCullingworthProductService };
