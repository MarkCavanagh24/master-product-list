// Configuration for Yojin Ulrome
// Store ID: 6855419f21bb01b10405e493
// Location: Ulrome, YO25 8TW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419f21bb01b10405e493',
    storeName: 'Yojin Ulrome',
    city: 'Ulrome',
    postcode: 'YO25 8TW',
...
// Product API Service for Yojin Ulrome
class YojinUlromeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ulrome:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUlromeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUlromeProductService };
