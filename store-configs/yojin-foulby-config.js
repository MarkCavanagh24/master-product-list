// Configuration for Yojin Foulby
// Store ID: 6855426021bb01b10405e757
// Location: Foulby, WF4 1QA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426021bb01b10405e757',
    storeName: 'Yojin Foulby',
    city: 'Foulby',
    postcode: 'WF4 1QA',
...
// Product API Service for Yojin Foulby
class YojinFoulbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Foulby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFoulbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFoulbyProductService };
