// Configuration for Yojin Farnborough
// Store ID: 685541ff21bb01b10405e5f3
// Location: Farnborough, GU14 8LG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ff21bb01b10405e5f3',
    storeName: 'Yojin Farnborough',
    city: 'Farnborough',
    postcode: 'GU14 8LG',
...
// Product API Service for Yojin Farnborough
class YojinFarnboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Farnborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFarnboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFarnboroughProductService };
