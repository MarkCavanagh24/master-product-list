// Configuration for Yojin Howden le Wear
// Store ID: 6855419221bb01b10405e465
// Location: Howden le Wear, DL15 8BG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419221bb01b10405e465',
    storeName: 'Yojin Howden le Wear',
    city: 'Howden le Wear',
    postcode: 'DL15 8BG',
...
// Product API Service for Yojin Howden le Wear
class YojinHowdenleWearProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Howden le Wear:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHowdenleWearProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHowdenleWearProductService };
