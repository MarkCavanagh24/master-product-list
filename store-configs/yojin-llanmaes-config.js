// Configuration for Yojin Llanmaes
// Store ID: 6855424221bb01b10405e6e9
// Location: Llanmaes, CF71 7LQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424221bb01b10405e6e9',
    storeName: 'Yojin Llanmaes',
    city: 'Llanmaes',
    postcode: 'CF71 7LQ',
...
// Product API Service for Yojin Llanmaes
class YojinLlanmaesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Llanmaes:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLlanmaesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLlanmaesProductService };
