// Configuration for Yojin Andover
// Store ID: 6855425621bb01b10405e732
// Location: Andover, SP10 1DX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425621bb01b10405e732',
    storeName: 'Yojin Andover',
    city: 'Andover',
    postcode: 'SP10 1DX',
...
// Product API Service for Yojin Andover
class YojinAndoverProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Andover:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAndoverProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAndoverProductService };
