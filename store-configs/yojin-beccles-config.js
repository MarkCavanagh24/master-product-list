// Configuration for Yojin Beccles
// Store ID: 685541e821bb01b10405e5a2
// Location: Beccles, NR34 8LQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e821bb01b10405e5a2',
    storeName: 'Yojin Beccles',
    city: 'Beccles',
    postcode: 'NR34 8LQ',
...
// Product API Service for Yojin Beccles
class YojinBecclesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Beccles:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBecclesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBecclesProductService };
