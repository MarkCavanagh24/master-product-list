// Configuration for Yojin Scarborough
// Store ID: 6855422a21bb01b10405e690
// Location: Scarborough, YO11 2YW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422a21bb01b10405e690',
    storeName: 'Yojin Scarborough',
    city: 'Scarborough',
    postcode: 'YO11 2YW',
...
// Product API Service for Yojin Scarborough
class YojinScarboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scarborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScarboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScarboroughProductService };
