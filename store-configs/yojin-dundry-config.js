// Configuration for Yojin Dundry
// Store ID: 6855428521bb01b10405e7dc
// Location: Dundry, BS41 8LW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428521bb01b10405e7dc',
    storeName: 'Yojin Dundry',
    city: 'Dundry',
    postcode: 'BS41 8LW',
...
// Product API Service for Yojin Dundry
class YojinDundryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dundry:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDundryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDundryProductService };
