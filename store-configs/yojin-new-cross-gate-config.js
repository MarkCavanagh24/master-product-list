// Configuration for Yojin New Cross Gate
// Store ID: 6855424021bb01b10405e6e1
// Location: New Cross Gate, SE14 6DH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424021bb01b10405e6e1',
    storeName: 'Yojin New Cross Gate',
    city: 'New Cross Gate',
    postcode: 'SE14 6DH',
...
// Product API Service for Yojin New Cross Gate
class YojinNewCrossGateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Cross Gate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewCrossGateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewCrossGateProductService };
