// Configuration for Yojin Doddington
// Store ID: 6855422021bb01b10405e66b
// Location: Doddington, PE26 2XS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422021bb01b10405e66b',
    storeName: 'Yojin Doddington',
    city: 'Doddington',
    postcode: 'PE26 2XS',
...
// Product API Service for Yojin Doddington
class YojinDoddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Doddington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDoddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDoddingtonProductService };
