// Configuration for Yojin Slaley
// Store ID: 6855418421bb01b10405e432
// Location: Slaley, NE47 0BL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418421bb01b10405e432',
    storeName: 'Yojin Slaley',
    city: 'Slaley',
    postcode: 'NE47 0BL',
...
// Product API Service for Yojin Slaley
class YojinSlaleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Slaley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSlaleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSlaleyProductService };
