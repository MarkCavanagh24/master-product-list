// Configuration for Yojin Once Brewed
// Store ID: 6855417c21bb01b10405e413
// Location: Once Brewed, NE47 7AW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417c21bb01b10405e413',
    storeName: 'Yojin Once Brewed',
    city: 'Once Brewed',
    postcode: 'NE47 7AW',
...
// Product API Service for Yojin Once Brewed
class YojinOnceBrewedProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Once Brewed:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOnceBrewedProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOnceBrewedProductService };
