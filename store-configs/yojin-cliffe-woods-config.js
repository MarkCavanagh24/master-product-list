// Configuration for Yojin Cliffe Woods
// Store ID: 6855428321bb01b10405e7d6
// Location: Cliffe Woods, ME3 7TJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428321bb01b10405e7d6',
    storeName: 'Yojin Cliffe Woods',
    city: 'Cliffe Woods',
    postcode: 'ME3 7TJ',
...
// Product API Service for Yojin Cliffe Woods
class YojinCliffeWoodsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cliffe Woods:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCliffeWoodsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCliffeWoodsProductService };
