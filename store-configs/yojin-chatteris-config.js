// Configuration for Yojin Chatteris
// Store ID: 685541e521bb01b10405e595
// Location: Chatteris, PE16 6SQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e521bb01b10405e595',
    storeName: 'Yojin Chatteris',
    city: 'Chatteris',
    postcode: 'PE16 6SQ',
...
// Product API Service for Yojin Chatteris
class YojinChatterisProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chatteris:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChatterisProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChatterisProductService };
