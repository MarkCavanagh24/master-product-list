// Configuration for Yojin Snods Edge
// Store ID: 6855418721bb01b10405e43e
// Location: Snods Edge, DH8 9TH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418721bb01b10405e43e',
    storeName: 'Yojin Snods Edge',
    city: 'Snods Edge',
    postcode: 'DH8 9TH',
...
// Product API Service for Yojin Snods Edge
class YojinSnodsEdgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Snods Edge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSnodsEdgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSnodsEdgeProductService };
