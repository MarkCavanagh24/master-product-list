// Configuration for Yojin Ash
// Store ID: 6855424e21bb01b10405e714
// Location: Ash, GU12 5DX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424e21bb01b10405e714',
    storeName: 'Yojin Ash',
    city: 'Ash',
    postcode: 'GU12 5DX',
...
// Product API Service for Yojin Ash
class YojinAshProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ash:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshProductService };
