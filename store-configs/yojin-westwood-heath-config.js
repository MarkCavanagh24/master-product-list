// Configuration for Yojin Westwood Heath
// Store ID: 685541eb21bb01b10405e5ae
// Location: Westwood Heath, CV4 8BB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541eb21bb01b10405e5ae',
    storeName: 'Yojin Westwood Heath',
    city: 'Westwood Heath',
    postcode: 'CV4 8BB',
...
// Product API Service for Yojin Westwood Heath
class YojinWestwoodHeathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Westwood Heath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestwoodHeathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestwoodHeathProductService };
