// Configuration for Yojin Wadenhoe
// Store ID: 685541e321bb01b10405e58f
// Location: Wadenhoe, PE8 5SU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e321bb01b10405e58f',
    storeName: 'Yojin Wadenhoe',
    city: 'Wadenhoe',
    postcode: 'PE8 5SU',
...
// Product API Service for Yojin Wadenhoe
class YojinWadenhoeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wadenhoe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWadenhoeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWadenhoeProductService };
