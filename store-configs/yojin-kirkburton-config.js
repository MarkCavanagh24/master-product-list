// Configuration for Yojin Kirkburton
// Store ID: 6855426621bb01b10405e76d
// Location: Kirkburton, HD8 0SQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426621bb01b10405e76d',
    storeName: 'Yojin Kirkburton',
    city: 'Kirkburton',
    postcode: 'HD8 0SQ',
...
// Product API Service for Yojin Kirkburton
class YojinKirkburtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkburton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkburtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkburtonProductService };
