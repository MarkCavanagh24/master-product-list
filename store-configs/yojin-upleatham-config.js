// Configuration for Yojin Upleatham
// Store ID: 685541b021bb01b10405e4d2
// Location: Upleatham, TS11 8AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b021bb01b10405e4d2',
    storeName: 'Yojin Upleatham',
    city: 'Upleatham',
    postcode: 'TS11 8AG',
...
// Product API Service for Yojin Upleatham
class YojinUpleathamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Upleatham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpleathamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpleathamProductService };
