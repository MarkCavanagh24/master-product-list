// Configuration for Yojin Walcote
// Store ID: 685541e121bb01b10405e586
// Location: Walcote, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e121bb01b10405e586',
    storeName: 'Yojin Walcote',
    city: 'Walcote',
    postcode: 'N/A',
...
// Product API Service for Yojin Walcote
class YojinWalcoteProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walcote:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWalcoteProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWalcoteProductService };
