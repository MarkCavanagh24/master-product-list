// Configuration for Yojin Lutton
// Store ID: 6855421f21bb01b10405e666
// Location: Lutton, PE8 5NE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421f21bb01b10405e666',
    storeName: 'Yojin Lutton',
    city: 'Lutton',
    postcode: 'PE8 5NE',
...
// Product API Service for Yojin Lutton
class YojinLuttonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lutton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLuttonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLuttonProductService };
