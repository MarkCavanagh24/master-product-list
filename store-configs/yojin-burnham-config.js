// Configuration for Yojin Burnham
// Store ID: 685541ee21bb01b10405e5b8
// Location: Burnham, SL6 0PF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ee21bb01b10405e5b8',
    storeName: 'Yojin Burnham',
    city: 'Burnham',
    postcode: 'SL6 0PF',
...
// Product API Service for Yojin Burnham
class YojinBurnhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burnham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnhamProductService };
