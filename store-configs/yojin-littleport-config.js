// Configuration for Yojin Littleport
// Store ID: 6855422121bb01b10405e66d
// Location: Littleport, CB6 1SE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422121bb01b10405e66d',
    storeName: 'Yojin Littleport',
    city: 'Littleport',
    postcode: 'CB6 1SE',
...
// Product API Service for Yojin Littleport
class YojinLittleportProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Littleport:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLittleportProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLittleportProductService };
