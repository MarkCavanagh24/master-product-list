// Configuration for Yojin Neasham
// Store ID: 685541d221bb01b10405e54e
// Location: Neasham, DL2 1PH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d221bb01b10405e54e',
    storeName: 'Yojin Neasham',
    city: 'Neasham',
    postcode: 'DL2 1PH',
...
// Product API Service for Yojin Neasham
class YojinNeashamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Neasham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNeashamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNeashamProductService };
