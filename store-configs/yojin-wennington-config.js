// Configuration for Yojin Wennington
// Store ID: 6855426b21bb01b10405e77e
// Location: Wennington, LA2 8NX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426b21bb01b10405e77e',
    storeName: 'Yojin Wennington',
    city: 'Wennington',
    postcode: 'LA2 8NX',
...
// Product API Service for Yojin Wennington
class YojinWenningtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wennington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWenningtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWenningtonProductService };
