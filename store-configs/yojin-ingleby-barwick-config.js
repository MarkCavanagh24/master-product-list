// Configuration for Yojin Ingleby Barwick
// Store ID: 685541b321bb01b10405e4de
// Location: Ingleby Barwick, TS17 5JS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b321bb01b10405e4de',
    storeName: 'Yojin Ingleby Barwick',
...
// Product API Service for Yojin Ingleby Barwick
class YojinInglebyBarwickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ingleby Barwick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinInglebyBarwickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinInglebyBarwickProductService };
