// Configuration for Yojin Royal Wootton Bassett
// Store ID: 685541ec21bb01b10405e5b0
// Location: Royal Wootton Bassett, SN4 7QR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ec21bb01b10405e5b0',
    storeName: 'Yojin Royal Wootton Bassett',
...
// Product API Service for Yojin Royal Wootton Bassett
class YojinRoyalWoottonBassettProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Royal Wootton Bassett:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRoyalWoottonBassettProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRoyalWoottonBassettProductService };
