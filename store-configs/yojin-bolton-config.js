// Configuration for Yojin Bolton
// Store ID: 685541a221bb01b10405e49e
// Location: Bolton, YO41 5NZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a221bb01b10405e49e',
    storeName: 'Yojin Bolton',
    city: 'Bolton',
    postcode: 'YO41 5NZ',
...
// Product API Service for Yojin Bolton
class YojinBoltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bolton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBoltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBoltonProductService };
