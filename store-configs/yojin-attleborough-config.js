// Configuration for Yojin Attleborough
// Store ID: 6855421721bb01b10405e64a
// Location: Attleborough, NR17 1AD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421721bb01b10405e64a',
    storeName: 'Yojin Attleborough',
    city: 'Attleborough',
    postcode: 'NR17 1AD',
...
// Product API Service for Yojin Attleborough
class YojinAttleboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Attleborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAttleboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAttleboroughProductService };
