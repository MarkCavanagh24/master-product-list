// Configuration for Yojin Ellerton-on-Swale
// Store ID: 685541d921bb01b10405e568
// Location: Ellerton-on-Swale, DL10 6BB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d921bb01b10405e568',
    storeName: 'Yojin Ellerton-on-Swale',
    city: 'Ellerton-on-Swale',
    postcode: 'DL10 6BB',
...
// Product API Service for Yojin Ellerton-on-Swale
class YojinEllertononSwaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ellerton-on-Swale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEllertononSwaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEllertononSwaleProductService };
