// Configuration for Yojin Bellerby
// Store ID: 685541db21bb01b10405e570
// Location: Bellerby, DL8 5JL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541db21bb01b10405e570',
    storeName: 'Yojin Bellerby',
    city: 'Bellerby',
    postcode: 'DL8 5JL',
...
// Product API Service for Yojin Bellerby
class YojinBellerbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bellerby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBellerbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBellerbyProductService };
