// Configuration for Yojin Bremhill
// Store ID: 685541f721bb01b10405e5d8
// Location: Bremhill, SN11 9HP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f721bb01b10405e5d8',
    storeName: 'Yojin Bremhill',
    city: 'Bremhill',
    postcode: 'SN11 9HP',
...
// Product API Service for Yojin Bremhill
class YojinBremhillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bremhill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBremhillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBremhillProductService };
