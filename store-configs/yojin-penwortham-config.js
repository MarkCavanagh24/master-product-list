// Configuration for Yojin Penwortham
// Store ID: 6855420c21bb01b10405e622
// Location: Penwortham, PR1 9QE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420c21bb01b10405e622',
    storeName: 'Yojin Penwortham',
    city: 'Penwortham',
    postcode: 'PR1 9QE',
...
// Product API Service for Yojin Penwortham
class YojinPenworthamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Penwortham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPenworthamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPenworthamProductService };
