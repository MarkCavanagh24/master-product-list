// Configuration for Yojin Lapworth
// Store ID: 6855423a21bb01b10405e6ce
// Location: Lapworth, B94 6HP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423a21bb01b10405e6ce',
    storeName: 'Yojin Lapworth',
    city: 'Lapworth',
    postcode: 'B94 6HP',
...
// Product API Service for Yojin Lapworth
class YojinLapworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lapworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLapworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLapworthProductService };
