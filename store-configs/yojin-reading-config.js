// Configuration for Yojin Reading
// Store ID: 6855424721bb01b10405e6f9
// Location: Reading, RG2 7LL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424721bb01b10405e6f9',
    storeName: 'Yojin Reading',
    city: 'Reading',
    postcode: 'RG2 7LL',
...
// Product API Service for Yojin Reading
class YojinReadingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Reading:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinReadingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinReadingProductService };
