// Configuration for Yojin Hunningham
// Store ID: 6855428021bb01b10405e7cb
// Location: Hunningham, CV33 9AE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428021bb01b10405e7cb',
    storeName: 'Yojin Hunningham',
    city: 'Hunningham',
    postcode: 'CV33 9AE',
...
// Product API Service for Yojin Hunningham
class YojinHunninghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hunningham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHunninghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHunninghamProductService };
