// Configuration for Yojin Beadlam
// Store ID: 6855422821bb01b10405e689
// Location: Beadlam, YO62 7TU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422821bb01b10405e689',
    storeName: 'Yojin Beadlam',
    city: 'Beadlam',
    postcode: 'YO62 7TU',
...
// Product API Service for Yojin Beadlam
class YojinBeadlamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Beadlam:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBeadlamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBeadlamProductService };
