// Configuration for Yojin Heighington
// Store ID: 685541aa21bb01b10405e4bd
// Location: Heighington, DL5 6NX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541aa21bb01b10405e4bd',
    storeName: 'Yojin Heighington',
    city: 'Heighington',
    postcode: 'DL5 6NX',
...
// Product API Service for Yojin Heighington
class YojinHeighingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heighington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeighingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeighingtonProductService };
