// Configuration for Yojin Compton
// Store ID: 6855425721bb01b10405e737
// Location: Compton, GU3 1DT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425721bb01b10405e737',
    storeName: 'Yojin Compton',
    city: 'Compton',
    postcode: 'GU3 1DT',
...
// Product API Service for Yojin Compton
class YojinComptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Compton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinComptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinComptonProductService };
