// Configuration for Yojin Hutton Conyers
// Store ID: 6855423021bb01b10405e6a6
// Location: Hutton Conyers, HG4 5LZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423021bb01b10405e6a6',
    storeName: 'Yojin Hutton Conyers',
    city: 'Hutton Conyers',
    postcode: 'HG4 5LZ',
...
// Product API Service for Yojin Hutton Conyers
class YojinHuttonConyersProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hutton Conyers:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHuttonConyersProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHuttonConyersProductService };
