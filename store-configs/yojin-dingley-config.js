// Configuration for Yojin Dingley
// Store ID: 6855421d21bb01b10405e660
// Location: Dingley, LE16 8PQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421d21bb01b10405e660',
    storeName: 'Yojin Dingley',
    city: 'Dingley',
    postcode: 'LE16 8PQ',
...
// Product API Service for Yojin Dingley
class YojinDingleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dingley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDingleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDingleyProductService };
