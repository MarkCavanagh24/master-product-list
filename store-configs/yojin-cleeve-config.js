// Configuration for Yojin Cleeve
// Store ID: 6855428421bb01b10405e7da
// Location: Cleeve, BS49 4PN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428421bb01b10405e7da',
    storeName: 'Yojin Cleeve',
    city: 'Cleeve',
    postcode: 'BS49 4PN',
...
// Product API Service for Yojin Cleeve
class YojinCleeveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cleeve:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCleeveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCleeveProductService };
