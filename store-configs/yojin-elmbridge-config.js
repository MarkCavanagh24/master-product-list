// Configuration for Yojin Elmbridge
// Store ID: 6855427e21bb01b10405e7c3
// Location: Elmbridge, WR9 0LZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427e21bb01b10405e7c3',
    storeName: 'Yojin Elmbridge',
    city: 'Elmbridge',
    postcode: 'WR9 0LZ',
...
// Product API Service for Yojin Elmbridge
class YojinElmbridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Elmbridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinElmbridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinElmbridgeProductService };
