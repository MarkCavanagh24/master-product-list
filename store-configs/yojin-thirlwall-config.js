// Configuration for Yojin Thirlwall
// Store ID: 6855417c21bb01b10405e412
// Location: Thirlwall, CA8 7HX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417c21bb01b10405e412',
    storeName: 'Yojin Thirlwall',
    city: 'Thirlwall',
    postcode: 'CA8 7HX',
...
// Product API Service for Yojin Thirlwall
class YojinThirlwallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thirlwall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThirlwallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThirlwallProductService };
