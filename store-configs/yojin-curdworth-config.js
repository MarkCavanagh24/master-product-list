// Configuration for Yojin Curdworth
// Store ID: 685541cc21bb01b10405e538
// Location: Curdworth, B46 1TT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cc21bb01b10405e538',
    storeName: 'Yojin Curdworth',
    city: 'Curdworth',
    postcode: 'B46 1TT',
...
// Product API Service for Yojin Curdworth
class YojinCurdworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Curdworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCurdworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCurdworthProductService };
