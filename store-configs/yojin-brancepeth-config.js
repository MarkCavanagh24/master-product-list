// Configuration for Yojin Brancepeth
// Store ID: 6855419021bb01b10405e45c
// Location: Brancepeth, DL15 9AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419021bb01b10405e45c',
    storeName: 'Yojin Brancepeth',
    city: 'Brancepeth',
    postcode: 'DL15 9AT',
...
// Product API Service for Yojin Brancepeth
class YojinBrancepethProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brancepeth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrancepethProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrancepethProductService };
