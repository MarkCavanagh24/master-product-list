// Configuration for Yojin Brompton
// Store ID: 6855422e21bb01b10405e69e
// Location: Brompton, YO13 9DH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422e21bb01b10405e69e',
    storeName: 'Yojin Brompton',
    city: 'Brompton',
    postcode: 'YO13 9DH',
...
// Product API Service for Yojin Brompton
class YojinBromptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brompton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBromptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBromptonProductService };
