// Configuration for Yojin Iver Heath
// Store ID: 685541ef21bb01b10405e5ba
// Location: Iver Heath, SL0 0LD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ef21bb01b10405e5ba',
    storeName: 'Yojin Iver Heath',
    city: 'Iver Heath',
    postcode: 'SL0 0LD',
...
// Product API Service for Yojin Iver Heath
class YojinIverHeathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Iver Heath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIverHeathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIverHeathProductService };
