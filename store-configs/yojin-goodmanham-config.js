// Configuration for Yojin Goodmanham
// Store ID: 685541b821bb01b10405e4f0
// Location: Goodmanham, YO43 4NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b821bb01b10405e4f0',
    storeName: 'Yojin Goodmanham',
    city: 'Goodmanham',
    postcode: 'YO43 4NB',
...
// Product API Service for Yojin Goodmanham
class YojinGoodmanhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Goodmanham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGoodmanhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGoodmanhamProductService };
