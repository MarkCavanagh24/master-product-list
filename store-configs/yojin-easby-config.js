// Configuration for Yojin Easby
// Store ID: 685541d321bb01b10405e552
// Location: Easby, TS9 6LQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d321bb01b10405e552',
    storeName: 'Yojin Easby',
    city: 'Easby',
    postcode: 'TS9 6LQ',
...
// Product API Service for Yojin Easby
class YojinEasbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Easby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEasbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEasbyProductService };
