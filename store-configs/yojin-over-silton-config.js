// Configuration for Yojin Over Silton
// Store ID: 685541dd21bb01b10405e577
// Location: Over Silton, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dd21bb01b10405e577',
    storeName: 'Yojin Over Silton',
    city: 'Over Silton',
    postcode: 'N/A',
...
// Product API Service for Yojin Over Silton
class YojinOverSiltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Over Silton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOverSiltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOverSiltonProductService };
