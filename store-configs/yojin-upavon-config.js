// Configuration for Yojin Upavon
// Store ID: 685541fc21bb01b10405e5eb
// Location: Upavon, SN9 6JS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fc21bb01b10405e5eb',
    storeName: 'Yojin Upavon',
    city: 'Upavon',
    postcode: 'SN9 6JS',
...
// Product API Service for Yojin Upavon
class YojinUpavonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Upavon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpavonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpavonProductService };
