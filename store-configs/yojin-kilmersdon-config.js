// Configuration for Yojin Kilmersdon
// Store ID: 6855420621bb01b10405e60c
// Location: Kilmersdon, BA11 3RP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420621bb01b10405e60c',
    storeName: 'Yojin Kilmersdon',
    city: 'Kilmersdon',
    postcode: 'BA11 3RP',
...
// Product API Service for Yojin Kilmersdon
class YojinKilmersdonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kilmersdon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKilmersdonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKilmersdonProductService };
