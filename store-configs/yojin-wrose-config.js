// Configuration for Yojin Wrose
// Store ID: 685541bb21bb01b10405e4fd
// Location: Wrose, BD10 8QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bb21bb01b10405e4fd',
    storeName: 'Yojin Wrose',
    city: 'Wrose',
    postcode: 'BD10 8QJ',
...
// Product API Service for Yojin Wrose
class YojinWroseProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrose:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWroseProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWroseProductService };
