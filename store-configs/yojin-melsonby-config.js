// Configuration for Yojin Melsonby
// Store ID: 685541b521bb01b10405e4e7
// Location: Melsonby, DL10 5PN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b521bb01b10405e4e7',
    storeName: 'Yojin Melsonby',
    city: 'Melsonby',
    postcode: 'DL10 5PN',
...
// Product API Service for Yojin Melsonby
class YojinMelsonbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Melsonby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMelsonbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMelsonbyProductService };
