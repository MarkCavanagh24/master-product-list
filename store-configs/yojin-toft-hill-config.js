// Configuration for Yojin Toft Hill
// Store ID: 6855419521bb01b10405e46f
// Location: Toft Hill, DL14 0JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419521bb01b10405e46f',
    storeName: 'Yojin Toft Hill',
    city: 'Toft Hill',
    postcode: 'DL14 0JB',
...
// Product API Service for Yojin Toft Hill
class YojinToftHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Toft Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinToftHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinToftHillProductService };
