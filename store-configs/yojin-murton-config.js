// Configuration for Yojin Murton
// Store ID: 685541ac21bb01b10405e4c4
// Location: Murton, CA16 6LN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ac21bb01b10405e4c4',
    storeName: 'Yojin Murton',
    city: 'Murton',
    postcode: 'CA16 6LN',
...
// Product API Service for Yojin Murton
class YojinMurtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Murton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMurtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMurtonProductService };
