// Configuration for Yojin Wadsworth
// Store ID: 685541c221bb01b10405e515
// Location: Wadsworth, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c221bb01b10405e515',
    storeName: 'Yojin Wadsworth',
    city: 'Wadsworth',
    postcode: 'N/A',
...
// Product API Service for Yojin Wadsworth
class YojinWadsworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wadsworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWadsworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWadsworthProductService };
