// Configuration for Yojin Warboys
// Store ID: 6855423521bb01b10405e6ba
// Location: Warboys, PE28 2SH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423521bb01b10405e6ba',
    storeName: 'Yojin Warboys',
    city: 'Warboys',
    postcode: 'PE28 2SH',
...
// Product API Service for Yojin Warboys
class YojinWarboysProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Warboys:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWarboysProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWarboysProductService };
