// Configuration for Yojin Gainford
// Store ID: 685541ad21bb01b10405e4c8
// Location: Gainford, DL2 3QH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ad21bb01b10405e4c8',
    storeName: 'Yojin Gainford',
    city: 'Gainford',
    postcode: 'DL2 3QH',
...
// Product API Service for Yojin Gainford
class YojinGainfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gainford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGainfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGainfordProductService };
