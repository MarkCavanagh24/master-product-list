// Configuration for Yojin Finedon
// Store ID: 6855427521bb01b10405e7a5
// Location: Finedon, NN9 5NT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427521bb01b10405e7a5',
    storeName: 'Yojin Finedon',
    city: 'Finedon',
    postcode: 'NN9 5NT',
...
// Product API Service for Yojin Finedon
class YojinFinedonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Finedon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFinedonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFinedonProductService };
