// Configuration for Yojin Deopham
// Store ID: 685541c621bb01b10405e524
// Location: Deopham, NR18 9EA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c621bb01b10405e524',
    storeName: 'Yojin Deopham',
    city: 'Deopham',
    postcode: 'NR18 9EA',
...
// Product API Service for Yojin Deopham
class YojinDeophamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Deopham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDeophamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDeophamProductService };
