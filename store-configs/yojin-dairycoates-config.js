// Configuration for Yojin Dairycoates
// Store ID: 6855421221bb01b10405e636
// Location: Dairycoates, HU3 2RA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421221bb01b10405e636',
    storeName: 'Yojin Dairycoates',
    city: 'Dairycoates',
    postcode: 'HU3 2RA',
...
// Product API Service for Yojin Dairycoates
class YojinDairycoatesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dairycoates:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDairycoatesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDairycoatesProductService };
