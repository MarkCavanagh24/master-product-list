// Configuration for Yojin Whiteclosegate
// Store ID: 6855418321bb01b10405e42e
// Location: Whiteclosegate, CA3 9ER

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418321bb01b10405e42e',
    storeName: 'Yojin Whiteclosegate',
    city: 'Whiteclosegate',
    postcode: 'CA3 9ER',
...
// Product API Service for Yojin Whiteclosegate
class YojinWhiteclosegateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whiteclosegate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhiteclosegateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhiteclosegateProductService };
