// Configuration for Yojin Burn Bridge
// Store ID: 685541a021bb01b10405e496
// Location: Burn Bridge, HG3 1PL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a021bb01b10405e496',
    storeName: 'Yojin Burn Bridge',
    city: 'Burn Bridge',
    postcode: 'HG3 1PL',
...
// Product API Service for Yojin Burn Bridge
class YojinBurnBridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burn Bridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnBridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnBridgeProductService };
