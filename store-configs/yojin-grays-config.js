// Configuration for Yojin Grays
// Store ID: 6855424221bb01b10405e6e6
// Location: Grays, RM17 5XR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424221bb01b10405e6e6',
    storeName: 'Yojin Grays',
    city: 'Grays',
    postcode: 'RM17 5XR',
...
// Product API Service for Yojin Grays
class YojinGraysProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Grays:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGraysProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGraysProductService };
