// Configuration for Yojin Haswell
// Store ID: 6855418d21bb01b10405e454
// Location: Haswell, DH6 2AA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418d21bb01b10405e454',
    storeName: 'Yojin Haswell',
    city: 'Haswell',
    postcode: 'DH6 2AA',
...
// Product API Service for Yojin Haswell
class YojinHaswellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Haswell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaswellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaswellProductService };
