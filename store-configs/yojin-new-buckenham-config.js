// Configuration for Yojin New Buckenham
// Store ID: 6855422121bb01b10405e670
// Location: New Buckenham, NR16 2AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422121bb01b10405e670',
    storeName: 'Yojin New Buckenham',
    city: 'New Buckenham',
    postcode: 'NR16 2AY',
...
// Product API Service for Yojin New Buckenham
class YojinNewBuckenhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Buckenham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewBuckenhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewBuckenhamProductService };
