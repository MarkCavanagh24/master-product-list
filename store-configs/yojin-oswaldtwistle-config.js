// Configuration for Yojin Oswaldtwistle
// Store ID: 6855420d21bb01b10405e625
// Location: Oswaldtwistle, BB5 3QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420d21bb01b10405e625',
    storeName: 'Yojin Oswaldtwistle',
    city: 'Oswaldtwistle',
    postcode: 'BB5 3QT',
...
// Product API Service for Yojin Oswaldtwistle
class YojinOswaldtwistleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oswaldtwistle:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOswaldtwistleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOswaldtwistleProductService };
