// Configuration for Yojin Farleigh Wallop
// Store ID: 6855425721bb01b10405e734
// Location: Farleigh Wallop, RG25 2HR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425721bb01b10405e734',
    storeName: 'Yojin Farleigh Wallop',
    city: 'Farleigh Wallop',
    postcode: 'RG25 2HR',
...
// Product API Service for Yojin Farleigh Wallop
class YojinFarleighWallopProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Farleigh Wallop:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFarleighWallopProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFarleighWallopProductService };
