// Configuration for Yojin Walton
// Store ID: 6855426021bb01b10405e756
// Location: Walton, WF2 6NL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426021bb01b10405e756',
    storeName: 'Yojin Walton',
    city: 'Walton',
    postcode: 'WF2 6NL',
...
// Product API Service for Yojin Walton
class YojinWaltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWaltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWaltonProductService };
