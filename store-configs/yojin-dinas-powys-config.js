// Configuration for Yojin Dinas Powys
// Store ID: 6855424321bb01b10405e6ea
// Location: Dinas Powys, CF5 6AF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424321bb01b10405e6ea',
    storeName: 'Yojin Dinas Powys',
    city: 'Dinas Powys',
    postcode: 'CF5 6AF',
...
// Product API Service for Yojin Dinas Powys
class YojinDinasPowysProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dinas Powys:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDinasPowysProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDinasPowysProductService };
