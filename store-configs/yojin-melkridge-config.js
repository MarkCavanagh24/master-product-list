// Configuration for Yojin Melkridge
// Store ID: 6855418021bb01b10405e422
// Location: Melkridge, NE47 7EX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418021bb01b10405e422',
    storeName: 'Yojin Melkridge',
    city: 'Melkridge',
    postcode: 'NE47 7EX',
...
// Product API Service for Yojin Melkridge
class YojinMelkridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Melkridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMelkridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMelkridgeProductService };
