// Configuration for Yojin Hudswell
// Store ID: 685541d821bb01b10405e565
// Location: Hudswell, DL11 6AA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d821bb01b10405e565',
    storeName: 'Yojin Hudswell',
    city: 'Hudswell',
    postcode: 'DL11 6AA',
...
// Product API Service for Yojin Hudswell
class YojinHudswellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hudswell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHudswellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHudswellProductService };
