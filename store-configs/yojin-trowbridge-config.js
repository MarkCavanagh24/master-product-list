// Configuration for Yojin Trowbridge
// Store ID: 685541f521bb01b10405e5cf
// Location: Trowbridge, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f521bb01b10405e5cf',
    storeName: 'Yojin Trowbridge',
    city: 'Trowbridge',
    postcode: 'N/A',
...
// Product API Service for Yojin Trowbridge
class YojinTrowbridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Trowbridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTrowbridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTrowbridgeProductService };
