// Configuration for Yojin Cowpen Bewley
// Store ID: 685541ab21bb01b10405e4c1
// Location: Cowpen Bewley, TS23 4HS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ab21bb01b10405e4c1',
    storeName: 'Yojin Cowpen Bewley',
    city: 'Cowpen Bewley',
    postcode: 'TS23 4HS',
...
// Product API Service for Yojin Cowpen Bewley
class YojinCowpenBewleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cowpen Bewley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCowpenBewleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCowpenBewleyProductService };
