// Configuration for Yojin Chartham
// Store ID: 6855425221bb01b10405e724
// Location: Chartham, CT4 7HR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425221bb01b10405e724',
    storeName: 'Yojin Chartham',
    city: 'Chartham',
    postcode: 'CT4 7HR',
...
// Product API Service for Yojin Chartham
class YojinCharthamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chartham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCharthamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCharthamProductService };
