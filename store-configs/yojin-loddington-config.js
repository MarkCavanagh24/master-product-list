// Configuration for Yojin Loddington
// Store ID: 6855423321bb01b10405e6b3
// Location: Loddington, NN14 1LB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423321bb01b10405e6b3',
    storeName: 'Yojin Loddington',
    city: 'Loddington',
    postcode: 'NN14 1LB',
...
// Product API Service for Yojin Loddington
class YojinLoddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Loddington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLoddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLoddingtonProductService };
