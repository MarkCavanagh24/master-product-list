// Configuration for Yojin Benefield
// Store ID: 6855421e21bb01b10405e663
// Location: Benefield, PE8 5AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421e21bb01b10405e663',
    storeName: 'Yojin Benefield',
    city: 'Benefield',
    postcode: 'PE8 5AG',
...
// Product API Service for Yojin Benefield
class YojinBenefieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Benefield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBenefieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBenefieldProductService };
