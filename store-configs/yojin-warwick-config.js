// Configuration for Yojin Warwick
// Store ID: 6855428021bb01b10405e7c9
// Location: Warwick, CV35 7PX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428021bb01b10405e7c9',
    storeName: 'Yojin Warwick',
    city: 'Warwick',
    postcode: 'CV35 7PX',
...
// Product API Service for Yojin Warwick
class YojinWarwickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Warwick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWarwickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWarwickProductService };
