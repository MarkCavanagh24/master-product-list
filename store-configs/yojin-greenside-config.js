// Configuration for Yojin Greenside
// Store ID: 6855418121bb01b10405e428
// Location: Greenside, NE40 4BL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418121bb01b10405e428',
    storeName: 'Yojin Greenside',
    city: 'Greenside',
    postcode: 'NE40 4BL',
...
// Product API Service for Yojin Greenside
class YojinGreensideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Greenside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreensideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreensideProductService };
