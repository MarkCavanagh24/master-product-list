// Configuration for Yojin Higher Walton
// Store ID: 6855420d21bb01b10405e623
// Location: Higher Walton, PR5 4EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420d21bb01b10405e623',
    storeName: 'Yojin Higher Walton',
    city: 'Higher Walton',
    postcode: 'PR5 4EF',
...
// Product API Service for Yojin Higher Walton
class YojinHigherWaltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Higher Walton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHigherWaltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHigherWaltonProductService };
