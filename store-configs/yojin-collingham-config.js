// Configuration for Yojin Collingham
// Store ID: 685541a521bb01b10405e4ab
// Location: Collingham, LS22 4JA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a521bb01b10405e4ab',
    storeName: 'Yojin Collingham',
    city: 'Collingham',
    postcode: 'LS22 4JA',
...
// Product API Service for Yojin Collingham
class YojinCollinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Collingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCollinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCollinghamProductService };
