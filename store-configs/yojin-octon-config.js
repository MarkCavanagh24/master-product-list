// Configuration for Yojin Octon
// Store ID: 6855426e21bb01b10405e78b
// Location: Octon, YO25 3DZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426e21bb01b10405e78b',
    storeName: 'Yojin Octon',
    city: 'Octon',
    postcode: 'YO25 3DZ',
...
// Product API Service for Yojin Octon
class YojinOctonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Octon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOctonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOctonProductService };
