// Configuration for Yojin Studley Roger
// Store ID: 6855426c21bb01b10405e782
// Location: Studley Roger, HG4 2DT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426c21bb01b10405e782',
    storeName: 'Yojin Studley Roger',
    city: 'Studley Roger',
    postcode: 'HG4 2DT',
...
// Product API Service for Yojin Studley Roger
class YojinStudleyRogerProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Studley Roger:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStudleyRogerProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStudleyRogerProductService };
