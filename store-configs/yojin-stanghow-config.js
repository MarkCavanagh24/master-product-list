// Configuration for Yojin Stanghow
// Store ID: 685541b421bb01b10405e4e3
// Location: Stanghow, TS12 3HT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b421bb01b10405e4e3',
    storeName: 'Yojin Stanghow',
    city: 'Stanghow',
    postcode: 'TS12 3HT',
...
// Product API Service for Yojin Stanghow
class YojinStanghowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stanghow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStanghowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStanghowProductService };
