// Configuration for Yojin Skidby
// Store ID: 6855420b21bb01b10405e61e
// Location: Skidby, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420b21bb01b10405e61e',
    storeName: 'Yojin Skidby',
    city: 'Skidby',
    postcode: 'N/A',
...
// Product API Service for Yojin Skidby
class YojinSkidbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skidby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkidbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkidbyProductService };
