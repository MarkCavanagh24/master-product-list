// Configuration for Yojin Stockton-on-the-Forest
// Store ID: 6855419e21bb01b10405e491
// Location: Stockton-on-the-Forest, YO19 5XS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419e21bb01b10405e491',
    storeName: 'Yojin Stockton-on-the-Forest',
    city: 'Stockton-on-the-Forest',
    postcode: 'YO19 5XS',
...
// Product API Service for Yojin Stockton-on-the-Forest
class YojinStocktonontheForestProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stockton-on-the-Forest:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStocktonontheForestProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStocktonontheForestProductService };
