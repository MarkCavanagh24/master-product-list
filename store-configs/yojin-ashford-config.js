// Configuration for Yojin Ashford
// Store ID: 6855424921bb01b10405e700
// Location: Ashford, TW15 2QS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424921bb01b10405e700',
    storeName: 'Yojin Ashford',
    city: 'Ashford',
    postcode: 'TW15 2QS',
...
// Product API Service for Yojin Ashford
class YojinAshfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ashford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshfordProductService };
