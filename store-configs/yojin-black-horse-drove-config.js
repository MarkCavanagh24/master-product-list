// Configuration for Yojin Black Horse Drove
// Store ID: 6855421621bb01b10405e647
// Location: Black Horse Drove, PE38 0EW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421621bb01b10405e647',
    storeName: 'Yojin Black Horse Drove',
    city: 'Black Horse Drove',
    postcode: 'PE38 0EW',
...
// Product API Service for Yojin Black Horse Drove
class YojinBlackHorseDroveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Black Horse Drove:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlackHorseDroveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlackHorseDroveProductService };
