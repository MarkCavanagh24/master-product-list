// Configuration for Yojin Norton Malreward
// Store ID: 6855428521bb01b10405e7dd
// Location: Norton Malreward, BS39 4EY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428521bb01b10405e7dd',
    storeName: 'Yojin Norton Malreward',
    city: 'Norton Malreward',
    postcode: 'BS39 4EY',
...
// Product API Service for Yojin Norton Malreward
class YojinNortonMalrewardProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Norton Malreward:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNortonMalrewardProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNortonMalrewardProductService };
