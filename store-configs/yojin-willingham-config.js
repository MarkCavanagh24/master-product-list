// Configuration for Yojin Willingham
// Store ID: 6855427821bb01b10405e7ae
// Location: Willingham, PE28 3PS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427821bb01b10405e7ae',
    storeName: 'Yojin Willingham',
    city: 'Willingham',
    postcode: 'PE28 3PS',
...
// Product API Service for Yojin Willingham
class YojinWillinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Willingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWillinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWillinghamProductService };
