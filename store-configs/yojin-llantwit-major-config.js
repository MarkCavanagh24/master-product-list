// Configuration for Yojin Llantwit Major
// Store ID: 6855424221bb01b10405e6e8
// Location: Llantwit Major, CF71 7PY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424221bb01b10405e6e8',
    storeName: 'Yojin Llantwit Major',
    city: 'Llantwit Major',
    postcode: 'CF71 7PY',
...
// Product API Service for Yojin Llantwit Major
class YojinLlantwitMajorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Llantwit Major:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLlantwitMajorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLlantwitMajorProductService };
