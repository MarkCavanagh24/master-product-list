// Configuration for Yojin Horton
// Store ID: 685541f921bb01b10405e5e0
// Location: Horton, SL3 0LP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f921bb01b10405e5e0',
    storeName: 'Yojin Horton',
    city: 'Horton',
    postcode: 'SL3 0LP',
...
// Product API Service for Yojin Horton
class YojinHortonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Horton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHortonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHortonProductService };
