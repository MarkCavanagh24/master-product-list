// Configuration for Yojin Seaton Delaval
// Store ID: 6855419921bb01b10405e47d
// Location: Seaton Delaval, NE25 0QQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419921bb01b10405e47d',
    storeName: 'Yojin Seaton Delaval',
    city: 'Seaton Delaval',
    postcode: 'NE25 0QQ',
...
// Product API Service for Yojin Seaton Delaval
class YojinSeatonDelavalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Seaton Delaval:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSeatonDelavalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSeatonDelavalProductService };
