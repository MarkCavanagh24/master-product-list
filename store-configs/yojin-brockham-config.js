// Configuration for Yojin Brockham
// Store ID: 6855425821bb01b10405e739
// Location: Brockham, RH3 7AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425821bb01b10405e739',
    storeName: 'Yojin Brockham',
    city: 'Brockham',
    postcode: 'RH3 7AT',
...
// Product API Service for Yojin Brockham
class YojinBrockhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brockham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrockhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrockhamProductService };
