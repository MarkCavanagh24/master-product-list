// Configuration for Yojin Pucklechurch
// Store ID: 685541f621bb01b10405e5d5
// Location: Pucklechurch, BS16 9SG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f621bb01b10405e5d5',
    storeName: 'Yojin Pucklechurch',
    city: 'Pucklechurch',
    postcode: 'BS16 9SG',
...
// Product API Service for Yojin Pucklechurch
class YojinPucklechurchProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pucklechurch:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPucklechurchProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPucklechurchProductService };
