// Configuration for Yojin Hartlebury
// Store ID: 6855423921bb01b10405e6c7
// Location: Hartlebury, DY11 7SD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423921bb01b10405e6c7',
    storeName: 'Yojin Hartlebury',
    city: 'Hartlebury',
    postcode: 'DY11 7SD',
...
// Product API Service for Yojin Hartlebury
class YojinHartleburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hartlebury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHartleburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHartleburyProductService };
