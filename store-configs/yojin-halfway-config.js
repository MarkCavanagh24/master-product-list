// Configuration for Yojin Halfway
// Store ID: 6855428421bb01b10405e7d8
// Location: Halfway, ME12 3AD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428421bb01b10405e7d8',
    storeName: 'Yojin Halfway',
    city: 'Halfway',
    postcode: 'ME12 3AD',
...
// Product API Service for Yojin Halfway
class YojinHalfwayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Halfway:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHalfwayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHalfwayProductService };
