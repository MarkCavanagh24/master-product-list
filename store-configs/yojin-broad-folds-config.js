// Configuration for Yojin Broad Folds
// Store ID: 685541c221bb01b10405e517
// Location: Broad Folds, BD14 6AN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c221bb01b10405e517',
    storeName: 'Yojin Broad Folds',
    city: 'Broad Folds',
    postcode: 'BD14 6AN',
...
// Product API Service for Yojin Broad Folds
class YojinBroadFoldsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Broad Folds:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBroadFoldsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBroadFoldsProductService };
