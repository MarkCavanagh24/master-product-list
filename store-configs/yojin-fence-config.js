// Configuration for Yojin Fence
// Store ID: 685541ba21bb01b10405e4f8
// Location: Fence, BB12 9NZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ba21bb01b10405e4f8',
    storeName: 'Yojin Fence',
    city: 'Fence',
    postcode: 'BB12 9NZ',
...
// Product API Service for Yojin Fence
class YojinFenceProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fence:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFenceProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFenceProductService };
