// Configuration for Yojin Merton
// Store ID: 685541c521bb01b10405e521
// Location: Merton, IP25 6LR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c521bb01b10405e521',
    storeName: 'Yojin Merton',
    city: 'Merton',
    postcode: 'IP25 6LR',
...
// Product API Service for Yojin Merton
class YojinMertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Merton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMertonProductService };
