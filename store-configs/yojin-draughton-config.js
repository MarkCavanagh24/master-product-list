// Configuration for Yojin Draughton
// Store ID: 6855423321bb01b10405e6b2
// Location: Draughton, NN6 9JJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423321bb01b10405e6b2',
    storeName: 'Yojin Draughton',
    city: 'Draughton',
    postcode: 'NN6 9JJ',
...
// Product API Service for Yojin Draughton
class YojinDraughtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Draughton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDraughtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDraughtonProductService };
