// Configuration for Yojin Grazeley Green
// Store ID: 6855428921bb01b10405e7e9
// Location: Grazeley Green, RG7 3AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428921bb01b10405e7e9',
    storeName: 'Yojin Grazeley Green',
    city: 'Grazeley Green',
    postcode: 'RG7 3AP',
...
// Product API Service for Yojin Grazeley Green
class YojinGrazeleyGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Grazeley Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGrazeleyGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGrazeleyGreenProductService };
