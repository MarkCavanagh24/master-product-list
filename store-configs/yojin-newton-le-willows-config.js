// Configuration for Yojin Newton le Willows
// Store ID: 6855422421bb01b10405e679
// Location: Newton le Willows, DL8 1SH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422421bb01b10405e679',
    storeName: 'Yojin Newton le Willows',
...
// Product API Service for Yojin Newton le Willows
class YojinNewtonleWillowsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newton le Willows:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewtonleWillowsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewtonleWillowsProductService };
