// Configuration for Yojin Croxdale
// Store ID: 6855419021bb01b10405e45d
// Location: Croxdale, DH6 5JJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419021bb01b10405e45d',
    storeName: 'Yojin Croxdale',
    city: 'Croxdale',
    postcode: 'DH6 5JJ',
...
// Product API Service for Yojin Croxdale
class YojinCroxdaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Croxdale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCroxdaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCroxdaleProductService };
