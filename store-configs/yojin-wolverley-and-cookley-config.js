// Configuration for Yojin Wolverley and Cookley
// Store ID: 6855422321bb01b10405e675
// Location: Wolverley and Cookley, DY7 6NP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422321bb01b10405e675',
    storeName: 'Yojin Wolverley and Cookley',
    city: 'Wolverley and Cookley',
    postcode: 'DY7 6NP',
...
// Product API Service for Yojin Wolverley and Cookley
class YojinWolverleyandCookleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wolverley and Cookley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWolverleyandCookleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWolverleyandCookleyProductService };
