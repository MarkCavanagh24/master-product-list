// Configuration for Yojin Yeading
// Store ID: 685541ef21bb01b10405e5bc
// Location: Yeading, UB4 9SR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ef21bb01b10405e5bc',
    storeName: 'Yojin Yeading',
    city: 'Yeading',
    postcode: 'UB4 9SR',
...
// Product API Service for Yojin Yeading
class YojinYeadingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Yeading:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinYeadingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinYeadingProductService };
