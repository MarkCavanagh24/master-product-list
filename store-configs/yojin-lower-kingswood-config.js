// Configuration for Yojin Lower Kingswood
// Store ID: 6855425021bb01b10405e71a
// Location: Lower Kingswood, KT20 7ET

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425021bb01b10405e71a',
    storeName: 'Yojin Lower Kingswood',
...
// Product API Service for Yojin Lower Kingswood
class YojinLowerKingswoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lower Kingswood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowerKingswoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowerKingswoodProductService };
