// Configuration for Yojin Clitheroe
// Store ID: 685541a821bb01b10405e4b4
// Location: Clitheroe, BB7 2JY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a821bb01b10405e4b4',
    storeName: 'Yojin Clitheroe',
    city: 'Clitheroe',
    postcode: 'BB7 2JY',
...
// Product API Service for Yojin Clitheroe
class YojinClitheroeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clitheroe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClitheroeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClitheroeProductService };
