// Configuration for Yojin Ripley
// Store ID: 6855419b21bb01b10405e484
// Location: Ripley, HG3 3BL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419b21bb01b10405e484',
    storeName: 'Yojin Ripley',
    city: 'Ripley',
    postcode: 'HG3 3BL',
...
// Product API Service for Yojin Ripley
class YojinRipleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ripley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRipleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRipleyProductService };
