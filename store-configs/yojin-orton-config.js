// Configuration for Yojin Orton
// Store ID: 685541b521bb01b10405e4e4
// Location: Orton, CA10 3QY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b521bb01b10405e4e4',
    storeName: 'Yojin Orton',
    city: 'Orton',
    postcode: 'CA10 3QY',
...
// Product API Service for Yojin Orton
class YojinOrtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Orton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOrtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOrtonProductService };
