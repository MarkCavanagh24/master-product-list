// Configuration for Yojin Over Kellet
// Store ID: 6855426a21bb01b10405e77c
// Location: Over Kellet, LA6 1AD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426a21bb01b10405e77c',
    storeName: 'Yojin Over Kellet',
    city: 'Over Kellet',
    postcode: 'LA6 1AD',
...
// Product API Service for Yojin Over Kellet
class YojinOverKelletProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Over Kellet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOverKelletProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOverKelletProductService };
