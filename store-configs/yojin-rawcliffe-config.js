// Configuration for Yojin Rawcliffe
// Store ID: 6855425c21bb01b10405e747
// Location: Rawcliffe, DN14 8SH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425c21bb01b10405e747',
    storeName: 'Yojin Rawcliffe',
    city: 'Rawcliffe',
    postcode: 'DN14 8SH',
...
// Product API Service for Yojin Rawcliffe
class YojinRawcliffeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rawcliffe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRawcliffeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRawcliffeProductService };
