// Configuration for Yojin Wokingham Without
// Store ID: 6855428921bb01b10405e7ec
// Location: Wokingham Without, RG40 3AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428921bb01b10405e7ec',
    storeName: 'Yojin Wokingham Without',
    city: 'Wokingham Without',
    postcode: 'RG40 3AP',
...
// Product API Service for Yojin Wokingham Without
class YojinWokinghamWithoutProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wokingham Without:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWokinghamWithoutProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWokinghamWithoutProductService };
