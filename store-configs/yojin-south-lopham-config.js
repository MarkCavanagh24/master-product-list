// Configuration for Yojin South Lopham
// Store ID: 6855423621bb01b10405e6bf
// Location: South Lopham, IP22 2HW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423621bb01b10405e6bf',
    storeName: 'Yojin South Lopham',
    city: 'South Lopham',
    postcode: 'IP22 2HW',
...
// Product API Service for Yojin South Lopham
class YojinSouthLophamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin South Lopham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSouthLophamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSouthLophamProductService };
