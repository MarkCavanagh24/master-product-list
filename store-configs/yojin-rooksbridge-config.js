// Configuration for Yojin Rooksbridge
// Store ID: 6855420521bb01b10405e609
// Location: Rooksbridge, TA9 4JN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420521bb01b10405e609',
    storeName: 'Yojin Rooksbridge',
    city: 'Rooksbridge',
    postcode: 'TA9 4JN',
...
// Product API Service for Yojin Rooksbridge
class YojinRooksbridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rooksbridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRooksbridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRooksbridgeProductService };
