// Configuration for Yojin Northallerton
// Store ID: 685541dc21bb01b10405e575
// Location: Northallerton, DL7 8DL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dc21bb01b10405e575',
    storeName: 'Yojin Northallerton',
    city: 'Northallerton',
    postcode: 'DL7 8DL',
...
// Product API Service for Yojin Northallerton
class YojinNorthallertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Northallerton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthallertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthallertonProductService };
