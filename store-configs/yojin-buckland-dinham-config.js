// Configuration for Yojin Buckland Dinham
// Store ID: 6855420621bb01b10405e60d
// Location: Buckland Dinham, BA11 2RG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420621bb01b10405e60d',
    storeName: 'Yojin Buckland Dinham',
    city: 'Buckland Dinham',
    postcode: 'BA11 2RG',
...
// Product API Service for Yojin Buckland Dinham
class YojinBucklandDinhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Buckland Dinham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBucklandDinhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBucklandDinhamProductService };
