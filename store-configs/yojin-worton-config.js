// Configuration for Yojin Worton
// Store ID: 685541fc21bb01b10405e5e9
// Location: Worton, SN10 5UN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fc21bb01b10405e5e9',
    storeName: 'Yojin Worton',
    city: 'Worton',
    postcode: 'SN10 5UN',
...
// Product API Service for Yojin Worton
class YojinWortonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Worton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWortonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWortonProductService };
