// Configuration for Yojin Desborough
// Store ID: 685541e221bb01b10405e58a
// Location: Desborough, LE16 8JW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e221bb01b10405e58a',
    storeName: 'Yojin Desborough',
    city: 'Desborough',
    postcode: 'LE16 8JW',
...
// Product API Service for Yojin Desborough
class YojinDesboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Desborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDesboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDesboroughProductService };
