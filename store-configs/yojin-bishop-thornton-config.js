// Configuration for Yojin Bishop Thornton
// Store ID: 6855427021bb01b10405e792
// Location: Bishop Thornton, HG3 3LF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427021bb01b10405e792',
    storeName: 'Yojin Bishop Thornton',
    city: 'Bishop Thornton',
    postcode: 'HG3 3LF',
...
// Product API Service for Yojin Bishop Thornton
class YojinBishopThorntonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bishop Thornton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBishopThorntonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBishopThorntonProductService };
