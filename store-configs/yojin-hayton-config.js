// Configuration for Yojin Hayton
// Store ID: 685541a721bb01b10405e4b0
// Location: Hayton, YO42 1RP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a721bb01b10405e4b0',
    storeName: 'Yojin Hayton',
    city: 'Hayton',
    postcode: 'YO42 1RP',
...
// Product API Service for Yojin Hayton
class YojinHaytonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hayton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaytonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaytonProductService };
