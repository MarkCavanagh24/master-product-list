// Configuration for Yojin Old Windsor
// Store ID: 6855424821bb01b10405e6fe
// Location: Old Windsor, SL4 2HP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424821bb01b10405e6fe',
    storeName: 'Yojin Old Windsor',
    city: 'Old Windsor',
    postcode: 'SL4 2HP',
...
// Product API Service for Yojin Old Windsor
class YojinOldWindsorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Old Windsor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOldWindsorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOldWindsorProductService };
