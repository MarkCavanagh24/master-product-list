// Configuration for Yojin Southwick
// Store ID: 685541fb21bb01b10405e5e7
// Location: Southwick, BA14 0EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fb21bb01b10405e5e7',
    storeName: 'Yojin Southwick',
    city: 'Southwick',
    postcode: 'BA14 0EF',
...
// Product API Service for Yojin Southwick
class YojinSouthwickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Southwick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSouthwickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSouthwickProductService };
