// Configuration for Yojin Farsley
// Store ID: 685541bc21bb01b10405e4fe
// Location: Farsley, LS13 1PX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bc21bb01b10405e4fe',
    storeName: 'Yojin Farsley',
    city: 'Farsley',
    postcode: 'LS13 1PX',
...
// Product API Service for Yojin Farsley
class YojinFarsleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Farsley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFarsleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFarsleyProductService };
