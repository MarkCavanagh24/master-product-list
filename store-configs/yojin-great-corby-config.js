// Configuration for Yojin Great Corby
// Store ID: 6855418621bb01b10405e43d
// Location: Great Corby, CA4 8NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418621bb01b10405e43d',
    storeName: 'Yojin Great Corby',
    city: 'Great Corby',
    postcode: 'CA4 8NJ',
...
// Product API Service for Yojin Great Corby
class YojinGreatCorbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Corby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatCorbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatCorbyProductService };
