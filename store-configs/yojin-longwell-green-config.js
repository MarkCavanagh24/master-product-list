// Configuration for Yojin Longwell Green
// Store ID: 6855424521bb01b10405e6f1
// Location: Longwell Green, BS30 9DB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424521bb01b10405e6f1',
    storeName: 'Yojin Longwell Green',
    city: 'Longwell Green',
    postcode: 'BS30 9DB',
...
// Product API Service for Yojin Longwell Green
class YojinLongwellGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Longwell Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLongwellGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLongwellGreenProductService };
