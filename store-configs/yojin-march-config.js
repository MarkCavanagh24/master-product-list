// Configuration for Yojin March
// Store ID: 6855421621bb01b10405e646
// Location: March, PE15 0YG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421621bb01b10405e646',
    storeName: 'Yojin March',
    city: 'March',
    postcode: 'PE15 0YG',
...
// Product API Service for Yojin March
class YojinMarchProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin March:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarchProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarchProductService };
