// Configuration for Yojin Chelsea
// Store ID: 6855424021bb01b10405e6df
// Location: Chelsea, SW10 0SW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424021bb01b10405e6df',
    storeName: 'Yojin Chelsea',
    city: 'Chelsea',
    postcode: 'SW10 0SW',
...
// Product API Service for Yojin Chelsea
class YojinChelseaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chelsea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChelseaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChelseaProductService };
