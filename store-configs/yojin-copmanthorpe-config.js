// Configuration for Yojin Copmanthorpe
// Store ID: 685541a621bb01b10405e4ae
// Location: Copmanthorpe, YO23 3XS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a621bb01b10405e4ae',
    storeName: 'Yojin Copmanthorpe',
    city: 'Copmanthorpe',
    postcode: 'YO23 3XS',
...
// Product API Service for Yojin Copmanthorpe
class YojinCopmanthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Copmanthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCopmanthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCopmanthorpeProductService };
