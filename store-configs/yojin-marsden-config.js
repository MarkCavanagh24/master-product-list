// Configuration for Yojin Marsden
// Store ID: 6855426521bb01b10405e76b
// Location: Marsden, HD7 6AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426521bb01b10405e76b',
    storeName: 'Yojin Marsden',
    city: 'Marsden',
    postcode: 'HD7 6AG',
...
// Product API Service for Yojin Marsden
class YojinMarsdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Marsden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarsdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarsdenProductService };
