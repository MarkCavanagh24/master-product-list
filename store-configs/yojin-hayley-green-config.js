// Configuration for Yojin Hayley Green
// Store ID: 6855422321bb01b10405e677
// Location: Hayley Green, B63 1EN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422321bb01b10405e677',
    storeName: 'Yojin Hayley Green',
    city: 'Hayley Green',
    postcode: 'B63 1EN',
...
// Product API Service for Yojin Hayley Green
class YojinHayleyGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hayley Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHayleyGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHayleyGreenProductService };
