// Configuration for Yojin Wimblington
// Store ID: 6855422021bb01b10405e66c
// Location: Wimblington, PE15 0NS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422021bb01b10405e66c',
    storeName: 'Yojin Wimblington',
    city: 'Wimblington',
    postcode: 'PE15 0NS',
...
// Product API Service for Yojin Wimblington
class YojinWimblingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wimblington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWimblingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWimblingtonProductService };
