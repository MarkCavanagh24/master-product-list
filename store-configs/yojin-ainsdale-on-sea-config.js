// Configuration for Yojin Ainsdale-on-Sea
// Store ID: 6855426221bb01b10405e75e
// Location: Ainsdale-on-Sea, PR8 3EN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426221bb01b10405e75e',
    storeName: 'Yojin Ainsdale-on-Sea',
    city: 'Ainsdale-on-Sea',
    postcode: 'PR8 3EN',
...
// Product API Service for Yojin Ainsdale-on-Sea
class YojinAinsdaleonSeaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ainsdale-on-Sea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAinsdaleonSeaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAinsdaleonSeaProductService };
