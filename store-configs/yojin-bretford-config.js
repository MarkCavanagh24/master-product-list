// Configuration for Yojin Bretford
// Store ID: 6855423121bb01b10405e6ab
// Location: Bretford, CV8 3GE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423121bb01b10405e6ab',
    storeName: 'Yojin Bretford',
    city: 'Bretford',
    postcode: 'CV8 3GE',
...
// Product API Service for Yojin Bretford
class YojinBretfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bretford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBretfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBretfordProductService };
