// Configuration for Yojin Corbridge
// Store ID: 6855418021bb01b10405e425
// Location: Corbridge, NE45 5RU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418021bb01b10405e425',
    storeName: 'Yojin Corbridge',
    city: 'Corbridge',
    postcode: 'NE45 5RU',
...
// Product API Service for Yojin Corbridge
class YojinCorbridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Corbridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCorbridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCorbridgeProductService };
