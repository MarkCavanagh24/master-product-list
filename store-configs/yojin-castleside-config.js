// Configuration for Yojin Castleside
// Store ID: 6855418921bb01b10405e446
// Location: Castleside, DH8 9AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418921bb01b10405e446',
    storeName: 'Yojin Castleside',
    city: 'Castleside',
    postcode: 'DH8 9AP',
...
// Product API Service for Yojin Castleside
class YojinCastlesideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Castleside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCastlesideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCastlesideProductService };
