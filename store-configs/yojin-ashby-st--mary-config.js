// Configuration for Yojin Ashby St. Mary
// Store ID: 685541c721bb01b10405e529
// Location: Ashby St. Mary, NR14 7BB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c721bb01b10405e529',
    storeName: 'Yojin Ashby St. Mary',
    city: 'Ashby St. Mary',
    postcode: 'NR14 7BB',
...
// Product API Service for Yojin Ashby St. Mary
class YojinAshbyStMaryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ashby St. Mary:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshbyStMaryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshbyStMaryProductService };
