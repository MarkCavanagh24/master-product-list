// Configuration for Yojin Newchurch
// Store ID: 6855421421bb01b10405e63e
// Location: Newchurch, BB4 7QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421421bb01b10405e63e',
    storeName: 'Yojin Newchurch',
    city: 'Newchurch',
    postcode: 'BB4 7QJ',
...
// Product API Service for Yojin Newchurch
class YojinNewchurchProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newchurch:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewchurchProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewchurchProductService };
