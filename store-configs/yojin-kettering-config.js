// Configuration for Yojin Kettering
// Store ID: 6855423421bb01b10405e6b5
// Location: Kettering, NN15 4AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423421bb01b10405e6b5',
    storeName: 'Yojin Kettering',
    city: 'Kettering',
    postcode: 'NN15 4AG',
...
// Product API Service for Yojin Kettering
class YojinKetteringProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kettering:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKetteringProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKetteringProductService };
