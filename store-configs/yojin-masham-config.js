// Configuration for Yojin Masham
// Store ID: 6855422b21bb01b10405e693
// Location: Masham, HG4 4NT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422b21bb01b10405e693',
    storeName: 'Yojin Masham',
    city: 'Masham',
    postcode: 'HG4 4NT',
...
// Product API Service for Yojin Masham
class YojinMashamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Masham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMashamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMashamProductService };
