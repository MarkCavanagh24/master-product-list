// Configuration for Yojin Holme-on-Spalding-Moor
// Store ID: 685541be21bb01b10405e506
// Location: Holme-on-Spalding-Moor, YO43 4HQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541be21bb01b10405e506',
    storeName: 'Yojin Holme-on-Spalding-Moor',
    city: 'Holme-on-Spalding-Moor',
    postcode: 'YO43 4HQ',
...
// Product API Service for Yojin Holme-on-Spalding-Moor
class YojinHolmeonSpaldingMoorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Holme-on-Spalding-Moor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHolmeonSpaldingMoorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHolmeonSpaldingMoorProductService };
