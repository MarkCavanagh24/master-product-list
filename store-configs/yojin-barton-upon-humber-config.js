// Configuration for Yojin Barton-upon-Humber
// Store ID: 6855426221bb01b10405e75c
// Location: Barton-upon-Humber, DN18 6BA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426221bb01b10405e75c',
    storeName: 'Yojin Barton-upon-Humber',
...
// Product API Service for Yojin Barton-upon-Humber
class YojinBartonuponHumberProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Barton-upon-Humber:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBartonuponHumberProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBartonuponHumberProductService };
