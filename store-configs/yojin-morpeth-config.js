// Configuration for Yojin Morpeth
// Store ID: 6855419721bb01b10405e476
// Location: Morpeth, NE61 2JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419721bb01b10405e476',
    storeName: 'Yojin Morpeth',
    city: 'Morpeth',
    postcode: 'NE61 2JB',
...
// Product API Service for Yojin Morpeth
class YojinMorpethProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Morpeth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMorpethProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMorpethProductService };
