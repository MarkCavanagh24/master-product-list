// Configuration for Yojin Preston Patrick
// Store ID: 6855422621bb01b10405e681
// Location: Preston Patrick, LA6 2QA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422621bb01b10405e681',
    storeName: 'Yojin Preston Patrick',
    city: 'Preston Patrick',
    postcode: 'LA6 2QA',
...
// Product API Service for Yojin Preston Patrick
class YojinPrestonPatrickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Preston Patrick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPrestonPatrickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPrestonPatrickProductService };
