// Configuration for Yojin New Arley
// Store ID: 685541cc21bb01b10405e53a
// Location: New Arley, CV10 9PH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cc21bb01b10405e53a',
    storeName: 'Yojin New Arley',
    city: 'New Arley',
    postcode: 'CV10 9PH',
...
// Product API Service for Yojin New Arley
class YojinNewArleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Arley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewArleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewArleyProductService };
