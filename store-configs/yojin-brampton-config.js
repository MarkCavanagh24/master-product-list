// Configuration for Yojin Brampton
// Store ID: 6855417f21bb01b10405e41f
// Location: Brampton, CA8 2HD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417f21bb01b10405e41f',
    storeName: 'Yojin Brampton',
    city: 'Brampton',
    postcode: 'CA8 2HD',
...
// Product API Service for Yojin Brampton
class YojinBramptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brampton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBramptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBramptonProductService };
