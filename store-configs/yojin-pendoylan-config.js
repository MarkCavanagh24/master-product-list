// Configuration for Yojin Pendoylan
// Store ID: 685541f421bb01b10405e5cb
// Location: Pendoylan, CF71 7UF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f421bb01b10405e5cb',
    storeName: 'Yojin Pendoylan',
    city: 'Pendoylan',
    postcode: 'CF71 7UF',
...
// Product API Service for Yojin Pendoylan
class YojinPendoylanProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pendoylan:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPendoylanProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPendoylanProductService };
