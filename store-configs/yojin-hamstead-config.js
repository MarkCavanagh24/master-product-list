// Configuration for Yojin Hamstead
// Store ID: 685541cb21bb01b10405e535
// Location: Hamstead, B20 2LU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cb21bb01b10405e535',
    storeName: 'Yojin Hamstead',
    city: 'Hamstead',
    postcode: 'B20 2LU',
...
// Product API Service for Yojin Hamstead
class YojinHamsteadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hamstead:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHamsteadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHamsteadProductService };
