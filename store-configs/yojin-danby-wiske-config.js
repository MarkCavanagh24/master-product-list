// Configuration for Yojin Danby Wiske
// Store ID: 685541d921bb01b10405e569
// Location: Danby Wiske, DL7 0AQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d921bb01b10405e569',
    storeName: 'Yojin Danby Wiske',
    city: 'Danby Wiske',
    postcode: 'DL7 0AQ',
...
// Product API Service for Yojin Danby Wiske
class YojinDanbyWiskeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Danby Wiske:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDanbyWiskeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDanbyWiskeProductService };
