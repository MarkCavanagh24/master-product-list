// Configuration for Yojin Burneston
// Store ID: 6855422721bb01b10405e685
// Location: Burneston, DL8 2JE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422721bb01b10405e685',
    storeName: 'Yojin Burneston',
    city: 'Burneston',
    postcode: 'DL8 2JE',
...
// Product API Service for Yojin Burneston
class YojinBurnestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burneston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnestonProductService };
