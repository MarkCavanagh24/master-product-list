// Configuration for Yojin Stivichall
// Store ID: 685541ec21bb01b10405e5af
// Location: Stivichall, CV3 6GH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ec21bb01b10405e5af',
    storeName: 'Yojin Stivichall',
    city: 'Stivichall',
    postcode: 'CV3 6GH',
...
// Product API Service for Yojin Stivichall
class YojinStivichallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stivichall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStivichallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStivichallProductService };
