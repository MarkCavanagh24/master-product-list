// Configuration for Yojin Bacup
// Store ID: 6855421421bb01b10405e63f
// Location: Bacup, OL13 9QH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421421bb01b10405e63f',
    storeName: 'Yojin Bacup',
    city: 'Bacup',
    postcode: 'OL13 9QH',
...
// Product API Service for Yojin Bacup
class YojinBacupProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bacup:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBacupProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBacupProductService };
