// Configuration for Yojin Snaith
// Store ID: 6855425c21bb01b10405e746
// Location: Snaith, DN14 9LN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425c21bb01b10405e746',
    storeName: 'Yojin Snaith',
    city: 'Snaith',
    postcode: 'DN14 9LN',
...
// Product API Service for Yojin Snaith
class YojinSnaithProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Snaith:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSnaithProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSnaithProductService };
