// Configuration for Yojin Westry
// Store ID: 685541c321bb01b10405e51b
// Location: Westry, PE15 8QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c321bb01b10405e51b',
    storeName: 'Yojin Westry',
    city: 'Westry',
    postcode: 'PE15 8QP',
...
// Product API Service for Yojin Westry
class YojinWestryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Westry:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestryProductService };
