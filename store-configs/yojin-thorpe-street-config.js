// Configuration for Yojin Thorpe Street
// Store ID: 6855427b21bb01b10405e7b7
// Location: Thorpe Street, IP22 1HX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427b21bb01b10405e7b7',
    storeName: 'Yojin Thorpe Street',
    city: 'Thorpe Street',
    postcode: 'IP22 1HX',
...
// Product API Service for Yojin Thorpe Street
class YojinThorpeStreetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thorpe Street:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThorpeStreetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThorpeStreetProductService };
