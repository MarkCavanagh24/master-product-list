// Configuration for Yojin Tandridge
// Store ID: 6855420121bb01b10405e5fc
// Location: Tandridge, CR6 9QG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420121bb01b10405e5fc',
    storeName: 'Yojin Tandridge',
    city: 'Tandridge',
    postcode: 'CR6 9QG',
...
// Product API Service for Yojin Tandridge
class YojinTandridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tandridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTandridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTandridgeProductService };
