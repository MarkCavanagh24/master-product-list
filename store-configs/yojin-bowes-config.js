// Configuration for Yojin Bowes
// Store ID: 685541b221bb01b10405e4d9
// Location: Bowes, DL12 9SJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b221bb01b10405e4d9',
    storeName: 'Yojin Bowes',
    city: 'Bowes',
    postcode: 'DL12 9SJ',
...
// Product API Service for Yojin Bowes
class YojinBowesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bowes:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBowesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBowesProductService };
