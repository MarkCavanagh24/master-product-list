// Configuration for Yojin Leybourne Chase
// Store ID: 6855420321bb01b10405e600
// Location: Leybourne Chase, ME19 5HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420321bb01b10405e600',
    storeName: 'Yojin Leybourne Chase',
    city: 'Leybourne Chase',
    postcode: 'ME19 5HZ',
...
// Product API Service for Yojin Leybourne Chase
class YojinLeybourneChaseProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Leybourne Chase:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLeybourneChaseProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLeybourneChaseProductService };
