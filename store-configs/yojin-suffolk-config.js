// Configuration for Yojin Suffolk
// Store ID: 6855427c21bb01b10405e7bc
// Location: Suffolk, IP21 5QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427c21bb01b10405e7bc',
    storeName: 'Yojin Suffolk',
    city: 'Suffolk',
    postcode: 'IP21 5QP',
...
// Product API Service for Yojin Suffolk
class YojinSuffolkProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Suffolk:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSuffolkProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSuffolkProductService };
