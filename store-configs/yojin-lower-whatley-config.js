// Configuration for Yojin Lower Whatley
// Store ID: 6855425521bb01b10405e72d
// Location: Lower Whatley, BA11 3JX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425521bb01b10405e72d',
    storeName: 'Yojin Lower Whatley',
    city: 'Lower Whatley',
    postcode: 'BA11 3JX',
...
// Product API Service for Yojin Lower Whatley
class YojinLowerWhatleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lower Whatley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowerWhatleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowerWhatleyProductService };
