// Configuration for Yojin Ramsey Saint Mary's
// Store ID: 6855421f21bb01b10405e669
// Location: Ramsey Saint Mary's, PE26 2AD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421f21bb01b10405e669',
    storeName: 'Yojin Ramsey Saint Mary's',
    city: 'Ramsey Saint Mary's',
    postcode: 'PE26 2AD',
...
// Product API Service for Yojin Ramsey Saint Mary's
class YojinRamseySaintMarysProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ramsey Saint Mary's:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRamseySaintMarysProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRamseySaintMarysProductService };
