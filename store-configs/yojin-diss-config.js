// Configuration for Yojin Diss
// Store ID: 6855427c21bb01b10405e7bb
// Location: Diss, IP21 5RE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427c21bb01b10405e7bb',
    storeName: 'Yojin Diss',
    city: 'Diss',
    postcode: 'IP21 5RE',
...
// Product API Service for Yojin Diss
class YojinDissProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Diss:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDissProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDissProductService };
