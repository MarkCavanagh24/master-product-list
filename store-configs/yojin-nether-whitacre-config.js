// Configuration for Yojin Nether Whitacre
// Store ID: 685541cc21bb01b10405e539
// Location: Nether Whitacre, B46 2PJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cc21bb01b10405e539',
    storeName: 'Yojin Nether Whitacre',
    city: 'Nether Whitacre',
    postcode: 'B46 2PJ',
...
// Product API Service for Yojin Nether Whitacre
class YojinNetherWhitacreProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Nether Whitacre:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNetherWhitacreProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNetherWhitacreProductService };
