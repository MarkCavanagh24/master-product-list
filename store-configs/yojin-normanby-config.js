// Configuration for Yojin Normanby
// Store ID: 6855422d21bb01b10405e69b
// Location: Normanby, YO17 6XE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422d21bb01b10405e69b',
    storeName: 'Yojin Normanby',
    city: 'Normanby',
    postcode: 'YO17 6XE',
...
// Product API Service for Yojin Normanby
class YojinNormanbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Normanby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNormanbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNormanbyProductService };
