// Configuration for Yojin Long Buckby
// Store ID: 6855428221bb01b10405e7d0
// Location: Long Buckby, NN6 8FB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428221bb01b10405e7d0',
    storeName: 'Yojin Long Buckby',
    city: 'Long Buckby',
    postcode: 'NN6 8FB',
...
// Product API Service for Yojin Long Buckby
class YojinLongBuckbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Long Buckby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLongBuckbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLongBuckbyProductService };
