// Configuration for Yojin Whinfell
// Store ID: 6855419421bb01b10405e46d
// Location: Whinfell, CA10 2AE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419421bb01b10405e46d',
    storeName: 'Yojin Whinfell',
    city: 'Whinfell',
    postcode: 'CA10 2AE',
...
// Product API Service for Yojin Whinfell
class YojinWhinfellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whinfell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhinfellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhinfellProductService };
