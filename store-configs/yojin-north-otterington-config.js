// Configuration for Yojin North Otterington
// Store ID: 6855422521bb01b10405e67c
// Location: North Otterington, DL7 9JQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422521bb01b10405e67c',
    storeName: 'Yojin North Otterington',
    city: 'North Otterington',
    postcode: 'DL7 9JQ',
...
// Product API Service for Yojin North Otterington
class YojinNorthOtteringtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Otterington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthOtteringtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthOtteringtonProductService };
