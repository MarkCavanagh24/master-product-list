// Configuration for Yojin Burnley
// Store ID: 685541c121bb01b10405e513
// Location: Burnley, BB11 4DL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c121bb01b10405e513',
    storeName: 'Yojin Burnley',
    city: 'Burnley',
    postcode: 'BB11 4DL',
...
// Product API Service for Yojin Burnley
class YojinBurnleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burnley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnleyProductService };
