// Configuration for Yojin Brigstock
// Store ID: 685541e321bb01b10405e58d
// Location: Brigstock, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e321bb01b10405e58d',
    storeName: 'Yojin Brigstock',
    city: 'Brigstock',
    postcode: 'N/A',
...
// Product API Service for Yojin Brigstock
class YojinBrigstockProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brigstock:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrigstockProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrigstockProductService };
