// Configuration for Yojin Streatham Hill
// Store ID: 6855424a21bb01b10405e705
// Location: Streatham Hill, SW16 2LT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424a21bb01b10405e705',
    storeName: 'Yojin Streatham Hill',
    city: 'Streatham Hill',
    postcode: 'SW16 2LT',
...
// Product API Service for Yojin Streatham Hill
class YojinStreathamHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Streatham Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStreathamHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStreathamHillProductService };
