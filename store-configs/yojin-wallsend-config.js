// Configuration for Yojin Wallsend
// Store ID: 6855417e21bb01b10405e41a
// Location: Wallsend, NE28 8UE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417e21bb01b10405e41a',
    storeName: 'Yojin Wallsend',
    city: 'Wallsend',
    postcode: 'NE28 8UE',
...
// Product API Service for Yojin Wallsend
class YojinWallsendProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wallsend:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWallsendProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWallsendProductService };
