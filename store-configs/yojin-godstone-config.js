// Configuration for Yojin Godstone
// Store ID: 6855425021bb01b10405e71c
// Location: Godstone, RH9 8ND

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425021bb01b10405e71c',
    storeName: 'Yojin Godstone',
    city: 'Godstone',
    postcode: 'RH9 8ND',
...
// Product API Service for Yojin Godstone
class YojinGodstoneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Godstone:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGodstoneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGodstoneProductService };
