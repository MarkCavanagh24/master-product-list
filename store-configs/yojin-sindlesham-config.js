// Configuration for Yojin Sindlesham
// Store ID: 6855424721bb01b10405e6fa
// Location: Sindlesham, RG41 5RY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424721bb01b10405e6fa',
    storeName: 'Yojin Sindlesham',
    city: 'Sindlesham',
    postcode: 'RG41 5RY',
...
// Product API Service for Yojin Sindlesham
class YojinSindleshamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sindlesham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSindleshamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSindleshamProductService };
