// Configuration for Yojin Sidcup
// Store ID: 6855424b21bb01b10405e708
// Location: Sidcup, DA15 7NU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424b21bb01b10405e708',
    storeName: 'Yojin Sidcup',
    city: 'Sidcup',
    postcode: 'DA15 7NU',
...
// Product API Service for Yojin Sidcup
class YojinSidcupProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sidcup:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSidcupProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSidcupProductService };
