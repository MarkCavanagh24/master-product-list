// Configuration for Yojin Frome
// Store ID: 6855425521bb01b10405e72e
// Location: Frome, BA11 5NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425521bb01b10405e72e',
    storeName: 'Yojin Frome',
    city: 'Frome',
    postcode: 'BA11 5NB',
...
// Product API Service for Yojin Frome
class YojinFromeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Frome:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFromeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFromeProductService };
