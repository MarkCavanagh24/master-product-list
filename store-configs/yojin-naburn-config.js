// Configuration for Yojin Naburn
// Store ID: 685541a621bb01b10405e4af
// Location: Naburn, YO19 4RH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a621bb01b10405e4af',
    storeName: 'Yojin Naburn',
    city: 'Naburn',
    postcode: 'YO19 4RH',
...
// Product API Service for Yojin Naburn
class YojinNaburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Naburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNaburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNaburnProductService };
