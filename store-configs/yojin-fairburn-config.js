// Configuration for Yojin Fairburn
// Store ID: 6855420a21bb01b10405e618
// Location: Fairburn, LS25 5LE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420a21bb01b10405e618',
    storeName: 'Yojin Fairburn',
    city: 'Fairburn',
    postcode: 'LS25 5LE',
...
// Product API Service for Yojin Fairburn
class YojinFairburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fairburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFairburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFairburnProductService };
