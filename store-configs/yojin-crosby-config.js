// Configuration for Yojin Crosby
// Store ID: 6855422521bb01b10405e67d
// Location: Crosby, DL6 3SZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422521bb01b10405e67d',
    storeName: 'Yojin Crosby',
    city: 'Crosby',
    postcode: 'DL6 3SZ',
...
// Product API Service for Yojin Crosby
class YojinCrosbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crosby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCrosbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCrosbyProductService };
