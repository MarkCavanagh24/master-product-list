// Configuration for Yojin Elloughton
// Store ID: 6855421121bb01b10405e634
// Location: Elloughton, HU15 1LN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421121bb01b10405e634',
    storeName: 'Yojin Elloughton',
    city: 'Elloughton',
    postcode: 'HU15 1LN',
...
// Product API Service for Yojin Elloughton
class YojinElloughtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Elloughton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinElloughtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinElloughtonProductService };
