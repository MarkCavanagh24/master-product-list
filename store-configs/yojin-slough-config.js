// Configuration for Yojin Slough
// Store ID: 685541ef21bb01b10405e5b9
// Location: Slough, SL2 5DF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ef21bb01b10405e5b9',
    storeName: 'Yojin Slough',
    city: 'Slough',
    postcode: 'SL2 5DF',
...
// Product API Service for Yojin Slough
class YojinSloughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Slough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSloughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSloughProductService };
