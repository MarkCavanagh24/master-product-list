// Configuration for Yojin Redmarshall
// Store ID: 685541ae21bb01b10405e4cd
// Location: Redmarshall, TS21 1BG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ae21bb01b10405e4cd',
    storeName: 'Yojin Redmarshall',
    city: 'Redmarshall',
    postcode: 'TS21 1BG',
...
// Product API Service for Yojin Redmarshall
class YojinRedmarshallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Redmarshall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRedmarshallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRedmarshallProductService };
