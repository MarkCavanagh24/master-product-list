// Configuration for Yojin Adlington
// Store ID: 6855426421bb01b10405e764
// Location: Adlington, PR6 9HP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426421bb01b10405e764',
    storeName: 'Yojin Adlington',
    city: 'Adlington',
    postcode: 'PR6 9HP',
...
// Product API Service for Yojin Adlington
class YojinAdlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Adlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAdlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAdlingtonProductService };
