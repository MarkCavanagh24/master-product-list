// Configuration for Yojin Hapton
// Store ID: 6855421821bb01b10405e64c
// Location: Hapton, NR15 2AF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421821bb01b10405e64c',
    storeName: 'Yojin Hapton',
    city: 'Hapton',
    postcode: 'NR15 2AF',
...
// Product API Service for Yojin Hapton
class YojinHaptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hapton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaptonProductService };
