// Configuration for Yojin Kirkstall
// Store ID: 685541bc21bb01b10405e4ff
// Location: Kirkstall, LS5 3HF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bc21bb01b10405e4ff',
    storeName: 'Yojin Kirkstall',
    city: 'Kirkstall',
    postcode: 'LS5 3HF',
...
// Product API Service for Yojin Kirkstall
class YojinKirkstallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkstall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkstallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkstallProductService };
