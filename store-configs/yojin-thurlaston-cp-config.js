// Configuration for Yojin Thurlaston CP
// Store ID: 6855423c21bb01b10405e6d4
// Location: Thurlaston CP, CV23 9JR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423c21bb01b10405e6d4',
    storeName: 'Yojin Thurlaston CP',
    city: 'Thurlaston CP',
    postcode: 'CV23 9JR',
...
// Product API Service for Yojin Thurlaston CP
class YojinThurlastonCPProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thurlaston CP:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThurlastonCPProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThurlastonCPProductService };
