// Configuration for Yojin Mytholmroyd
// Store ID: 6855420e21bb01b10405e628
// Location: Mytholmroyd, HX7 5QZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420e21bb01b10405e628',
    storeName: 'Yojin Mytholmroyd',
    city: 'Mytholmroyd',
    postcode: 'HX7 5QZ',
...
// Product API Service for Yojin Mytholmroyd
class YojinMytholmroydProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mytholmroyd:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMytholmroydProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMytholmroydProductService };
