// Configuration for Yojin Harewood
// Store ID: 685541b721bb01b10405e4ec
// Location: Harewood, LS17 9JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b721bb01b10405e4ec',
    storeName: 'Yojin Harewood',
    city: 'Harewood',
    postcode: 'LS17 9JD',
...
// Product API Service for Yojin Harewood
class YojinHarewoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harewood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHarewoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHarewoodProductService };
