// Configuration for Yojin East Cowton
// Store ID: 685541d521bb01b10405e55a
// Location: East Cowton, DL7 0DR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d521bb01b10405e55a',
    storeName: 'Yojin East Cowton',
    city: 'East Cowton',
    postcode: 'DL7 0DR',
...
// Product API Service for Yojin East Cowton
class YojinEastCowtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Cowton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastCowtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastCowtonProductService };
