// Configuration for Yojin Clerkenwell
// Store ID: 685541f021bb01b10405e5c0
// Location: Clerkenwell, EC1M 5UQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f021bb01b10405e5c0',
    storeName: 'Yojin Clerkenwell',
    city: 'Clerkenwell',
    postcode: 'EC1M 5UQ',
...
// Product API Service for Yojin Clerkenwell
class YojinClerkenwellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clerkenwell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClerkenwellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClerkenwellProductService };
