// Configuration for Yojin Pooley Green
// Store ID: 6855424821bb01b10405e6ff
// Location: Pooley Green, TW20 9AL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424821bb01b10405e6ff',
    storeName: 'Yojin Pooley Green',
    city: 'Pooley Green',
    postcode: 'TW20 9AL',
...
// Product API Service for Yojin Pooley Green
class YojinPooleyGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pooley Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPooleyGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPooleyGreenProductService };
