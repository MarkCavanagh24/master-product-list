// Configuration for Yojin Chippenham
// Store ID: 685541f721bb01b10405e5d6
// Location: Chippenham, SN14 6UY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f721bb01b10405e5d6',
    storeName: 'Yojin Chippenham',
    city: 'Chippenham',
    postcode: 'SN14 6UY',
...
// Product API Service for Yojin Chippenham
class YojinChippenhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chippenham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChippenhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChippenhamProductService };
