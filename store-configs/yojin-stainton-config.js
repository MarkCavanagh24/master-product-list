// Configuration for Yojin Stainton
// Store ID: 685541ad21bb01b10405e4c7
// Location: Stainton, DL12 8UD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ad21bb01b10405e4c7',
    storeName: 'Yojin Stainton',
    city: 'Stainton',
    postcode: 'DL12 8UD',
...
// Product API Service for Yojin Stainton
class YojinStaintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stainton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStaintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStaintonProductService };
