// Configuration for Yojin North Lees
// Store ID: 6855423021bb01b10405e6a5
// Location: North Lees, HG4 3HS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423021bb01b10405e6a5',
    storeName: 'Yojin North Lees',
    city: 'North Lees',
    postcode: 'HG4 3HS',
...
// Product API Service for Yojin North Lees
class YojinNorthLeesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Lees:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthLeesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthLeesProductService };
