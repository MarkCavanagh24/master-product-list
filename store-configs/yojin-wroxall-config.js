// Configuration for Yojin Wroxall
// Store ID: 6855423b21bb01b10405e6cf
// Location: Wroxall, CV35 7NH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423b21bb01b10405e6cf',
    storeName: 'Yojin Wroxall',
    city: 'Wroxall',
    postcode: 'CV35 7NH',
...
// Product API Service for Yojin Wroxall
class YojinWroxallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wroxall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWroxallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWroxallProductService };
