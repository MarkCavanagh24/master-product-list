// Configuration for Yojin Royal Leamington Spa
// Store ID: 6855428021bb01b10405e7ca
// Location: Royal Leamington Spa, CV32 6LX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428021bb01b10405e7ca',
    storeName: 'Yojin Royal Leamington Spa',
...
// Product API Service for Yojin Royal Leamington Spa
class YojinRoyalLeamingtonSpaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Royal Leamington Spa:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRoyalLeamingtonSpaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRoyalLeamingtonSpaProductService };
