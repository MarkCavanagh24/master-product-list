// Configuration for Yojin Marwood
// Store ID: 685541ad21bb01b10405e4c6
// Location: Marwood, DL12 8QW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ad21bb01b10405e4c6',
    storeName: 'Yojin Marwood',
    city: 'Marwood',
    postcode: 'DL12 8QW',
...
// Product API Service for Yojin Marwood
class YojinMarwoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Marwood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarwoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarwoodProductService };
