// Configuration for Yojin Grindale
// Store ID: 6855426f21bb01b10405e78d
// Location: Grindale, YO16 4XZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426f21bb01b10405e78d',
    storeName: 'Yojin Grindale',
    city: 'Grindale',
    postcode: 'YO16 4XZ',
...
// Product API Service for Yojin Grindale
class YojinGrindaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Grindale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGrindaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGrindaleProductService };
