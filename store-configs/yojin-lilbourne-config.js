// Configuration for Yojin Lilbourne
// Store ID: 6855423221bb01b10405e6ae
// Location: Lilbourne, CV23 0SZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423221bb01b10405e6ae',
    storeName: 'Yojin Lilbourne',
    city: 'Lilbourne',
    postcode: 'CV23 0SZ',
...
// Product API Service for Yojin Lilbourne
class YojinLilbourneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lilbourne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLilbourneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLilbourneProductService };
