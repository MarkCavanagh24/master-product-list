// Configuration for Yojin Sedbergh
// Store ID: 685541de21bb01b10405e57b
// Location: Sedbergh, LA10 5ET

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541de21bb01b10405e57b',
    storeName: 'Yojin Sedbergh',
    city: 'Sedbergh',
    postcode: 'LA10 5ET',
...
// Product API Service for Yojin Sedbergh
class YojinSedberghProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sedbergh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSedberghProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSedberghProductService };
