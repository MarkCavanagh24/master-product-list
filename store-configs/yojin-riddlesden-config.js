// Configuration for Yojin Riddlesden
// Store ID: 685541b621bb01b10405e4e9
// Location: Riddlesden, BD21 4ND

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b621bb01b10405e4e9',
    storeName: 'Yojin Riddlesden',
    city: 'Riddlesden',
    postcode: 'BD21 4ND',
...
// Product API Service for Yojin Riddlesden
class YojinRiddlesdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Riddlesden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRiddlesdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRiddlesdenProductService };
