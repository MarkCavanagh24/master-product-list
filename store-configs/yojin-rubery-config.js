// Configuration for Yojin Rubery
// Store ID: 685541ea21bb01b10405e5a8
// Location: Rubery, B45 9LW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ea21bb01b10405e5a8',
    storeName: 'Yojin Rubery',
    city: 'Rubery',
    postcode: 'B45 9LW',
...
// Product API Service for Yojin Rubery
class YojinRuberyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rubery:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRuberyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRuberyProductService };
