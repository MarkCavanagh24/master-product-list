// Configuration for Yojin Flax Bourton
// Store ID: 6855424421bb01b10405e6ee
// Location: Flax Bourton, BS48 1NF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424421bb01b10405e6ee',
    storeName: 'Yojin Flax Bourton',
    city: 'Flax Bourton',
    postcode: 'BS48 1NF',
...
// Product API Service for Yojin Flax Bourton
class YojinFlaxBourtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Flax Bourton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFlaxBourtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFlaxBourtonProductService };
