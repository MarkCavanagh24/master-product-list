// Configuration for Yojin Elwick
// Store ID: 6855419721bb01b10405e475
// Location: Elwick, TS27 3HQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419721bb01b10405e475',
    storeName: 'Yojin Elwick',
    city: 'Elwick',
    postcode: 'TS27 3HQ',
...
// Product API Service for Yojin Elwick
class YojinElwickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Elwick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinElwickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinElwickProductService };
