// Configuration for Yojin Prudhoe
// Store ID: 6855418121bb01b10405e427
// Location: Prudhoe, NE42 6LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418121bb01b10405e427',
    storeName: 'Yojin Prudhoe',
    city: 'Prudhoe',
    postcode: 'NE42 6LJ',
...
// Product API Service for Yojin Prudhoe
class YojinPrudhoeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Prudhoe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPrudhoeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPrudhoeProductService };
