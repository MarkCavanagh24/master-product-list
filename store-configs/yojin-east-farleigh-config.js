// Configuration for Yojin East Farleigh
// Store ID: 6855425221bb01b10405e721
// Location: East Farleigh, ME16 9NG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425221bb01b10405e721',
    storeName: 'Yojin East Farleigh',
    city: 'East Farleigh',
    postcode: 'ME16 9NG',
...
// Product API Service for Yojin East Farleigh
class YojinEastFarleighProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Farleigh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastFarleighProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastFarleighProductService };
