// Configuration for Yojin Monkspath
// Store ID: 685541eb21bb01b10405e5ab
// Location: Monkspath, B90 4SJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541eb21bb01b10405e5ab',
    storeName: 'Yojin Monkspath',
    city: 'Monkspath',
    postcode: 'B90 4SJ',
...
// Product API Service for Yojin Monkspath
class YojinMonkspathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Monkspath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMonkspathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMonkspathProductService };
