// Configuration for Yojin Catforth
// Store ID: 685541b921bb01b10405e4f4
// Location: Catforth, PR4 0BP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b921bb01b10405e4f4',
    storeName: 'Yojin Catforth',
    city: 'Catforth',
    postcode: 'PR4 0BP',
...
// Product API Service for Yojin Catforth
class YojinCatforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Catforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCatforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCatforthProductService };
