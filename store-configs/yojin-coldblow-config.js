// Configuration for Yojin Coldblow
// Store ID: 6855424b21bb01b10405e709
// Location: Coldblow, DA5 2BX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424b21bb01b10405e709',
    storeName: 'Yojin Coldblow',
    city: 'Coldblow',
    postcode: 'DA5 2BX',
...
// Product API Service for Yojin Coldblow
class YojinColdblowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Coldblow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinColdblowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinColdblowProductService };
