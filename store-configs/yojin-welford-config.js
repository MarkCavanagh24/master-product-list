// Configuration for Yojin Welford
// Store ID: 685541e121bb01b10405e587
// Location: Welford, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e121bb01b10405e587',
    storeName: 'Yojin Welford',
    city: 'Welford',
    postcode: 'N/A',
...
// Product API Service for Yojin Welford
class YojinWelfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Welford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWelfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWelfordProductService };
