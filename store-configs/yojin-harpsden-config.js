// Configuration for Yojin Harpsden
// Store ID: 685541ed21bb01b10405e5b4
// Location: Harpsden, RG9 4HY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ed21bb01b10405e5b4',
    storeName: 'Yojin Harpsden',
    city: 'Harpsden',
    postcode: 'RG9 4HY',
...
// Product API Service for Yojin Harpsden
class YojinHarpsdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harpsden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHarpsdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHarpsdenProductService };
