// Configuration for Yojin Alwoodley
// Store ID: 685541b721bb01b10405e4eb
// Location: Alwoodley, LS16 8LZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b721bb01b10405e4eb',
    storeName: 'Yojin Alwoodley',
    city: 'Alwoodley',
    postcode: 'LS16 8LZ',
...
// Product API Service for Yojin Alwoodley
class YojinAlwoodleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Alwoodley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAlwoodleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAlwoodleyProductService };
