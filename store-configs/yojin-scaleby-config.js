// Configuration for Yojin Scaleby
// Store ID: 6855417e21bb01b10405e41d
// Location: Scaleby, CA6 4LS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417e21bb01b10405e41d',
    storeName: 'Yojin Scaleby',
    city: 'Scaleby',
    postcode: 'CA6 4LS',
...
// Product API Service for Yojin Scaleby
class YojinScalebyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scaleby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScalebyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScalebyProductService };
