// Configuration for Yojin Dudley Wood
// Store ID: 6855421a21bb01b10405e653
// Location: Dudley Wood, DY2 9SH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421a21bb01b10405e653',
    storeName: 'Yojin Dudley Wood',
    city: 'Dudley Wood',
    postcode: 'DY2 9SH',
...
// Product API Service for Yojin Dudley Wood
class YojinDudleyWoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dudley Wood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDudleyWoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDudleyWoodProductService };
