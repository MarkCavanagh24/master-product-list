// Configuration for Yojin Newholm-cum-Dunsley
// Store ID: 685541d321bb01b10405e553
// Location: Newholm-cum-Dunsley, YO21 3QY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d321bb01b10405e553',
    storeName: 'Yojin Newholm-cum-Dunsley',
    city: 'Newholm-cum-Dunsley',
    postcode: 'YO21 3QY',
...
// Product API Service for Yojin Newholm-cum-Dunsley
class YojinNewholmcumDunsleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newholm-cum-Dunsley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewholmcumDunsleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewholmcumDunsleyProductService };
