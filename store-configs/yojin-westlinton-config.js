// Configuration for Yojin Westlinton
// Store ID: 6855417e21bb01b10405e41c
// Location: Westlinton, CA6 4EP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417e21bb01b10405e41c',
    storeName: 'Yojin Westlinton',
    city: 'Westlinton',
    postcode: 'CA6 4EP',
...
// Product API Service for Yojin Westlinton
class YojinWestlintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Westlinton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestlintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestlintonProductService };
