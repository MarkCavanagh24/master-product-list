// Configuration for Yojin North Cave
// Store ID: 6855420b21bb01b10405e61d
// Location: North Cave, HU15 2LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420b21bb01b10405e61d',
    storeName: 'Yojin North Cave',
    city: 'North Cave',
    postcode: 'HU15 2LJ',
...
// Product API Service for Yojin North Cave
class YojinNorthCaveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Cave:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthCaveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthCaveProductService };
