// Configuration for Yojin Hanworth
// Store ID: 6855424921bb01b10405e701
// Location: Hanworth, TW13 7NW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424921bb01b10405e701',
    storeName: 'Yojin Hanworth',
    city: 'Hanworth',
    postcode: 'TW13 7NW',
...
// Product API Service for Yojin Hanworth
class YojinHanworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hanworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHanworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHanworthProductService };
