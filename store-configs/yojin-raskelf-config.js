// Configuration for Yojin Raskelf
// Store ID: 6855426d21bb01b10405e786
// Location: Raskelf, YO61 3SD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426d21bb01b10405e786',
    storeName: 'Yojin Raskelf',
    city: 'Raskelf',
    postcode: 'YO61 3SD',
...
// Product API Service for Yojin Raskelf
class YojinRaskelfProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Raskelf:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRaskelfProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRaskelfProductService };
