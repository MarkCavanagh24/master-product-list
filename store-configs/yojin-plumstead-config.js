// Configuration for Yojin Plumstead
// Store ID: 6855424121bb01b10405e6e3
// Location: Plumstead, SE18 2DE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424121bb01b10405e6e3',
    storeName: 'Yojin Plumstead',
    city: 'Plumstead',
    postcode: 'SE18 2DE',
...
// Product API Service for Yojin Plumstead
class YojinPlumsteadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Plumstead:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPlumsteadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPlumsteadProductService };
