// Configuration for Yojin Harrogate
// Store ID: 6855419d21bb01b10405e48b
// Location: Harrogate, HG1 2LP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419d21bb01b10405e48b',
...
// Product API Service for Yojin Harrogate
class YojinHarrogateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harrogate:', error);
            throw error;
        }
    }
...
module.exports = { STORE_CONFIG, YojinHarrogateProductService };
