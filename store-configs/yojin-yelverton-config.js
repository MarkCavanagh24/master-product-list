// Configuration for Yojin Yelverton
// Store ID: 685541c721bb01b10405e528
// Location: Yelverton, NR14 7PU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c721bb01b10405e528',
    storeName: 'Yojin Yelverton',
    city: 'Yelverton',
    postcode: 'NR14 7PU',
...
// Product API Service for Yojin Yelverton
class YojinYelvertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Yelverton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinYelvertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinYelvertonProductService };
