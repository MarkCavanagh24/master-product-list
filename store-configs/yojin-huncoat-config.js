// Configuration for Yojin Huncoat
// Store ID: 685541c121bb01b10405e512
// Location: Huncoat, BB5 5UU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c121bb01b10405e512',
    storeName: 'Yojin Huncoat',
    city: 'Huncoat',
    postcode: 'BB5 5UU',
...
// Product API Service for Yojin Huncoat
class YojinHuncoatProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Huncoat:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHuncoatProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHuncoatProductService };
