// Configuration for Yojin Low Ackworth
// Store ID: 6855426021bb01b10405e758
// Location: Low Ackworth, WF7 7NR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426021bb01b10405e758',
    storeName: 'Yojin Low Ackworth',
    city: 'Low Ackworth',
    postcode: 'WF7 7NR',
...
// Product API Service for Yojin Low Ackworth
class YojinLowAckworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Low Ackworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowAckworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowAckworthProductService };
