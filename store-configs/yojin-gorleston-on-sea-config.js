// Configuration for Yojin Gorleston-on-Sea
// Store ID: 685541c921bb01b10405e52c
// Location: Gorleston-on-Sea, NR31 6ED

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c921bb01b10405e52c',
    storeName: 'Yojin Gorleston-on-Sea',
...
// Product API Service for Yojin Gorleston-on-Sea
class YojinGorlestononSeaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gorleston-on-Sea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGorlestononSeaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGorlestononSeaProductService };
