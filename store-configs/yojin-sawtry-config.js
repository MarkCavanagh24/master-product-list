// Configuration for Yojin Sawtry
// Store ID: 685541e321bb01b10405e590
// Location: Sawtry, PE28 5UL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e321bb01b10405e590',
    storeName: 'Yojin Sawtry',
    city: 'Sawtry',
    postcode: 'PE28 5UL',
...
// Product API Service for Yojin Sawtry
class YojinSawtryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sawtry:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSawtryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSawtryProductService };
