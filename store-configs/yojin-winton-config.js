// Configuration for Yojin Winton
// Store ID: 685541b521bb01b10405e4e6
// Location: Winton, CA17 4HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b521bb01b10405e4e6',
    storeName: 'Yojin Winton',
    city: 'Winton',
    postcode: 'CA17 4HU',
...
// Product API Service for Yojin Winton
class YojinWintonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Winton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWintonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWintonProductService };
