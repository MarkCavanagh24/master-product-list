// Configuration for Yojin Wordsley
// Store ID: 6855421921bb01b10405e652
// Location: Wordsley, DY8 5UA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421921bb01b10405e652',
    storeName: 'Yojin Wordsley',
    city: 'Wordsley',
    postcode: 'DY8 5UA',
...
// Product API Service for Yojin Wordsley
class YojinWordsleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wordsley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWordsleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWordsleyProductService };
