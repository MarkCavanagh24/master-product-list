// Configuration for Yojin Chilcompton
// Store ID: 6855420621bb01b10405e60b
// Location: Chilcompton, BA3 4FQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420621bb01b10405e60b',
    storeName: 'Yojin Chilcompton',
    city: 'Chilcompton',
    postcode: 'BA3 4FQ',
...
// Product API Service for Yojin Chilcompton
class YojinChilcomptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chilcompton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChilcomptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChilcomptonProductService };
