// Configuration for Yojin Newbrough
// Store ID: 6855427521bb01b10405e7a3
// Location: Newbrough, NE47 5BE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427521bb01b10405e7a3',
    storeName: 'Yojin Newbrough',
    city: 'Newbrough',
    postcode: 'NE47 5BE',
...
// Product API Service for Yojin Newbrough
class YojinNewbroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newbrough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewbroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewbroughProductService };
