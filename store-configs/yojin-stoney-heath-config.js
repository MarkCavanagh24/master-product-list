// Configuration for Yojin Stoney Heath
// Store ID: 685541fd21bb01b10405e5ef
// Location: Stoney Heath, RG26 5RG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fd21bb01b10405e5ef',
    storeName: 'Yojin Stoney Heath',
    city: 'Stoney Heath',
    postcode: 'RG26 5RG',
...
// Product API Service for Yojin Stoney Heath
class YojinStoneyHeathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stoney Heath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStoneyHeathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStoneyHeathProductService };
