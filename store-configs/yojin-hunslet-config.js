// Configuration for Yojin Hunslet
// Store ID: 6855420921bb01b10405e615
// Location: Hunslet, LS10 1GE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420921bb01b10405e615',
    storeName: 'Yojin Hunslet',
    city: 'Hunslet',
    postcode: 'LS10 1GE',
...
// Product API Service for Yojin Hunslet
class YojinHunsletProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hunslet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHunsletProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHunsletProductService };
