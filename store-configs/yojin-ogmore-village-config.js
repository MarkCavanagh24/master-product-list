// Configuration for Yojin Ogmore Village
// Store ID: 685541f321bb01b10405e5c8
// Location: Ogmore Village, CF32 0QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f321bb01b10405e5c8',
    storeName: 'Yojin Ogmore Village',
    city: 'Ogmore Village',
    postcode: 'CF32 0QP',
...
// Product API Service for Yojin Ogmore Village
class YojinOgmoreVillageProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ogmore Village:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOgmoreVillageProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOgmoreVillageProductService };
