// Configuration for Yojin New Fryston
// Store ID: 6855421121bb01b10405e631
// Location: New Fryston, WF10 2SS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421121bb01b10405e631',
    storeName: 'Yojin New Fryston',
    city: 'New Fryston',
    postcode: 'WF10 2SS',
...
// Product API Service for Yojin New Fryston
class YojinNewFrystonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Fryston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewFrystonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewFrystonProductService };
