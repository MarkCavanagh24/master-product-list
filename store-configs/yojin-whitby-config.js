// Configuration for Yojin Whitby
// Store ID: 685541d321bb01b10405e554
// Location: Whitby, YO22 4JZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d321bb01b10405e554',
    storeName: 'Yojin Whitby',
    city: 'Whitby',
    postcode: 'YO22 4JZ',
...
// Product API Service for Yojin Whitby
class YojinWhitbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whitby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhitbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhitbyProductService };
