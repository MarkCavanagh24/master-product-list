// Configuration for Yojin Stilton
// Store ID: 6855421f21bb01b10405e667
// Location: Stilton, PE7 3XW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421f21bb01b10405e667',
    storeName: 'Yojin Stilton',
    city: 'Stilton',
    postcode: 'PE7 3XW',
...
// Product API Service for Yojin Stilton
class YojinStiltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stilton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStiltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStiltonProductService };
