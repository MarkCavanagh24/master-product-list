// Configuration for Yojin Barmston
// Store ID: 6855419c21bb01b10405e489
// Location: Barmston, YO15 3QU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419c21bb01b10405e489',
    storeName: 'Yojin Barmston',
    city: 'Barmston',
    postcode: 'YO15 3QU',
...
// Product API Service for Yojin Barmston
class YojinBarmstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Barmston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBarmstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBarmstonProductService };
