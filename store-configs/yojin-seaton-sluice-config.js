// Configuration for Yojin Seaton Sluice
// Store ID: 6855419921bb01b10405e47e
// Location: Seaton Sluice, NE26 4RE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419921bb01b10405e47e',
    storeName: 'Yojin Seaton Sluice',
    city: 'Seaton Sluice',
    postcode: 'NE26 4RE',
...
// Product API Service for Yojin Seaton Sluice
class YojinSeatonSluiceProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Seaton Sluice:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSeatonSluiceProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSeatonSluiceProductService };
