// Configuration for Yojin Thatcham
// Store ID: 6855428821bb01b10405e7e6
// Location: Thatcham, RG19 4AS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428821bb01b10405e7e6',
    storeName: 'Yojin Thatcham',
    city: 'Thatcham',
    postcode: 'RG19 4AS',
...
// Product API Service for Yojin Thatcham
class YojinThatchamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thatcham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThatchamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThatchamProductService };
