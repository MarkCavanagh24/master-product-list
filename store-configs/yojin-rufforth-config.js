// Configuration for Yojin Rufforth
// Store ID: 685541a121bb01b10405e49a
// Location: Rufforth, YO23 3RF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a121bb01b10405e49a',
    storeName: 'Yojin Rufforth',
    city: 'Rufforth',
    postcode: 'YO23 3RF',
...
// Product API Service for Yojin Rufforth
class YojinRufforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rufforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRufforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRufforthProductService };
