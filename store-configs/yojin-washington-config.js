// Configuration for Yojin Washington
// Store ID: 6855418521bb01b10405e439
// Location: Washington, SR5 3QY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418521bb01b10405e439',
    storeName: 'Yojin Washington',
    city: 'Washington',
    postcode: 'SR5 3QY',
...
// Product API Service for Yojin Washington
class YojinWashingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Washington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWashingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWashingtonProductService };
