// Configuration for Yojin New Herrington
// Store ID: 6855418821bb01b10405e443
// Location: New Herrington, DH4 7NA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418821bb01b10405e443',
    storeName: 'Yojin New Herrington',
    city: 'New Herrington',
    postcode: 'DH4 7NA',
...
// Product API Service for Yojin New Herrington
class YojinNewHerringtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Herrington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewHerringtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewHerringtonProductService };
