// Configuration for Yojin Thrapston
// Store ID: 6855423421bb01b10405e6b7
// Location: Thrapston, NN14 4FR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423421bb01b10405e6b7',
    storeName: 'Yojin Thrapston',
    city: 'Thrapston',
    postcode: 'NN14 4FR',
...
// Product API Service for Yojin Thrapston
class YojinThrapstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thrapston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThrapstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThrapstonProductService };
