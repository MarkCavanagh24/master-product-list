// Configuration for Yojin Shrewley
// Store ID: 6855427f21bb01b10405e7c8
// Location: Shrewley, CV35 7HJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427f21bb01b10405e7c8',
    storeName: 'Yojin Shrewley',
    city: 'Shrewley',
    postcode: 'CV35 7HJ',
...
// Product API Service for Yojin Shrewley
class YojinShrewleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Shrewley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinShrewleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinShrewleyProductService };
