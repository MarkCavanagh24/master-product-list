// Configuration for Yojin Treales
// Store ID: 685541bf21bb01b10405e50c
// Location: Treales, PR4 3SB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bf21bb01b10405e50c',
    storeName: 'Yojin Treales',
    city: 'Treales',
    postcode: 'PR4 3SB',
...
// Product API Service for Yojin Treales
class YojinTrealesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Treales:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTrealesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTrealesProductService };
