// Configuration for Yojin Summerstown
// Store ID: 6855424a21bb01b10405e704
// Location: Summerstown, SW17 0LF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424a21bb01b10405e704',
    storeName: 'Yojin Summerstown',
    city: 'Summerstown',
    postcode: 'SW17 0LF',
...
// Product API Service for Yojin Summerstown
class YojinSummerstownProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Summerstown:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSummerstownProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSummerstownProductService };
