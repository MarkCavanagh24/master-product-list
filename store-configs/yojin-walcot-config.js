// Configuration for Yojin Walcot
// Store ID: 6855428621bb01b10405e7e0
// Location: Walcot, BA1 6DF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428621bb01b10405e7e0',
    storeName: 'Yojin Walcot',
    city: 'Walcot',
    postcode: 'BA1 6DF',
...
// Product API Service for Yojin Walcot
class YojinWalcotProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walcot:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWalcotProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWalcotProductService };
