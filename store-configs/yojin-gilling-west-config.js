// Configuration for Yojin Gilling West
// Store ID: 685541d421bb01b10405e557
// Location: Gilling West, DL10 5HN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d421bb01b10405e557',
    storeName: 'Yojin Gilling West',
    city: 'Gilling West',
    postcode: 'DL10 5HN',
...
// Product API Service for Yojin Gilling West
class YojinGillingWestProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gilling West:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGillingWestProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGillingWestProductService };
