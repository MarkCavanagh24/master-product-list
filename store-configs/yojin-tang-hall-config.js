// Configuration for Yojin Tang Hall
// Store ID: 685541a121bb01b10405e49c
// Location: Tang Hall, YO10 3TW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a121bb01b10405e49c',
    storeName: 'Yojin Tang Hall',
    city: 'Tang Hall',
    postcode: 'YO10 3TW',
...
// Product API Service for Yojin Tang Hall
class YojinTangHallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tang Hall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTangHallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTangHallProductService };
