// Configuration for Yojin Beetham
// Store ID: 6855422a21bb01b10405e691
// Location: Beetham, LA6 1PB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422a21bb01b10405e691',
    storeName: 'Yojin Beetham',
    city: 'Beetham',
    postcode: 'LA6 1PB',
...
// Product API Service for Yojin Beetham
class YojinBeethamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Beetham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBeethamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBeethamProductService };
