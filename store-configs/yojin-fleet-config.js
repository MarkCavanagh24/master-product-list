// Configuration for Yojin Fleet
// Store ID: 6855424e21bb01b10405e712
// Location: Fleet, GU52 6PN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424e21bb01b10405e712',
    storeName: 'Yojin Fleet',
    city: 'Fleet',
    postcode: 'GU52 6PN',
...
// Product API Service for Yojin Fleet
class YojinFleetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fleet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFleetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFleetProductService };
