// Configuration for Yojin Kinver
// Store ID: 6855421921bb01b10405e651
// Location: Kinver, DY7 5AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421921bb01b10405e651',
    storeName: 'Yojin Kinver',
    city: 'Kinver',
    postcode: 'DY7 5AY',
...
// Product API Service for Yojin Kinver
class YojinKinverProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kinver:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKinverProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKinverProductService };
