// Configuration for Yojin Fetcham
// Store ID: 6855420021bb01b10405e5f7
// Location: Fetcham, KT22 0AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420021bb01b10405e5f7',
    storeName: 'Yojin Fetcham',
    city: 'Fetcham',
    postcode: 'KT22 0AY',
...
// Product API Service for Yojin Fetcham
class YojinFetchamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fetcham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFetchamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFetchamProductService };
