// Configuration for Yojin Wrea Green
// Store ID: 685541bf21bb01b10405e50b
// Location: Wrea Green, PR4 2RL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bf21bb01b10405e50b',
    storeName: 'Yojin Wrea Green',
    city: 'Wrea Green',
    postcode: 'PR4 2RL',
...
// Product API Service for Yojin Wrea Green
class YojinWreaGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrea Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWreaGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWreaGreenProductService };
