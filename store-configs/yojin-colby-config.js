// Configuration for Yojin Colby
// Store ID: 685541ac21bb01b10405e4c3
// Location: Colby, CA16 6BB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ac21bb01b10405e4c3',
    storeName: 'Yojin Colby',
    city: 'Colby',
    postcode: 'CA16 6BB',
...
// Product API Service for Yojin Colby
class YojinColbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Colby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinColbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinColbyProductService };
