// Configuration for Yojin St Philip's Marsh
// Store ID: 6855424421bb01b10405e6f0
// Location: St Philip's Marsh, BS4 3JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424421bb01b10405e6f0',
    storeName: 'Yojin St Philip's Marsh',
    city: 'St Philip's Marsh',
    postcode: 'BS4 3JB',
...
// Product API Service for Yojin St Philip's Marsh
class YojinStPhilipsMarshProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin St Philip's Marsh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStPhilipsMarshProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStPhilipsMarshProductService };
