// Configuration for Yojin Bressingham
// Store ID: 6855423721bb01b10405e6c0
// Location: Bressingham, IP22 2AN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423721bb01b10405e6c0',
    storeName: 'Yojin Bressingham',
    city: 'Bressingham',
    postcode: 'IP22 2AN',
...
// Product API Service for Yojin Bressingham
class YojinBressinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bressingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBressinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBressinghamProductService };
