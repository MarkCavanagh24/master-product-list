// Configuration for Yojin Brookwood
// Store ID: 685541ff21bb01b10405e5f5
// Location: Brookwood, GU24 0ES

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ff21bb01b10405e5f5',
    storeName: 'Yojin Brookwood',
    city: 'Brookwood',
    postcode: 'GU24 0ES',
...
// Product API Service for Yojin Brookwood
class YojinBrookwoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brookwood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrookwoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrookwoodProductService };
