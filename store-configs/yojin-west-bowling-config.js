// Configuration for Yojin West Bowling
// Store ID: 685541c221bb01b10405e518
// Location: West Bowling, BD4 7EZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c221bb01b10405e518',
    storeName: 'Yojin West Bowling',
    city: 'West Bowling',
    postcode: 'BD4 7EZ',
...
// Product API Service for Yojin West Bowling
class YojinWestBowlingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Bowling:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestBowlingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestBowlingProductService };
