// Configuration for Yojin Morley St Botolph
// Store ID: 685541c621bb01b10405e525
// Location: Morley St Botolph, NR18 9QS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c621bb01b10405e525',
    storeName: 'Yojin Morley St Botolph',
    city: 'Morley St Botolph',
    postcode: 'NR18 9QS',
...
// Product API Service for Yojin Morley St Botolph
class YojinMorleyStBotolphProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Morley St Botolph:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMorleyStBotolphProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMorleyStBotolphProductService };
