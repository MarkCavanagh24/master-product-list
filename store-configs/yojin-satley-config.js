// Configuration for Yojin Satley
// Store ID: 6855418c21bb01b10405e44f
// Location: Satley, DL13 4HT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418c21bb01b10405e44f',
    storeName: 'Yojin Satley',
    city: 'Satley',
    postcode: 'DL13 4HT',
...
// Product API Service for Yojin Satley
class YojinSatleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Satley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSatleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSatleyProductService };
