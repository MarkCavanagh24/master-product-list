// Configuration for Yojin Kennythorpe
// Store ID: 6855427221bb01b10405e799
// Location: Kennythorpe, YO17 9QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427221bb01b10405e799',
    storeName: 'Yojin Kennythorpe',
    city: 'Kennythorpe',
    postcode: 'YO17 9QT',
...
// Product API Service for Yojin Kennythorpe
class YojinKennythorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kennythorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKennythorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKennythorpeProductService };
