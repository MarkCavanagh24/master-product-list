// Configuration for Yojin Westbury
// Store ID: 6855420721bb01b10405e610
// Location: Westbury, BA13 4TQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420721bb01b10405e610',
    storeName: 'Yojin Westbury',
    city: 'Westbury',
    postcode: 'BA13 4TQ',
...
// Product API Service for Yojin Westbury
class YojinWestburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Westbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestburyProductService };
