// Configuration for Yojin Pallion
// Store ID: 6855418621bb01b10405e43a
// Location: Pallion, SR4 6TY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418621bb01b10405e43a',
    storeName: 'Yojin Pallion',
    city: 'Pallion',
    postcode: 'SR4 6TY',
...
// Product API Service for Yojin Pallion
class YojinPallionProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pallion:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPallionProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPallionProductService };
