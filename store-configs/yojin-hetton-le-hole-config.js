// Configuration for Yojin Hetton-le-Hole
// Store ID: 6855418b21bb01b10405e44c
// Location: Hetton-le-Hole, DH5 9GD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418b21bb01b10405e44c',
    storeName: 'Yojin Hetton-le-Hole',
    city: 'Hetton-le-Hole',
    postcode: 'DH5 9GD',
...
// Product API Service for Yojin Hetton-le-Hole
class YojinHettonleHoleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hetton-le-Hole:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHettonleHoleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHettonleHoleProductService };
