// Configuration for Yojin Newbold on Avon
// Store ID: 6855423221bb01b10405e6ac
// Location: Newbold on Avon, CV23 0JJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423221bb01b10405e6ac',
    storeName: 'Yojin Newbold on Avon',
    city: 'Newbold on Avon',
    postcode: 'CV23 0JJ',
...
// Product API Service for Yojin Newbold on Avon
class YojinNewboldonAvonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newbold on Avon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewboldonAvonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewboldonAvonProductService };
