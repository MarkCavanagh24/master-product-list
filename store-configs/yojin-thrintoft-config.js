// Configuration for Yojin Thrintoft
// Store ID: 685541dc21bb01b10405e574
// Location: Thrintoft, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dc21bb01b10405e574',
    storeName: 'Yojin Thrintoft',
    city: 'Thrintoft',
    postcode: 'N/A',
...
// Product API Service for Yojin Thrintoft
class YojinThrintoftProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thrintoft:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThrintoftProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThrintoftProductService };
