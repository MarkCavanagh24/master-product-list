// Configuration for Yojin Bapchild
// Store ID: 6855420321bb01b10405e602
// Location: Bapchild, ME9 9PA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420321bb01b10405e602',
    storeName: 'Yojin Bapchild',
    city: 'Bapchild',
    postcode: 'ME9 9PA',
...
// Product API Service for Yojin Bapchild
class YojinBapchildProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bapchild:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBapchildProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBapchildProductService };
