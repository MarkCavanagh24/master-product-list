// Configuration for Yojin Woodnesborough
// Store ID: 6855425321bb01b10405e727
// Location: Woodnesborough, CT13 0NN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425321bb01b10405e727',
    storeName: 'Yojin Woodnesborough',
    city: 'Woodnesborough',
    postcode: 'CT13 0NN',
...
// Product API Service for Yojin Woodnesborough
class YojinWoodnesboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Woodnesborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoodnesboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoodnesboroughProductService };
