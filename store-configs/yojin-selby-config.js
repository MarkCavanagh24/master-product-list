// Configuration for Yojin Selby
// Store ID: 6855420a21bb01b10405e61a
// Location: Selby, YO8 4HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420a21bb01b10405e61a',
    storeName: 'Yojin Selby',
    city: 'Selby',
    postcode: 'YO8 4HZ',
...
// Product API Service for Yojin Selby
class YojinSelbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Selby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSelbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSelbyProductService };
