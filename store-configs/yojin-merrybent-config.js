// Configuration for Yojin Merrybent
// Store ID: 685541b221bb01b10405e4da
// Location: Merrybent, DL2 2RD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b221bb01b10405e4da',
    storeName: 'Yojin Merrybent',
    city: 'Merrybent',
    postcode: 'DL2 2RD',
...
// Product API Service for Yojin Merrybent
class YojinMerrybentProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Merrybent:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMerrybentProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMerrybentProductService };
