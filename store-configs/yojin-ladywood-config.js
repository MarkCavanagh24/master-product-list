// Configuration for Yojin Ladywood
// Store ID: 6855421a21bb01b10405e655
// Location: Ladywood, B16 9EY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421a21bb01b10405e655',
    storeName: 'Yojin Ladywood',
    city: 'Ladywood',
    postcode: 'B16 9EY',
...
// Product API Service for Yojin Ladywood
class YojinLadywoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ladywood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLadywoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLadywoodProductService };
