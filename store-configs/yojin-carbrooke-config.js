// Configuration for Yojin Carbrooke
// Store ID: 685541c621bb01b10405e522
// Location: Carbrooke, IP25 6JP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c621bb01b10405e522',
    storeName: 'Yojin Carbrooke',
    city: 'Carbrooke',
    postcode: 'IP25 6JP',
...
// Product API Service for Yojin Carbrooke
class YojinCarbrookeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Carbrooke:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCarbrookeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCarbrookeProductService };
