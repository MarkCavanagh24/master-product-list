// Configuration for Yojin Upsall
// Store ID: 6855422821bb01b10405e688
// Location: Upsall, YO7 2NX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422821bb01b10405e688',
    storeName: 'Yojin Upsall',
    city: 'Upsall',
    postcode: 'YO7 2NX',
...
// Product API Service for Yojin Upsall
class YojinUpsallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Upsall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpsallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpsallProductService };
