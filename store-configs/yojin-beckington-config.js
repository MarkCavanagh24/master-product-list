// Configuration for Yojin Beckington
// Store ID: 6855420721bb01b10405e60e
// Location: Beckington, BA11 6TE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420721bb01b10405e60e',
    storeName: 'Yojin Beckington',
    city: 'Beckington',
    postcode: 'BA11 6TE',
...
// Product API Service for Yojin Beckington
class YojinBeckingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Beckington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBeckingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBeckingtonProductService };
