// Configuration for Yojin Mickleton
// Store ID: 685541a921bb01b10405e4b8
// Location: Mickleton, DL12 0NS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a921bb01b10405e4b8',
    storeName: 'Yojin Mickleton',
    city: 'Mickleton',
    postcode: 'DL12 0NS',
...
// Product API Service for Yojin Mickleton
class YojinMickletonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mickleton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMickletonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMickletonProductService };
