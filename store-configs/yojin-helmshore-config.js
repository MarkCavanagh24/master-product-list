// Configuration for Yojin Helmshore
// Store ID: 6855421421bb01b10405e63d
// Location: Helmshore, BB4 4QR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421421bb01b10405e63d',
    storeName: 'Yojin Helmshore',
    city: 'Helmshore',
    postcode: 'BB4 4QR',
...
// Product API Service for Yojin Helmshore
class YojinHelmshoreProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Helmshore:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHelmshoreProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHelmshoreProductService };
