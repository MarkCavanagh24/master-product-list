// Configuration for Yojin St Cuthbert Without
// Store ID: 6855418621bb01b10405e43b
// Location: St Cuthbert Without, CA2 4SN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418621bb01b10405e43b',
    storeName: 'Yojin St Cuthbert Without',
    city: 'St Cuthbert Without',
    postcode: 'CA2 4SN',
...
// Product API Service for Yojin St Cuthbert Without
class YojinStCuthbertWithoutProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin St Cuthbert Without:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStCuthbertWithoutProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStCuthbertWithoutProductService };
