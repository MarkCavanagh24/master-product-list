// Configuration for Yojin Dunscar
// Store ID: 6855426421bb01b10405e765
// Location: Dunscar, BL1 7JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426421bb01b10405e765',
    storeName: 'Yojin Dunscar',
    city: 'Dunscar',
    postcode: 'BL1 7JG',
...
// Product API Service for Yojin Dunscar
class YojinDunscarProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dunscar:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDunscarProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDunscarProductService };
