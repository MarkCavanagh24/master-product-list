// Configuration for Yojin Weaverthorpe
// Store ID: 6855426e21bb01b10405e78a
// Location: Weaverthorpe, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426e21bb01b10405e78a',
    storeName: 'Yojin Weaverthorpe',
    city: 'Weaverthorpe',
    postcode: 'N/A',
...
// Product API Service for Yojin Weaverthorpe
class YojinWeaverthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Weaverthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWeaverthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWeaverthorpeProductService };
