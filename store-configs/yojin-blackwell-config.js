// Configuration for Yojin Blackwell
// Store ID: 6855423921bb01b10405e6ca
// Location: Blackwell, B60 1QD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423921bb01b10405e6ca',
    storeName: 'Yojin Blackwell',
    city: 'Blackwell',
    postcode: 'B60 1QD',
...
// Product API Service for Yojin Blackwell
class YojinBlackwellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blackwell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlackwellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlackwellProductService };
