// Configuration for Yojin Whittington
// Store ID: 6855422f21bb01b10405e6a2
// Location: Whittington, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422f21bb01b10405e6a2',
    storeName: 'Yojin Whittington',
    city: 'Whittington',
    postcode: 'N/A',
...
// Product API Service for Yojin Whittington
class YojinWhittingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whittington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhittingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhittingtonProductService };
