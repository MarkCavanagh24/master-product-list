// Configuration for Yojin West Chevin
// Store ID: 685541a421bb01b10405e4a8
// Location: West Chevin, LS21 3DW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a421bb01b10405e4a8',
    storeName: 'Yojin West Chevin',
    city: 'West Chevin',
    postcode: 'LS21 3DW',
...
// Product API Service for Yojin West Chevin
class YojinWestChevinProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Chevin:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestChevinProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestChevinProductService };
