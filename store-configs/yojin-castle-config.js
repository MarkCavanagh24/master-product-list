// Configuration for Yojin Castle
// Store ID: 685541f521bb01b10405e5ce
// Location: Castle, CF10 1LA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f521bb01b10405e5ce',
    storeName: 'Yojin Castle',
    city: 'Castle',
    postcode: 'CF10 1LA',
...
// Product API Service for Yojin Castle
class YojinCastleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Castle:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCastleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCastleProductService };
