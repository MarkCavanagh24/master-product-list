// Configuration for Yojin Cononley
// Store ID: 685541a421bb01b10405e4a5
// Location: Cononley, BD20 8NX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a421bb01b10405e4a5',
    storeName: 'Yojin Cononley',
    city: 'Cononley',
    postcode: 'BD20 8NX',
...
// Product API Service for Yojin Cononley
class YojinCononleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cononley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCononleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCononleyProductService };
