// Configuration for Yojin Woodway Park
// Store ID: 685541e021bb01b10405e582
// Location: Woodway Park, CV2 2RA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e021bb01b10405e582',
    storeName: 'Yojin Woodway Park',
    city: 'Woodway Park',
    postcode: 'CV2 2RA',
...
// Product API Service for Yojin Woodway Park
class YojinWoodwayParkProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Woodway Park:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoodwayParkProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoodwayParkProductService };
