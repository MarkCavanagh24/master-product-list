// Configuration for Yojin Knapton
// Store ID: 6855426921bb01b10405e776
// Location: Knapton, YO17 8HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426921bb01b10405e776',
    storeName: 'Yojin Knapton',
    city: 'Knapton',
    postcode: 'YO17 8HZ',
...
// Product API Service for Yojin Knapton
class YojinKnaptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Knapton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKnaptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKnaptonProductService };
