// Configuration for Yojin Cottingley
// Store ID: 685541bb21bb01b10405e4fc
// Location: Cottingley, BD16 1UW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bb21bb01b10405e4fc',
    storeName: 'Yojin Cottingley',
    city: 'Cottingley',
    postcode: 'BD16 1UW',
...
// Product API Service for Yojin Cottingley
class YojinCottingleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cottingley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCottingleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCottingleyProductService };
