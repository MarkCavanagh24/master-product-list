// Configuration for Yojin Shorne
// Store ID: 6855424c21bb01b10405e70d
// Location: Shorne, DA12 3HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424c21bb01b10405e70d',
    storeName: 'Yojin Shorne',
    city: 'Shorne',
    postcode: 'DA12 3HU',
...
// Product API Service for Yojin Shorne
class YojinShorneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Shorne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinShorneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinShorneProductService };
