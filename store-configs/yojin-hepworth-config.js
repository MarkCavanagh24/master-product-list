// Configuration for Yojin Hepworth
// Store ID: 6855427a21bb01b10405e7b6
// Location: Hepworth, IP22 2PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427a21bb01b10405e7b6',
    storeName: 'Yojin Hepworth',
    city: 'Hepworth',
    postcode: 'IP22 2PR',
...
// Product API Service for Yojin Hepworth
class YojinHepworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hepworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHepworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHepworthProductService };
