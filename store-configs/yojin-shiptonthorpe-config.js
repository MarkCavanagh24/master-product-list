// Configuration for Yojin Shiptonthorpe
// Store ID: 685541b821bb01b10405e4ef
// Location: Shiptonthorpe, YO43 3PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b821bb01b10405e4ef',
    storeName: 'Yojin Shiptonthorpe',
    city: 'Shiptonthorpe',
    postcode: 'YO43 3PR',
...
// Product API Service for Yojin Shiptonthorpe
class YojinShiptonthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Shiptonthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinShiptonthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinShiptonthorpeProductService };
