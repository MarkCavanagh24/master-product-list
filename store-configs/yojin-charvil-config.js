// Configuration for Yojin Charvil
// Store ID: 685541f821bb01b10405e5db
// Location: Charvil, RG10 9QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f821bb01b10405e5db',
    storeName: 'Yojin Charvil',
    city: 'Charvil',
    postcode: 'RG10 9QJ',
...
// Product API Service for Yojin Charvil
class YojinCharvilProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Charvil:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCharvilProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCharvilProductService };
