// Configuration for Yojin Skipsea
// Store ID: 685541a321bb01b10405e4a2
// Location: Skipsea, YO25 8EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a321bb01b10405e4a2',
    storeName: 'Yojin Skipsea',
    city: 'Skipsea',
    postcode: 'YO25 8EF',
...
// Product API Service for Yojin Skipsea
class YojinSkipseaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skipsea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkipseaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkipseaProductService };
