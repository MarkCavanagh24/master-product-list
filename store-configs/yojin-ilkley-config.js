// Configuration for Yojin Ilkley
// Store ID: 685541a421bb01b10405e4a7
// Location: Ilkley, LS29 8RF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a421bb01b10405e4a7',
    storeName: 'Yojin Ilkley',
    city: 'Ilkley',
    postcode: 'LS29 8RF',
...
// Product API Service for Yojin Ilkley
class YojinIlkleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ilkley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIlkleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIlkleyProductService };
