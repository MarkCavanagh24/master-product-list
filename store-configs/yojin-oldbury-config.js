// Configuration for Yojin Oldbury
// Store ID: 685541c921bb01b10405e52e
// Location: Oldbury, WV16 5EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c921bb01b10405e52e',
    storeName: 'Yojin Oldbury',
    city: 'Oldbury',
    postcode: 'WV16 5EF',
...
// Product API Service for Yojin Oldbury
class YojinOldburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oldbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOldburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOldburyProductService };
