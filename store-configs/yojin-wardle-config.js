// Configuration for Yojin Wardle
// Store ID: 6855425e21bb01b10405e751
// Location: Wardle, OL12 9NF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425e21bb01b10405e751',
    storeName: 'Yojin Wardle',
    city: 'Wardle',
    postcode: 'OL12 9NF',
...
// Product API Service for Yojin Wardle
class YojinWardleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wardle:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWardleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWardleProductService };
