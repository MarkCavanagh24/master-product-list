// Configuration for Yojin Eamont Bridge
// Store ID: 6855419421bb01b10405e46c
// Location: Eamont Bridge, CA10 2BN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419421bb01b10405e46c',
    storeName: 'Yojin Eamont Bridge',
    city: 'Eamont Bridge',
    postcode: 'CA10 2BN',
...
// Product API Service for Yojin Eamont Bridge
class YojinEamontBridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Eamont Bridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEamontBridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEamontBridgeProductService };
