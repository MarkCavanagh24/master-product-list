// Configuration for Yojin Upper Bentley
// Store ID: 6855427f21bb01b10405e7c5
// Location: Upper Bentley, B60 3BB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427f21bb01b10405e7c5',
    storeName: 'Yojin Upper Bentley',
    city: 'Upper Bentley',
    postcode: 'B60 3BB',
...
// Product API Service for Yojin Upper Bentley
class YojinUpperBentleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Upper Bentley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpperBentleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpperBentleyProductService };
