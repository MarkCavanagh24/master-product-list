// Configuration for Yojin Strawberry Hill
// Store ID: 6855424921bb01b10405e702
// Location: Strawberry Hill, TW1 4SL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424921bb01b10405e702',
    storeName: 'Yojin Strawberry Hill',
    city: 'Strawberry Hill',
    postcode: 'TW1 4SL',
...
// Product API Service for Yojin Strawberry Hill
class YojinStrawberryHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Strawberry Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStrawberryHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStrawberryHillProductService };
