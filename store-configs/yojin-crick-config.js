// Configuration for Yojin Crick
// Store ID: 6855423d21bb01b10405e6d7
// Location: Crick, NN6 7SJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423d21bb01b10405e6d7',
    storeName: 'Yojin Crick',
    city: 'Crick',
    postcode: 'NN6 7SJ',
...
// Product API Service for Yojin Crick
class YojinCrickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCrickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCrickProductService };
