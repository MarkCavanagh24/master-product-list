// Configuration for Yojin Gretton
// Store ID: 685541cf21bb01b10405e545
// Location: Gretton, LE16 8TE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cf21bb01b10405e545',
    storeName: 'Yojin Gretton',
    city: 'Gretton',
    postcode: 'LE16 8TE',
...
// Product API Service for Yojin Gretton
class YojinGrettonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gretton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGrettonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGrettonProductService };
