// Configuration for Yojin Monkton Farleigh
// Store ID: 6855428621bb01b10405e7e1
// Location: Monkton Farleigh, BA15 2QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428621bb01b10405e7e1',
    storeName: 'Yojin Monkton Farleigh',
    city: 'Monkton Farleigh',
    postcode: 'BA15 2QP',
...
// Product API Service for Yojin Monkton Farleigh
class YojinMonktonFarleighProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Monkton Farleigh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMonktonFarleighProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMonktonFarleighProductService };
