// Configuration for Yojin Methwold
// Store ID: 6855421721bb01b10405e648
// Location: Methwold, IP26 4RN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421721bb01b10405e648',
    storeName: 'Yojin Methwold',
    city: 'Methwold',
    postcode: 'IP26 4RN',
...
// Product API Service for Yojin Methwold
class YojinMethwoldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Methwold:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMethwoldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMethwoldProductService };
