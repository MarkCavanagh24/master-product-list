// Configuration for Yojin Kemsing
// Store ID: 6855420221bb01b10405e5fe
// Location: Kemsing, TN15 0BY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420221bb01b10405e5fe',
    storeName: 'Yojin Kemsing',
    city: 'Kemsing',
    postcode: 'TN15 0BY',
...
// Product API Service for Yojin Kemsing
class YojinKemsingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kemsing:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKemsingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKemsingProductService };
