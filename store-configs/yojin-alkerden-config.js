// Configuration for Yojin Alkerden
// Store ID: 6855424c21bb01b10405e70b
// Location: Alkerden, DA10 1FG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424c21bb01b10405e70b',
    storeName: 'Yojin Alkerden',
    city: 'Alkerden',
    postcode: 'DA10 1FG',
...
// Product API Service for Yojin Alkerden
class YojinAlkerdenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Alkerden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAlkerdenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAlkerdenProductService };
