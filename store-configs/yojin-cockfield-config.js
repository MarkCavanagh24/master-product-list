// Configuration for Yojin Cockfield
// Store ID: 685541aa21bb01b10405e4bb
// Location: Cockfield, DL13 5RB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541aa21bb01b10405e4bb',
    storeName: 'Yojin Cockfield',
    city: 'Cockfield',
    postcode: 'DL13 5RB',
...
// Product API Service for Yojin Cockfield
class YojinCockfieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cockfield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCockfieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCockfieldProductService };
