// Configuration for Yojin Burbage
// Store ID: 685541fd21bb01b10405e5ed
// Location: Burbage, SN8 3RX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fd21bb01b10405e5ed',
    storeName: 'Yojin Burbage',
    city: 'Burbage',
    postcode: 'SN8 3RX',
...
// Product API Service for Yojin Burbage
class YojinBurbageProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burbage:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurbageProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurbageProductService };
