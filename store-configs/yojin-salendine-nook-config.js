// Configuration for Yojin Salendine Nook
// Store ID: 6855425f21bb01b10405e752
// Location: Salendine Nook, HD3 4GL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425f21bb01b10405e752',
    storeName: 'Yojin Salendine Nook',
    city: 'Salendine Nook',
    postcode: 'HD3 4GL',
...
// Product API Service for Yojin Salendine Nook
class YojinSalendineNookProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Salendine Nook:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSalendineNookProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSalendineNookProductService };
