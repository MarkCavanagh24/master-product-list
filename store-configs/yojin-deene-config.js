// Configuration for Yojin Deene
// Store ID: 685541d021bb01b10405e546
// Location: Deene, NN17 3EN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d021bb01b10405e546',
    storeName: 'Yojin Deene',
    city: 'Deene',
    postcode: 'NN17 3EN',
...
// Product API Service for Yojin Deene
class YojinDeeneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Deene:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDeeneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDeeneProductService };
