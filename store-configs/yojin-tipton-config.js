// Configuration for Yojin Tipton
// Store ID: 685541ca21bb01b10405e533
// Location: Tipton, DY4 8JT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ca21bb01b10405e533',
    storeName: 'Yojin Tipton',
    city: 'Tipton',
    postcode: 'DY4 8JT',
...
// Product API Service for Yojin Tipton
class YojinTiptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tipton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTiptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTiptonProductService };
