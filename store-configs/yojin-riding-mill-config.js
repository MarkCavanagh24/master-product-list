// Configuration for Yojin Riding Mill
// Store ID: 6855418421bb01b10405e433
// Location: Riding Mill, DH8 9RP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418421bb01b10405e433',
    storeName: 'Yojin Riding Mill',
    city: 'Riding Mill',
    postcode: 'DH8 9RP',
...
// Product API Service for Yojin Riding Mill
class YojinRidingMillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Riding Mill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRidingMillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRidingMillProductService };
