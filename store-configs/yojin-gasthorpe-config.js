// Configuration for Yojin Gasthorpe
// Store ID: 6855423621bb01b10405e6be
// Location: Gasthorpe, IP22 2TN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423621bb01b10405e6be',
    storeName: 'Yojin Gasthorpe',
    city: 'Gasthorpe',
    postcode: 'IP22 2TN',
...
// Product API Service for Yojin Gasthorpe
class YojinGasthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gasthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGasthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGasthorpeProductService };
