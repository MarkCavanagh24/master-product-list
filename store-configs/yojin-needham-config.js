// Configuration for Yojin Needham
// Store ID: 6855423821bb01b10405e6c3
// Location: Needham, IP20 9LH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423821bb01b10405e6c3',
    storeName: 'Yojin Needham',
    city: 'Needham',
    postcode: 'IP20 9LH',
...
// Product API Service for Yojin Needham
class YojinNeedhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Needham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNeedhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNeedhamProductService };
