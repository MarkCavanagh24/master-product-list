// Configuration for Yojin Great Bookham
// Store ID: 6855424f21bb01b10405e719
// Location: Great Bookham, KT23 4QG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424f21bb01b10405e719',
    storeName: 'Yojin Great Bookham',
    city: 'Great Bookham',
    postcode: 'KT23 4QG',
...
// Product API Service for Yojin Great Bookham
class YojinGreatBookhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Bookham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatBookhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatBookhamProductService };
