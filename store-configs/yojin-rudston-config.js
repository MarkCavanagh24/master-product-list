// Configuration for Yojin Rudston
// Store ID: 6855427321bb01b10405e79e
// Location: Rudston, YO16 4XJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427321bb01b10405e79e',
    storeName: 'Yojin Rudston',
    city: 'Rudston',
    postcode: 'YO16 4XJ',
...
// Product API Service for Yojin Rudston
class YojinRudstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rudston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRudstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRudstonProductService };
