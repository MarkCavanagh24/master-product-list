// Configuration for Yojin Longnewton
// Store ID: 685541b321bb01b10405e4dd
// Location: Longnewton, TS16 0TD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b321bb01b10405e4dd',
    storeName: 'Yojin Longnewton',
    city: 'Longnewton',
    postcode: 'TS16 0TD',
...
// Product API Service for Yojin Longnewton
class YojinLongnewtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Longnewton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLongnewtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLongnewtonProductService };
