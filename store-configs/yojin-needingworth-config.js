// Configuration for Yojin Needingworth
// Store ID: 6855427821bb01b10405e7ad
// Location: Needingworth, PE27 4NE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427821bb01b10405e7ad',
    storeName: 'Yojin Needingworth',
    city: 'Needingworth',
    postcode: 'PE27 4NE',
...
// Product API Service for Yojin Needingworth
class YojinNeedingworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Needingworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNeedingworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNeedingworthProductService };
