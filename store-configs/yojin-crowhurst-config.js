// Configuration for Yojin Crowhurst
// Store ID: 6855425921bb01b10405e73c
// Location: Crowhurst, RH8 9HH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425921bb01b10405e73c',
    storeName: 'Yojin Crowhurst',
    city: 'Crowhurst',
    postcode: 'RH8 9HH',
...
// Product API Service for Yojin Crowhurst
class YojinCrowhurstProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crowhurst:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCrowhurstProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCrowhurstProductService };
