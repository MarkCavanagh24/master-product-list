// Configuration for Yojin Fourstones
// Store ID: 6855417c21bb01b10405e415
// Location: Fourstones, NE46 4SX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417c21bb01b10405e415',
    storeName: 'Yojin Fourstones',
    city: 'Fourstones',
    postcode: 'NE46 4SX',
...
// Product API Service for Yojin Fourstones
class YojinFourstonesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fourstones:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFourstonesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFourstonesProductService };
