// Configuration for Yojin Minworth
// Store ID: 685541cb21bb01b10405e537
// Location: Minworth, B35 6LY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cb21bb01b10405e537',
    storeName: 'Yojin Minworth',
    city: 'Minworth',
    postcode: 'B35 6LY',
...
// Product API Service for Yojin Minworth
class YojinMinworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Minworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMinworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMinworthProductService };
