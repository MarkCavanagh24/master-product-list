// Configuration for Yojin Sneaton
// Store ID: 685541d721bb01b10405e561
// Location: Sneaton, YO22 5JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d721bb01b10405e561',
    storeName: 'Yojin Sneaton',
    city: 'Sneaton',
    postcode: 'YO22 5JG',
...
// Product API Service for Yojin Sneaton
class YojinSneatonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sneaton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSneatonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSneatonProductService };
