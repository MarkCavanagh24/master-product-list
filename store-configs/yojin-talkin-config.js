// Configuration for Yojin Talkin
// Store ID: 6855418321bb01b10405e431
// Location: Talkin, CA8 1AQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418321bb01b10405e431',
    storeName: 'Yojin Talkin',
    city: 'Talkin',
    postcode: 'CA8 1AQ',
...
// Product API Service for Yojin Talkin
class YojinTalkinProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Talkin:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTalkinProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTalkinProductService };
