// Configuration for Yojin Haworth
// Store ID: 685541ba21bb01b10405e4fa
// Location: Haworth, BD22 8QS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ba21bb01b10405e4fa',
    storeName: 'Yojin Haworth',
    city: 'Haworth',
    postcode: 'BD22 8QS',
...
// Product API Service for Yojin Haworth
class YojinHaworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Haworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaworthProductService };
