// Configuration for Yojin Stoke Holy Cross
// Store ID: 685541c721bb01b10405e527
// Location: Stoke Holy Cross, NR14 8LH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c721bb01b10405e527',
    storeName: 'Yojin Stoke Holy Cross',
    city: 'Stoke Holy Cross',
    postcode: 'NR14 8LH',
...
// Product API Service for Yojin Stoke Holy Cross
class YojinStokeHolyCrossProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stoke Holy Cross:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStokeHolyCrossProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStokeHolyCrossProductService };
