// Configuration for Yojin Lockington
// Store ID: 685541a721bb01b10405e4b1
// Location: Lockington, YO25 9SQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a721bb01b10405e4b1',
    storeName: 'Yojin Lockington',
    city: 'Lockington',
    postcode: 'YO25 9SQ',
...
// Product API Service for Yojin Lockington
class YojinLockingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lockington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLockingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLockingtonProductService };
