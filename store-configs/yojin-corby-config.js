// Configuration for Yojin Corby
// Store ID: 6855421d21bb01b10405e661
// Location: Corby, NN18 9BE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421d21bb01b10405e661',
    storeName: 'Yojin Corby',
    city: 'Corby',
    postcode: 'NN18 9BE',
...
// Product API Service for Yojin Corby
class YojinCorbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Corby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCorbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCorbyProductService };
