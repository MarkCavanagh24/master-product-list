// Configuration for Yojin Hinton Blewett
// Store ID: 685541fa21bb01b10405e5e3
// Location: Hinton Blewett, BS39 5AH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fa21bb01b10405e5e3',
    storeName: 'Yojin Hinton Blewett',
    city: 'Hinton Blewett',
    postcode: 'BS39 5AH',
...
// Product API Service for Yojin Hinton Blewett
class YojinHintonBlewettProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hinton Blewett:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHintonBlewettProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHintonBlewettProductService };
