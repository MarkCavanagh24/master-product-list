// Configuration for Yojin Little Hulton
// Store ID: 6804ed7e609167bd23094bb5
// Location: Little Hulton, M38 9UJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6804ed7e609167bd23094bb5',
    storeName: 'Yojin Little Hulton',
    city: 'Little Hulton',
    postcode: 'M38 9UJ',
...
// Product API Service for Yojin Little Hulton
class YojinLittleHultonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Little Hulton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLittleHultonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLittleHultonProductService };
