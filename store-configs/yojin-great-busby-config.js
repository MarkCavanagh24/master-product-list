// Configuration for Yojin Great Busby
// Store ID: 685541d621bb01b10405e55e
// Location: Great Busby, TS9 7AU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d621bb01b10405e55e',
    storeName: 'Yojin Great Busby',
    city: 'Great Busby',
    postcode: 'TS9 7AU',
...
// Product API Service for Yojin Great Busby
class YojinGreatBusbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Busby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatBusbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatBusbyProductService };
