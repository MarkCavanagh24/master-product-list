// Configuration for Yojin Gressingham
// Store ID: 6855426a21bb01b10405e77d
// Location: Gressingham, LA2 8LP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426a21bb01b10405e77d',
    storeName: 'Yojin Gressingham',
    city: 'Gressingham',
    postcode: 'LA2 8LP',
...
// Product API Service for Yojin Gressingham
class YojinGressinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gressingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGressinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGressinghamProductService };
