// Configuration for Yojin South Ockendon
// Store ID: 685541f221bb01b10405e5c6
// Location: South Ockendon, RM15 6SL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f221bb01b10405e5c6',
    storeName: 'Yojin South Ockendon',
    city: 'South Ockendon',
    postcode: 'RM15 6SL',
...
// Product API Service for Yojin South Ockendon
class YojinSouthOckendonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin South Ockendon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSouthOckendonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSouthOckendonProductService };
