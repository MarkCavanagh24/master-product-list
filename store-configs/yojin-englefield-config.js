// Configuration for Yojin Englefield
// Store ID: 6855424621bb01b10405e6f7
// Location: Englefield, RG7 5JS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424621bb01b10405e6f7',
    storeName: 'Yojin Englefield',
    city: 'Englefield',
    postcode: 'RG7 5JS',
...
// Product API Service for Yojin Englefield
class YojinEnglefieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Englefield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEnglefieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEnglefieldProductService };
