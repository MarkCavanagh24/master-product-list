// Configuration for Yojin Whittingham
// Store ID: 685541b921bb01b10405e4f6
// Location: Whittingham, PR3 2JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b921bb01b10405e4f6',
    storeName: 'Yojin Whittingham',
    city: 'Whittingham',
    postcode: 'PR3 2JB',
...
// Product API Service for Yojin Whittingham
class YojinWhittinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whittingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhittinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhittinghamProductService };
