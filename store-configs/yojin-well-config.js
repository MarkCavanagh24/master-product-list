// Configuration for Yojin Well
// Store ID: 6855422b21bb01b10405e694
// Location: Well, HG4 5JT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422b21bb01b10405e694',
    storeName: 'Yojin Well',
    city: 'Well',
    postcode: 'HG4 5JT',
...
// Product API Service for Yojin Well
class YojinWellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Well:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWellProductService };
