// Configuration for Yojin Little Addington
// Store ID: 6855427621bb01b10405e7a6
// Location: Little Addington, NN14 4BE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427621bb01b10405e7a6',
    storeName: 'Yojin Little Addington',
    city: 'Little Addington',
    postcode: 'NN14 4BE',
...
// Product API Service for Yojin Little Addington
class YojinLittleAddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Little Addington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLittleAddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLittleAddingtonProductService };
