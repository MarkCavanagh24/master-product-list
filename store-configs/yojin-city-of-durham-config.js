// Configuration for Yojin City of Durham
// Store ID: 6855418d21bb01b10405e452
// Location: City of Durham, DH1 4LY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418d21bb01b10405e452',
    storeName: 'Yojin City of Durham',
    city: 'City of Durham',
    postcode: 'DH1 4LY',
...
// Product API Service for Yojin City of Durham
class YojinCityofDurhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin City of Durham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCityofDurhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCityofDurhamProductService };
