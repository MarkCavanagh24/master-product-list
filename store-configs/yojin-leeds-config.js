// Configuration for Yojin Leeds
// Store ID: 6855425221bb01b10405e723
// Location: Leeds, ME17 1XL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425221bb01b10405e723',
    storeName: 'Yojin Leeds',
    city: 'Leeds',
    postcode: 'ME17 1XL',
...
// Product API Service for Yojin Leeds
class YojinLeedsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Leeds:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLeedsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLeedsProductService };
