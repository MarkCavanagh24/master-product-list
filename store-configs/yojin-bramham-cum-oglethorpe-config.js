// Configuration for Yojin Bramham cum Oglethorpe
// Store ID: 685541b721bb01b10405e4ee
// Location: Bramham cum Oglethorpe, LS24 9NR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b721bb01b10405e4ee',
    storeName: 'Yojin Bramham cum Oglethorpe',
    city: 'Bramham cum Oglethorpe',
    postcode: 'LS24 9NR',
...
// Product API Service for Yojin Bramham cum Oglethorpe
class YojinBramhamcumOglethorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bramham cum Oglethorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBramhamcumOglethorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBramhamcumOglethorpeProductService };
