// Configuration for Yojin Nelson
// Store ID: 685541ba21bb01b10405e4f9
// Location: Nelson, BB10 3RJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ba21bb01b10405e4f9',
    storeName: 'Yojin Nelson',
    city: 'Nelson',
    postcode: 'BB10 3RJ',
...
// Product API Service for Yojin Nelson
class YojinNelsonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Nelson:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNelsonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNelsonProductService };
