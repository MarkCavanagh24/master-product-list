// Configuration for Yojin Killerby
// Store ID: 685541ad21bb01b10405e4c9
// Location: Killerby, DL2 3UF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ad21bb01b10405e4c9',
    storeName: 'Yojin Killerby',
    city: 'Killerby',
    postcode: 'DL2 3UF',
...
// Product API Service for Yojin Killerby
class YojinKillerbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Killerby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKillerbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKillerbyProductService };
