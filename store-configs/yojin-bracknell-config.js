// Configuration for Yojin Bracknell
// Store ID: 6855428a21bb01b10405e7ed
// Location: Bracknell, RG12 7LD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428a21bb01b10405e7ed',
    storeName: 'Yojin Bracknell',
    city: 'Bracknell',
    postcode: 'RG12 7LD',
...
// Product API Service for Yojin Bracknell
class YojinBracknellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bracknell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBracknellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBracknellProductService };
