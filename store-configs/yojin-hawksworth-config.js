// Configuration for Yojin Hawksworth
// Store ID: 685541b621bb01b10405e4ea
// Location: Hawksworth, LS20 8JF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b621bb01b10405e4ea',
    storeName: 'Yojin Hawksworth',
    city: 'Hawksworth',
    postcode: 'LS20 8JF',
...
// Product API Service for Yojin Hawksworth
class YojinHawksworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hawksworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHawksworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHawksworthProductService };
