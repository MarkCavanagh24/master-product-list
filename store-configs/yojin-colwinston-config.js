// Configuration for Yojin Colwinston
// Store ID: 685541f321bb01b10405e5c9
// Location: Colwinston, CF35 5AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f321bb01b10405e5c9',
    storeName: 'Yojin Colwinston',
    city: 'Colwinston',
    postcode: 'CF35 5AY',
...
// Product API Service for Yojin Colwinston
class YojinColwinstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Colwinston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinColwinstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinColwinstonProductService };
