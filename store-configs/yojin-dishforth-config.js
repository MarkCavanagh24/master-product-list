// Configuration for Yojin Dishforth
// Store ID: 6855426c21bb01b10405e784
// Location: Dishforth, YO61 2RU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426c21bb01b10405e784',
    storeName: 'Yojin Dishforth',
    city: 'Dishforth',
    postcode: 'YO61 2RU',
...
// Product API Service for Yojin Dishforth
class YojinDishforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dishforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDishforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDishforthProductService };
