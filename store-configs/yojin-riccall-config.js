// Configuration for Yojin Riccall
// Store ID: 685541bd21bb01b10405e503
// Location: Riccall, YO19 6PP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bd21bb01b10405e503',
    storeName: 'Yojin Riccall',
    city: 'Riccall',
    postcode: 'YO19 6PP',
...
// Product API Service for Yojin Riccall
class YojinRiccallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Riccall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRiccallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRiccallProductService };
