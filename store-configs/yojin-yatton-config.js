// Configuration for Yojin Yatton
// Store ID: 6855428421bb01b10405e7d9
// Location: Yatton, BS49 4QN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428421bb01b10405e7d9',
    storeName: 'Yojin Yatton',
    city: 'Yatton',
    postcode: 'BS49 4QN',
...
// Product API Service for Yojin Yatton
class YojinYattonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Yatton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinYattonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinYattonProductService };
