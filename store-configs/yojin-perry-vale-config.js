// Configuration for Yojin Perry Vale
// Store ID: 6855424a21bb01b10405e706
// Location: Perry Vale, SE23 2XA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424a21bb01b10405e706',
    storeName: 'Yojin Perry Vale',
    city: 'Perry Vale',
    postcode: 'SE23 2XA',
...
// Product API Service for Yojin Perry Vale
class YojinPerryValeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Perry Vale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPerryValeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPerryValeProductService };
