// Configuration for Yojin Stoke Bishop
// Store ID: 685541f621bb01b10405e5d2
// Location: Stoke Bishop, BS9 1FE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f621bb01b10405e5d2',
    storeName: 'Yojin Stoke Bishop',
    city: 'Stoke Bishop',
    postcode: 'BS9 1FE',
...
// Product API Service for Yojin Stoke Bishop
class YojinStokeBishopProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stoke Bishop:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStokeBishopProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStokeBishopProductService };
