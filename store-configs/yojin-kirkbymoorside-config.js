// Configuration for Yojin Kirkbymoorside
// Store ID: 6855422821bb01b10405e68a
// Location: Kirkbymoorside, YO62 6DR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422821bb01b10405e68a',
    storeName: 'Yojin Kirkbymoorside',
    city: 'Kirkbymoorside',
    postcode: 'YO62 6DR',
...
// Product API Service for Yojin Kirkbymoorside
class YojinKirkbymoorsideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkbymoorside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkbymoorsideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkbymoorsideProductService };
