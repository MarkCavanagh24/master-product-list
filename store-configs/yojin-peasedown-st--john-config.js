// Configuration for Yojin Peasedown St. John
// Store ID: 685541fb21bb01b10405e5e5
// Location: Peasedown St. John, BA2 8LF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fb21bb01b10405e5e5',
    storeName: 'Yojin Peasedown St. John',
...
// Product API Service for Yojin Peasedown St. John
class YojinPeasedownStJohnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Peasedown St. John:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPeasedownStJohnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPeasedownStJohnProductService };
