// Configuration for Yojin Market Harborough
// Store ID: 6855421d21bb01b10405e65f
// Location: Market Harborough, LE16 9AD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421d21bb01b10405e65f',
    storeName: 'Yojin Market Harborough',
...
// Product API Service for Yojin Market Harborough
class YojinMarketHarboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Market Harborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarketHarboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarketHarboroughProductService };
