// Configuration for Yojin Oval
// Store ID: 6855424021bb01b10405e6e0
// Location: Oval, SW9 6DY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424021bb01b10405e6e0',
    storeName: 'Yojin Oval',
    city: 'Oval',
    postcode: 'SW9 6DY',
...
// Product API Service for Yojin Oval
class YojinOvalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oval:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOvalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOvalProductService };
