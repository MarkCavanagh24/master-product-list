// Configuration for Yojin Huddersfield
// Store ID: 6855425f21bb01b10405e753
// Location: Huddersfield, HD5 9NN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425f21bb01b10405e753',
    storeName: 'Yojin Huddersfield',
    city: 'Huddersfield',
    postcode: 'HD5 9NN',
...
// Product API Service for Yojin Huddersfield
class YojinHuddersfieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Huddersfield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHuddersfieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHuddersfieldProductService };
