// Configuration for Yojin Stourbridge
// Store ID: 6855422321bb01b10405e676
// Location: Stourbridge, DY8 2LL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422321bb01b10405e676',
    storeName: 'Yojin Stourbridge',
    city: 'Stourbridge',
    postcode: 'DY8 2LL',
...
// Product API Service for Yojin Stourbridge
class YojinStourbridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stourbridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStourbridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStourbridgeProductService };
