// Configuration for Yojin Reigate
// Store ID: 6855425821bb01b10405e73a
// Location: Reigate, RH2 8NH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425821bb01b10405e73a',
    storeName: 'Yojin Reigate',
    city: 'Reigate',
    postcode: 'RH2 8NH',
...
// Product API Service for Yojin Reigate
class YojinReigateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Reigate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinReigateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinReigateProductService };
