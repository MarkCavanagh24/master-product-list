// Configuration for Yojin Frosterley
// Store ID: 6855418f21bb01b10405e458
// Location: Frosterley, DL13 2QF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418f21bb01b10405e458',
    storeName: 'Yojin Frosterley',
    city: 'Frosterley',
    postcode: 'DL13 2QF',
...
// Product API Service for Yojin Frosterley
class YojinFrosterleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Frosterley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFrosterleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFrosterleyProductService };
