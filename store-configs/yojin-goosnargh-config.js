// Configuration for Yojin Goosnargh
// Store ID: 685541b921bb01b10405e4f5
// Location: Goosnargh, PR3 2JU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b921bb01b10405e4f5',
    storeName: 'Yojin Goosnargh',
    city: 'Goosnargh',
    postcode: 'PR3 2JU',
...
// Product API Service for Yojin Goosnargh
class YojinGoosnarghProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Goosnargh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGoosnarghProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGoosnarghProductService };
