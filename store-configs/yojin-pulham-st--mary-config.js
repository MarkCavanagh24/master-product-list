// Configuration for Yojin Pulham St. Mary
// Store ID: 685541e721bb01b10405e59f
// Location: Pulham St. Mary, IP21 4XZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e721bb01b10405e59f',
    storeName: 'Yojin Pulham St. Mary',
    city: 'Pulham St. Mary',
    postcode: 'IP21 4XZ',
...
// Product API Service for Yojin Pulham St. Mary
class YojinPulhamStMaryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pulham St. Mary:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPulhamStMaryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPulhamStMaryProductService };
