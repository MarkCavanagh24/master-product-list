// Configuration for Yojin England
// Store ID: 6855423f21bb01b10405e6de
// Location: England, SW13 9PY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423f21bb01b10405e6de',
    storeName: 'Yojin England',
    city: 'England',
    postcode: 'SW13 9PY',
...
// Product API Service for Yojin England
class YojinEnglandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin England:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEnglandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEnglandProductService };
