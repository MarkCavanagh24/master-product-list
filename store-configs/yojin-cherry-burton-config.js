// Configuration for Yojin Cherry Burton
// Store ID: 685541b821bb01b10405e4f1
// Location: Cherry Burton, HU17 7LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b821bb01b10405e4f1',
    storeName: 'Yojin Cherry Burton',
    city: 'Cherry Burton',
    postcode: 'HU17 7LJ',
...
// Product API Service for Yojin Cherry Burton
class YojinCherryBurtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cherry Burton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCherryBurtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCherryBurtonProductService };
