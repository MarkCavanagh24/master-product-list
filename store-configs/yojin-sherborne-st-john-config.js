// Configuration for Yojin Sherborne St John
// Store ID: 685541fe21bb01b10405e5f0
// Location: Sherborne St John, RG26 5HA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fe21bb01b10405e5f0',
    storeName: 'Yojin Sherborne St John',
...
// Product API Service for Yojin Sherborne St John
class YojinSherborneStJohnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sherborne St John:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSherborneStJohnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSherborneStJohnProductService };
