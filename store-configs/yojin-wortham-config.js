// Configuration for Yojin Wortham
// Store ID: 6855427b21bb01b10405e7b8
// Location: Wortham, IP22 1QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427b21bb01b10405e7b8',
    storeName: 'Yojin Wortham',
    city: 'Wortham',
    postcode: 'IP22 1QJ',
...
// Product API Service for Yojin Wortham
class YojinWorthamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wortham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWorthamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWorthamProductService };
