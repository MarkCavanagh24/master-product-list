// Configuration for Yojin Cornsay Colliery
// Store ID: 6855418c21bb01b10405e450
// Location: Cornsay Colliery, DH7 9EZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418c21bb01b10405e450',
    storeName: 'Yojin Cornsay Colliery',
    city: 'Cornsay Colliery',
    postcode: 'DH7 9EZ',
...
// Product API Service for Yojin Cornsay Colliery
class YojinCornsayCollieryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cornsay Colliery:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCornsayCollieryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCornsayCollieryProductService };
