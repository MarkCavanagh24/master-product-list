// Configuration for Yojin Rotherwick
// Store ID: 685541fe21bb01b10405e5f1
// Location: Rotherwick, RG27 9BJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fe21bb01b10405e5f1',
    storeName: 'Yojin Rotherwick',
    city: 'Rotherwick',
    postcode: 'RG27 9BJ',
...
// Product API Service for Yojin Rotherwick
class YojinRotherwickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rotherwick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRotherwickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRotherwickProductService };
