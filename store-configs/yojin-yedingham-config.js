// Configuration for Yojin Yedingham
// Store ID: 6855422d21bb01b10405e69d
// Location: Yedingham, YO18 7PQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422d21bb01b10405e69d',
    storeName: 'Yojin Yedingham',
    city: 'Yedingham',
    postcode: 'YO18 7PQ',
...
// Product API Service for Yojin Yedingham
class YojinYedinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Yedingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinYedinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinYedinghamProductService };
