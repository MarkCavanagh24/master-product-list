// Configuration for Yojin Rillington
// Store ID: 6855426821bb01b10405e775
// Location: Rillington, YO17 8JU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426821bb01b10405e775',
    storeName: 'Yojin Rillington',
    city: 'Rillington',
    postcode: 'YO17 8JU',
...
// Product API Service for Yojin Rillington
class YojinRillingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rillington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRillingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRillingtonProductService };
