// Configuration for Yojin Ingleby Greenhow
// Store ID: 685541d621bb01b10405e55f
// Location: Ingleby Greenhow, TS9 7EZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d621bb01b10405e55f',
    storeName: 'Yojin Ingleby Greenhow',
...
// Product API Service for Yojin Ingleby Greenhow
class YojinInglebyGreenhowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ingleby Greenhow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinInglebyGreenhowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinInglebyGreenhowProductService };
