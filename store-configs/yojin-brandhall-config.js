// Configuration for Yojin Brandhall
// Store ID: 6855421a21bb01b10405e654
// Location: Brandhall, B68 8DR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421a21bb01b10405e654',
    storeName: 'Yojin Brandhall',
    city: 'Brandhall',
    postcode: 'B68 8DR',
...
// Product API Service for Yojin Brandhall
class YojinBrandhallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brandhall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrandhallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrandhallProductService };
