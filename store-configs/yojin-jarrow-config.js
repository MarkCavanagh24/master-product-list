// Configuration for Yojin Jarrow
// Store ID: 6855418221bb01b10405e42c
// Location: Jarrow, NE32 4TY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418221bb01b10405e42c',
    storeName: 'Yojin Jarrow',
    city: 'Jarrow',
    postcode: 'NE32 4TY',
...
// Product API Service for Yojin Jarrow
class YojinJarrowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Jarrow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinJarrowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinJarrowProductService };
