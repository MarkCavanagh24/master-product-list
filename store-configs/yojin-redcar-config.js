// Configuration for Yojin Redcar
// Store ID: 685541ac21bb01b10405e4c2
// Location: Redcar, TS10 5DT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ac21bb01b10405e4c2',
    storeName: 'Yojin Redcar',
    city: 'Redcar',
    postcode: 'TS10 5DT',
...
// Product API Service for Yojin Redcar
class YojinRedcarProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Redcar:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRedcarProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRedcarProductService };
