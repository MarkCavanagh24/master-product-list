// Configuration for Yojin Little Stukeley
// Store ID: 6855427721bb01b10405e7aa
// Location: Little Stukeley, PE28 4HG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427721bb01b10405e7aa',
    storeName: 'Yojin Little Stukeley',
    city: 'Little Stukeley',
    postcode: 'PE28 4HG',
...
// Product API Service for Yojin Little Stukeley
class YojinLittleStukeleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Little Stukeley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLittleStukeleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLittleStukeleyProductService };
