// Configuration for Yojin Farnley
// Store ID: 685541a521bb01b10405e4a9
// Location: Farnley, LS21 1DZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a521bb01b10405e4a9',
    storeName: 'Yojin Farnley',
    city: 'Farnley',
    postcode: 'LS21 1DZ',
...
// Product API Service for Yojin Farnley
class YojinFarnleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Farnley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFarnleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFarnleyProductService };
