// Configuration for Yojin Blucher
// Store ID: 6855417d21bb01b10405e418
// Location: Blucher, NE5 1SP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417d21bb01b10405e418',
    storeName: 'Yojin Blucher',
    city: 'Blucher',
    postcode: 'NE5 1SP',
...
// Product API Service for Yojin Blucher
class YojinBlucherProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blucher:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlucherProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlucherProductService };
