// Configuration for Yojin Cowan Bridge
// Store ID: 6855422f21bb01b10405e6a3
// Location: Cowan Bridge, LA6 2HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422f21bb01b10405e6a3',
    storeName: 'Yojin Cowan Bridge',
    city: 'Cowan Bridge',
    postcode: 'LA6 2HU',
...
// Product API Service for Yojin Cowan Bridge
class YojinCowanBridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cowan Bridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCowanBridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCowanBridgeProductService };
