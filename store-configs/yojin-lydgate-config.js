// Configuration for Yojin Lydgate
// Store ID: 6855420e21bb01b10405e627
// Location: Lydgate, OL14 8SB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420e21bb01b10405e627',
    storeName: 'Yojin Lydgate',
    city: 'Lydgate',
    postcode: 'OL14 8SB',
...
// Product API Service for Yojin Lydgate
class YojinLydgateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lydgate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLydgateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLydgateProductService };
