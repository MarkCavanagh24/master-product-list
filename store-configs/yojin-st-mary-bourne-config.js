// Configuration for Yojin St Mary Bourne
// Store ID: 6855420821bb01b10405e613
// Location: St Mary Bourne, SP11 6DJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420821bb01b10405e613',
    storeName: 'Yojin St Mary Bourne',
    city: 'St Mary Bourne',
    postcode: 'SP11 6DJ',
...
// Product API Service for Yojin St Mary Bourne
class YojinStMaryBourneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin St Mary Bourne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStMaryBourneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStMaryBourneProductService };
