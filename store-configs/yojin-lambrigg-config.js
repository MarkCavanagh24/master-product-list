// Configuration for Yojin Lambrigg
// Store ID: 685541da21bb01b10405e56e
// Location: Lambrigg, LA8 0DH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541da21bb01b10405e56e',
    storeName: 'Yojin Lambrigg',
    city: 'Lambrigg',
    postcode: 'LA8 0DH',
...
// Product API Service for Yojin Lambrigg
class YojinLambriggProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lambrigg:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLambriggProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLambriggProductService };
