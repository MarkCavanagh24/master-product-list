// Configuration for Yojin Scholes
// Store ID: 685541bc21bb01b10405e501
// Location: Scholes, LS14 5BY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bc21bb01b10405e501',
    storeName: 'Yojin Scholes',
    city: 'Scholes',
    postcode: 'LS14 5BY',
...
// Product API Service for Yojin Scholes
class YojinScholesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scholes:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScholesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScholesProductService };
