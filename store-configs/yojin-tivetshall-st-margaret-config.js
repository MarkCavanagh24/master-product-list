// Configuration for Yojin Tivetshall St Margaret
// Store ID: 685541e721bb01b10405e59e
// Location: Tivetshall St Margaret, NR15 2BW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e721bb01b10405e59e',
    storeName: 'Yojin Tivetshall St Margaret',
    city: 'Tivetshall St Margaret',
    postcode: 'NR15 2BW',
...
// Product API Service for Yojin Tivetshall St Margaret
class YojinTivetshallStMargaretProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tivetshall St Margaret:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTivetshallStMargaretProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTivetshallStMargaretProductService };
