// Configuration for Yojin Chaddesley Corbett
// Store ID: 6855423921bb01b10405e6c8
// Location: Chaddesley Corbett, DY10 4QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423921bb01b10405e6c8',
    storeName: 'Yojin Chaddesley Corbett',
    city: 'Chaddesley Corbett',
    postcode: 'DY10 4QT',
...
// Product API Service for Yojin Chaddesley Corbett
class YojinChaddesleyCorbettProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chaddesley Corbett:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChaddesleyCorbettProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChaddesleyCorbettProductService };
