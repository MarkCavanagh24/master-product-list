// Configuration for Yojin Eggleston
// Store ID: 685541a921bb01b10405e4b9
// Location: Eggleston, DL12 0DF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a921bb01b10405e4b9',
    storeName: 'Yojin Eggleston',
    city: 'Eggleston',
    postcode: 'DL12 0DF',
...
// Product API Service for Yojin Eggleston
class YojinEgglestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Eggleston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEgglestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEgglestonProductService };
