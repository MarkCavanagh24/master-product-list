// Configuration for Yojin Heathton
// Store ID: 685541ca21bb01b10405e530
// Location: Heathton, WV5 7AS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ca21bb01b10405e530',
    storeName: 'Yojin Heathton',
    city: 'Heathton',
    postcode: 'WV5 7AS',
...
// Product API Service for Yojin Heathton
class YojinHeathtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heathton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeathtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeathtonProductService };
