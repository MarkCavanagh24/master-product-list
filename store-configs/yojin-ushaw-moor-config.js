// Configuration for Yojin Ushaw Moor
// Store ID: 6855418d21bb01b10405e451
// Location: Ushaw Moor, DH7 7PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418d21bb01b10405e451',
    storeName: 'Yojin Ushaw Moor',
    city: 'Ushaw Moor',
    postcode: 'DH7 7PR',
...
// Product API Service for Yojin Ushaw Moor
class YojinUshawMoorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ushaw Moor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUshawMoorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUshawMoorProductService };
