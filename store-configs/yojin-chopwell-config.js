// Configuration for Yojin Chopwell
// Store ID: 6855418421bb01b10405e435
// Location: Chopwell, NE17 7DN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418421bb01b10405e435',
    storeName: 'Yojin Chopwell',
    city: 'Chopwell',
    postcode: 'NE17 7DN',
...
// Product API Service for Yojin Chopwell
class YojinChopwellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chopwell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChopwellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChopwellProductService };
