// Configuration for Yojin Peatling Magna
// Store ID: 685541ce21bb01b10405e540
// Location: Peatling Magna, LE8 6UJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ce21bb01b10405e540',
    storeName: 'Yojin Peatling Magna',
    city: 'Peatling Magna',
    postcode: 'LE8 6UJ',
...
// Product API Service for Yojin Peatling Magna
class YojinPeatlingMagnaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Peatling Magna:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPeatlingMagnaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPeatlingMagnaProductService };
