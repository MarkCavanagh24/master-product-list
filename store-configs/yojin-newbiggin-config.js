// Configuration for Yojin Newbiggin
// Store ID: 6855419521bb01b10405e46e
// Location: Newbiggin, CA10 1SN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419521bb01b10405e46e',
    storeName: 'Yojin Newbiggin',
    city: 'Newbiggin',
    postcode: 'CA10 1SN',
...
// Product API Service for Yojin Newbiggin
class YojinNewbigginProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newbiggin:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewbigginProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewbigginProductService };
