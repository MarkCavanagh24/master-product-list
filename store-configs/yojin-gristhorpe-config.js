// Configuration for Yojin Gristhorpe
// Store ID: 6855422e21bb01b10405e6a0
// Location: Gristhorpe, YO14 9PY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422e21bb01b10405e6a0',
    storeName: 'Yojin Gristhorpe',
    city: 'Gristhorpe',
    postcode: 'YO14 9PY',
...
// Product API Service for Yojin Gristhorpe
class YojinGristhorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gristhorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGristhorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGristhorpeProductService };
