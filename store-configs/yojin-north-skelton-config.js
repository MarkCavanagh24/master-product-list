// Configuration for Yojin North Skelton
// Store ID: 685541b021bb01b10405e4d3
// Location: North Skelton, TS12 2UR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b021bb01b10405e4d3',
    storeName: 'Yojin North Skelton',
    city: 'North Skelton',
    postcode: 'TS12 2UR',
...
// Product API Service for Yojin North Skelton
class YojinNorthSkeltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Skelton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthSkeltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthSkeltonProductService };
