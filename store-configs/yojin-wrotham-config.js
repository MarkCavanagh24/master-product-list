// Configuration for Yojin Wrotham
// Store ID: 6855420221bb01b10405e5ff
// Location: Wrotham, TN15 7SE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420221bb01b10405e5ff',
    storeName: 'Yojin Wrotham',
    city: 'Wrotham',
    postcode: 'TN15 7SE',
...
// Product API Service for Yojin Wrotham
class YojinWrothamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrotham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWrothamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWrothamProductService };
