// Configuration for Yojin Twywell
// Store ID: 6855423421bb01b10405e6b6
// Location: Twywell, NN14 3AL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423421bb01b10405e6b6',
    storeName: 'Yojin Twywell',
    city: 'Twywell',
    postcode: 'NN14 3AL',
...
// Product API Service for Yojin Twywell
class YojinTwywellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Twywell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTwywellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTwywellProductService };
