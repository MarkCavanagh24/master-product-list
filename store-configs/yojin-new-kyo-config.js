// Configuration for Yojin New Kyo
// Store ID: 6855418721bb01b10405e440
// Location: New Kyo, DH9 8NH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418721bb01b10405e440',
    storeName: 'Yojin New Kyo',
    city: 'New Kyo',
    postcode: 'DH9 8NH',
...
// Product API Service for Yojin New Kyo
class YojinNewKyoProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Kyo:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewKyoProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewKyoProductService };
