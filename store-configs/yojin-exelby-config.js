// Configuration for Yojin Exelby
// Store ID: 6855422421bb01b10405e67b
// Location: Exelby, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422421bb01b10405e67b',
    storeName: 'Yojin Exelby',
    city: 'Exelby',
    postcode: 'N/A',
...
// Product API Service for Yojin Exelby
class YojinExelbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Exelby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinExelbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinExelbyProductService };
