// Configuration for Yojin Stanion
// Store ID: 6855421e21bb01b10405e662
// Location: Stanion, NN14 1FB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421e21bb01b10405e662',
    storeName: 'Yojin Stanion',
    city: 'Stanion',
    postcode: 'NN14 1FB',
...
// Product API Service for Yojin Stanion
class YojinStanionProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stanion:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStanionProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStanionProductService };
