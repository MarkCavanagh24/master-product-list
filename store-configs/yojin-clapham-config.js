// Configuration for Yojin Clapham
// Store ID: 6855426b21bb01b10405e780
// Location: Clapham, LA2 8HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426b21bb01b10405e780',
    storeName: 'Yojin Clapham',
    city: 'Clapham',
    postcode: 'LA2 8HU',
...
// Product API Service for Yojin Clapham
class YojinClaphamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clapham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClaphamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClaphamProductService };
