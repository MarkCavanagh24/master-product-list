// Configuration for Yojin Clevedon
// Store ID: 6855424321bb01b10405e6ec
// Location: Clevedon, BS21 6YF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424321bb01b10405e6ec',
    storeName: 'Yojin Clevedon',
    city: 'Clevedon',
    postcode: 'BS21 6YF',
...
// Product API Service for Yojin Clevedon
class YojinClevedonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clevedon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClevedonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClevedonProductService };
