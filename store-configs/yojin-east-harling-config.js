// Configuration for Yojin East Harling
// Store ID: 685541e621bb01b10405e59a
// Location: East Harling, NR16 2SG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e621bb01b10405e59a',
    storeName: 'Yojin East Harling',
    city: 'East Harling',
    postcode: 'NR16 2SG',
...
// Product API Service for Yojin East Harling
class YojinEastHarlingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Harling:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastHarlingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastHarlingProductService };
