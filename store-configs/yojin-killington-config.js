// Configuration for Yojin Killington
// Store ID: 685541dd21bb01b10405e57a
// Location: Killington, LA8 0BX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dd21bb01b10405e57a',
    storeName: 'Yojin Killington',
    city: 'Killington',
    postcode: 'LA8 0BX',
...
// Product API Service for Yojin Killington
class YojinKillingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Killington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKillingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKillingtonProductService };
