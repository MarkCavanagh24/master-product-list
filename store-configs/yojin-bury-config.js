// Configuration for Yojin Bury
// Store ID: 685541e421bb01b10405e593
// Location: Bury, PE26 1DQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e421bb01b10405e593',
    storeName: 'Yojin Bury',
    city: 'Bury',
    postcode: 'PE26 1DQ',
...
// Product API Service for Yojin Bury
class YojinBuryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBuryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBuryProductService };
