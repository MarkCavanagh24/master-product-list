// Configuration for Yojin Portway
// Store ID: 6855423a21bb01b10405e6cc
// Location: Portway, B48 7HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423a21bb01b10405e6cc',
    storeName: 'Yojin Portway',
    city: 'Portway',
    postcode: 'B48 7HU',
...
// Product API Service for Yojin Portway
class YojinPortwayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Portway:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPortwayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPortwayProductService };
