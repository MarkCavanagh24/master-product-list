// Configuration for Yojin Wykeham
// Store ID: 6855422921bb01b10405e68e
// Location: Wykeham, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422921bb01b10405e68e',
    storeName: 'Yojin Wykeham',
    city: 'Wykeham',
    postcode: 'N/A',
...
// Product API Service for Yojin Wykeham
class YojinWykehamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wykeham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWykehamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWykehamProductService };
