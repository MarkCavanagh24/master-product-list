// Configuration for Yojin Merstham
// Store ID: 6855425021bb01b10405e71b
// Location: Merstham, RH1 3EJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425021bb01b10405e71b',
    storeName: 'Yojin Merstham',
    city: 'Merstham',
    postcode: 'RH1 3EJ',
...
// Product API Service for Yojin Merstham
class YojinMersthamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Merstham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMersthamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMersthamProductService };
