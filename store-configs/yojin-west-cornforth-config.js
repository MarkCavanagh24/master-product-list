// Configuration for Yojin West Cornforth
// Store ID: 6855419321bb01b10405e468
// Location: West Cornforth, DL17 9LR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419321bb01b10405e468',
    storeName: 'Yojin West Cornforth',
    city: 'West Cornforth',
    postcode: 'DL17 9LR',
...
// Product API Service for Yojin West Cornforth
class YojinWestCornforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Cornforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestCornforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestCornforthProductService };
