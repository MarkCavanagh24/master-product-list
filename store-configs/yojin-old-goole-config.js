// Configuration for Yojin Old Goole
// Store ID: 6855425c21bb01b10405e748
// Location: Old Goole, DN14 5RW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425c21bb01b10405e748',
    storeName: 'Yojin Old Goole',
    city: 'Old Goole',
    postcode: 'DN14 5RW',
...
// Product API Service for Yojin Old Goole
class YojinOldGooleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Old Goole:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOldGooleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOldGooleProductService };
