// Configuration for Yojin Easton in Gordano
// Store ID: 685541f521bb01b10405e5d1
// Location: Easton in Gordano, BS20 0JF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f521bb01b10405e5d1',
    storeName: 'Yojin Easton in Gordano',
...
// Product API Service for Yojin Easton in Gordano
class YojinEastoninGordanoProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Easton in Gordano:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastoninGordanoProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastoninGordanoProductService };
