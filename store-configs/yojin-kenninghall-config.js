// Configuration for Yojin Kenninghall
// Store ID: 685541e621bb01b10405e59b
// Location: Kenninghall, NR16 2LH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e621bb01b10405e59b',
    storeName: 'Yojin Kenninghall',
    city: 'Kenninghall',
    postcode: 'NR16 2LH',
...
// Product API Service for Yojin Kenninghall
class YojinKenninghallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kenninghall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKenninghallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKenninghallProductService };
