// Configuration for Yojin Rimington
// Store ID: 685541a321bb01b10405e4a3
// Location: Rimington, BB7 4JL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a321bb01b10405e4a3',
    storeName: 'Yojin Rimington',
    city: 'Rimington',
    postcode: 'BB7 4JL',
...
// Product API Service for Yojin Rimington
class YojinRimingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rimington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRimingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRimingtonProductService };
