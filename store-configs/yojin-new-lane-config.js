// Configuration for Yojin New Lane
// Store ID: 6855426321bb01b10405e760
// Location: New Lane, L40 0RS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426321bb01b10405e760',
    storeName: 'Yojin New Lane',
    city: 'New Lane',
    postcode: 'L40 0RS',
...
// Product API Service for Yojin New Lane
class YojinNewLaneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin New Lane:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewLaneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewLaneProductService };
