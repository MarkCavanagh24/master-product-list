// Configuration for Yojin Norland
// Store ID: 6855421521bb01b10405e641
// Location: Norland, HX6 3QP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421521bb01b10405e641',
    storeName: 'Yojin Norland',
    city: 'Norland',
    postcode: 'HX6 3QP',
...
// Product API Service for Yojin Norland
class YojinNorlandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Norland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorlandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorlandProductService };
