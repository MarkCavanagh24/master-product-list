// Configuration for Yojin Aberford
// Store ID: 685541bd21bb01b10405e502
// Location: Aberford, LS25 3BL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bd21bb01b10405e502',
    storeName: 'Yojin Aberford',
    city: 'Aberford',
    postcode: 'LS25 3BL',
...
// Product API Service for Yojin Aberford
class YojinAberfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Aberford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAberfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAberfordProductService };
