// Configuration for Yojin Cowthorpe
// Store ID: 685541a021bb01b10405e499
// Location: Cowthorpe, LS22 5EU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a021bb01b10405e499',
    storeName: 'Yojin Cowthorpe',
    city: 'Cowthorpe',
    postcode: 'LS22 5EU',
...
// Product API Service for Yojin Cowthorpe
class YojinCowthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cowthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCowthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCowthorpeProductService };
