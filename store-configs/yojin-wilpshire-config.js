// Configuration for Yojin Wilpshire
// Store ID: 685541c021bb01b10405e510
// Location: Wilpshire, BB1 9BJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c021bb01b10405e510',
    storeName: 'Yojin Wilpshire',
    city: 'Wilpshire',
    postcode: 'BB1 9BJ',
...
// Product API Service for Yojin Wilpshire
class YojinWilpshireProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wilpshire:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWilpshireProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWilpshireProductService };
