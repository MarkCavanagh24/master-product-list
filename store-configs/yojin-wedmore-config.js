// Configuration for Yojin Wedmore
// Store ID: 6855425421bb01b10405e729
// Location: Wedmore, BS28 4TP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425421bb01b10405e729',
    storeName: 'Yojin Wedmore',
    city: 'Wedmore',
    postcode: 'BS28 4TP',
...
// Product API Service for Yojin Wedmore
class YojinWedmoreProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wedmore:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWedmoreProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWedmoreProductService };
