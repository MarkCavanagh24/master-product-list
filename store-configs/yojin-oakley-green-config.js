// Configuration for Yojin Oakley Green
// Store ID: 685541f921bb01b10405e5de
// Location: Oakley Green, SL4 5UF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f921bb01b10405e5de',
    storeName: 'Yojin Oakley Green',
    city: 'Oakley Green',
    postcode: 'SL4 5UF',
...
// Product API Service for Yojin Oakley Green
class YojinOakleyGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oakley Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOakleyGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOakleyGreenProductService };
