// Configuration for Yojin Pontefract
// Store ID: 6855425b21bb01b10405e743
// Location: Pontefract, WF8 4QE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425b21bb01b10405e743',
    storeName: 'Yojin Pontefract',
    city: 'Pontefract',
    postcode: 'WF8 4QE',
...
// Product API Service for Yojin Pontefract
class YojinPontefractProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pontefract:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPontefractProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPontefractProductService };
