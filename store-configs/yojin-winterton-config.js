// Configuration for Yojin Winterton
// Store ID: 6855426121bb01b10405e75b
// Location: Winterton, DN15 9UX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426121bb01b10405e75b',
    storeName: 'Yojin Winterton',
    city: 'Winterton',
    postcode: 'DN15 9UX',
...
// Product API Service for Yojin Winterton
class YojinWintertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Winterton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWintertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWintertonProductService };
