// Configuration for Yojin Sturry
// Store ID: 6855420421bb01b10405e606
// Location: Sturry, CT2 0PY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420421bb01b10405e606',
    storeName: 'Yojin Sturry',
    city: 'Sturry',
    postcode: 'CT2 0PY',
...
// Product API Service for Yojin Sturry
class YojinSturryProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sturry:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSturryProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSturryProductService };
