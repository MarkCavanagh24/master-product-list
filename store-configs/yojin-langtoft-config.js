// Configuration for Yojin Langtoft
// Store ID: 6855427321bb01b10405e79c
// Location: Langtoft, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427321bb01b10405e79c',
    storeName: 'Yojin Langtoft',
    city: 'Langtoft',
    postcode: 'N/A',
...
// Product API Service for Yojin Langtoft
class YojinLangtoftProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Langtoft:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLangtoftProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLangtoftProductService };
