// Configuration for Yojin Alburgh
// Store ID: 685541e821bb01b10405e5a0
// Location: Alburgh, IP20 0BY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e821bb01b10405e5a0',
    storeName: 'Yojin Alburgh',
    city: 'Alburgh',
    postcode: 'IP20 0BY',
...
// Product API Service for Yojin Alburgh
class YojinAlburghProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Alburgh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAlburghProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAlburghProductService };
