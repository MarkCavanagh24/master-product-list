// Configuration for Yojin Wolvey CP
// Store ID: 6855421c21bb01b10405e65c
// Location: Wolvey CP, LE10 3LL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421c21bb01b10405e65c',
    storeName: 'Yojin Wolvey CP',
    city: 'Wolvey CP',
    postcode: 'LE10 3LL',
...
// Product API Service for Yojin Wolvey CP
class YojinWolveyCPProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wolvey CP:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWolveyCPProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWolveyCPProductService };
