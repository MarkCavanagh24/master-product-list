// Configuration for Yojin Hounslow West
// Store ID: 6855423f21bb01b10405e6dc
// Location: Hounslow West, TW5 9EQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423f21bb01b10405e6dc',
    storeName: 'Yojin Hounslow West',
    city: 'Hounslow West',
    postcode: 'TW5 9EQ',
...
// Product API Service for Yojin Hounslow West
class YojinHounslowWestProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hounslow West:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHounslowWestProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHounslowWestProductService };
