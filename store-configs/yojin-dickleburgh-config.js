// Configuration for Yojin Dickleburgh
// Store ID: 6855423721bb01b10405e6c2
// Location: Dickleburgh, IP21 4PJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423721bb01b10405e6c2',
    storeName: 'Yojin Dickleburgh',
    city: 'Dickleburgh',
    postcode: 'IP21 4PJ',
...
// Product API Service for Yojin Dickleburgh
class YojinDickleburghProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dickleburgh:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDickleburghProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDickleburghProductService };
