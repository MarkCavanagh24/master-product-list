// Configuration for Yojin Barton
// Store ID: 685541d121bb01b10405e54c
// Location: Barton, DL10 6LP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d121bb01b10405e54c',
    storeName: 'Yojin Barton',
    city: 'Barton',
    postcode: 'DL10 6LP',
...
// Product API Service for Yojin Barton
class YojinBartonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Barton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBartonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBartonProductService };
