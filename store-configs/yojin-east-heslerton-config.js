// Configuration for Yojin East Heslerton
// Store ID: 6855426921bb01b10405e777
// Location: East Heslerton, YO17 8RW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426921bb01b10405e777',
    storeName: 'Yojin East Heslerton',
    city: 'East Heslerton',
    postcode: 'YO17 8RW',
...
// Product API Service for Yojin East Heslerton
class YojinEastHeslertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Heslerton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastHeslertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastHeslertonProductService };
