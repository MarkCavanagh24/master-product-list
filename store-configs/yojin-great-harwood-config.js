// Configuration for Yojin Great Harwood
// Store ID: 685541c121bb01b10405e511
// Location: Great Harwood, BB6 7AF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c121bb01b10405e511',
    storeName: 'Yojin Great Harwood',
    city: 'Great Harwood',
    postcode: 'BB6 7AF',
...
// Product API Service for Yojin Great Harwood
class YojinGreatHarwoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Harwood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatHarwoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatHarwoodProductService };
