// Configuration for Yojin Notton
// Store ID: 6855426621bb01b10405e76e
// Location: Notton, WF4 2NH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426621bb01b10405e76e',
    storeName: 'Yojin Notton',
    city: 'Notton',
    postcode: 'WF4 2NH',
...
// Product API Service for Yojin Notton
class YojinNottonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Notton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNottonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNottonProductService };
