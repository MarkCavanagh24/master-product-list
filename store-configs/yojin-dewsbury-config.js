// Configuration for Yojin Dewsbury
// Store ID: 6855421621bb01b10405e645
// Location: Dewsbury, WF12 7LR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421621bb01b10405e645',
    storeName: 'Yojin Dewsbury',
    city: 'Dewsbury',
    postcode: 'WF12 7LR',
...
// Product API Service for Yojin Dewsbury
class YojinDewsburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dewsbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDewsburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDewsburyProductService };
