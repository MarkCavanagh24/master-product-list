// Configuration for Yojin Skelton
// Store ID: 6855419e21bb01b10405e48f
// Location: Skelton, YO30 1YG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419e21bb01b10405e48f',
    storeName: 'Yojin Skelton',
    city: 'Skelton',
    postcode: 'YO30 1YG',
...
// Product API Service for Yojin Skelton
class YojinSkeltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skelton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkeltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkeltonProductService };
