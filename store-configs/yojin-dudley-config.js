// Configuration for Yojin Dudley
// Store ID: 685541ca21bb01b10405e532
// Location: Dudley, DY3 3EP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ca21bb01b10405e532',
    storeName: 'Yojin Dudley',
    city: 'Dudley',
    postcode: 'DY3 3EP',
...
// Product API Service for Yojin Dudley
class YojinDudleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dudley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDudleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDudleyProductService };
