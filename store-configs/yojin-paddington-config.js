// Configuration for Yojin Paddington
// Store ID: 685541f021bb01b10405e5bf
// Location: Paddington, W2 1DE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f021bb01b10405e5bf',
    storeName: 'Yojin Paddington',
    city: 'Paddington',
    postcode: 'W2 1DE',
...
// Product API Service for Yojin Paddington
class YojinPaddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Paddington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPaddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPaddingtonProductService };
