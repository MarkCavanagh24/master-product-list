// Configuration for Yojin Hales
// Store ID: 6855421821bb01b10405e64e
// Location: Hales, NR14 6TB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421821bb01b10405e64e',
    storeName: 'Yojin Hales',
    city: 'Hales',
    postcode: 'NR14 6TB',
...
// Product API Service for Yojin Hales
class YojinHalesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hales:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHalesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHalesProductService };
