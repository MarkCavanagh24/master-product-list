// Configuration for Yojin Burston
// Store ID: 6855423721bb01b10405e6c1
// Location: Burston, IP22 5SR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423721bb01b10405e6c1',
    storeName: 'Yojin Burston',
    city: 'Burston',
    postcode: 'IP22 5SR',
...
// Product API Service for Yojin Burston
class YojinBurstonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurstonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurstonProductService };
