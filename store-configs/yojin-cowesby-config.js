// Configuration for Yojin Cowesby
// Store ID: 6855422521bb01b10405e67e
// Location: Cowesby, YO7 2JL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422521bb01b10405e67e',
    storeName: 'Yojin Cowesby',
    city: 'Cowesby',
    postcode: 'YO7 2JL',
...
// Product API Service for Yojin Cowesby
class YojinCowesbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cowesby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCowesbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCowesbyProductService };
