// Configuration for Yojin North Meols
// Store ID: 6855425d21bb01b10405e74c
// Location: North Meols, PR9 8AF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425d21bb01b10405e74c',
    storeName: 'Yojin North Meols',
    city: 'North Meols',
    postcode: 'PR9 8AF',
...
// Product API Service for Yojin North Meols
class YojinNorthMeolsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Meols:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthMeolsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthMeolsProductService };
