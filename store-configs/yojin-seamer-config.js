// Configuration for Yojin Seamer
// Store ID: 6855422e21bb01b10405e69f
// Location: Seamer, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422e21bb01b10405e69f',
    storeName: 'Yojin Seamer',
    city: 'Seamer',
    postcode: 'N/A',
...
// Product API Service for Yojin Seamer
class YojinSeamerProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Seamer:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSeamerProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSeamerProductService };
