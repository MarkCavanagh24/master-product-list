// Configuration for Yojin Paulton
// Store ID: 685541fb21bb01b10405e5e4
// Location: Paulton, BS39 7LT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fb21bb01b10405e5e4',
    storeName: 'Yojin Paulton',
    city: 'Paulton',
    postcode: 'BS39 7LT',
...
// Product API Service for Yojin Paulton
class YojinPaultonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Paulton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPaultonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPaultonProductService };
