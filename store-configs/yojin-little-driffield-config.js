// Configuration for Yojin Little Driffield
// Store ID: 6855419f21bb01b10405e492
// Location: Little Driffield, YO25 9GG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419f21bb01b10405e492',
    storeName: 'Yojin Little Driffield',
    city: 'Little Driffield',
    postcode: 'YO25 9GG',
...
// Product API Service for Yojin Little Driffield
class YojinLittleDriffieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Little Driffield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLittleDriffieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLittleDriffieldProductService };
