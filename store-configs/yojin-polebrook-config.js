// Configuration for Yojin Polebrook
// Store ID: 6855421e21bb01b10405e665
// Location: Polebrook, PE8 5LQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421e21bb01b10405e665',
    storeName: 'Yojin Polebrook',
    city: 'Polebrook',
    postcode: 'PE8 5LQ',
...
// Product API Service for Yojin Polebrook
class YojinPolebrookProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Polebrook:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPolebrookProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPolebrookProductService };
