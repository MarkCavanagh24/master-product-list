// Configuration for Yojin West Rounton
// Store ID: 685541d521bb01b10405e55c
// Location: West Rounton, DL6 2LU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d521bb01b10405e55c',
    storeName: 'Yojin West Rounton',
    city: 'West Rounton',
    postcode: 'DL6 2LU',
...
// Product API Service for Yojin West Rounton
class YojinWestRountonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin West Rounton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWestRountonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWestRountonProductService };
