// Configuration for Yojin Thrandeston
// Store ID: 6855427b21bb01b10405e7b9
// Location: Thrandeston, IP21 4BP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427b21bb01b10405e7b9',
    storeName: 'Yojin Thrandeston',
    city: 'Thrandeston',
    postcode: 'IP21 4BP',
...
// Product API Service for Yojin Thrandeston
class YojinThrandestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thrandeston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThrandestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThrandestonProductService };
