// Configuration for Yojin Topcliffe
// Store ID: 6855422c21bb01b10405e697
// Location: Topcliffe, YO7 4NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422c21bb01b10405e697',
    storeName: 'Yojin Topcliffe',
    city: 'Topcliffe',
    postcode: 'YO7 4NJ',
...
// Product API Service for Yojin Topcliffe
class YojinTopcliffeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Topcliffe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTopcliffeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTopcliffeProductService };
