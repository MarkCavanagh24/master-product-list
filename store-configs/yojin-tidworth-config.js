// Configuration for Yojin Tidworth
// Store ID: 6855425621bb01b10405e731
// Location: Tidworth, SP9 7AQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425621bb01b10405e731',
    storeName: 'Yojin Tidworth',
    city: 'Tidworth',
    postcode: 'SP9 7AQ',
...
// Product API Service for Yojin Tidworth
class YojinTidworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tidworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTidworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTidworthProductService };
