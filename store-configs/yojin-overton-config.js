// Configuration for Yojin Overton
// Store ID: 6855425f21bb01b10405e754
// Location: Overton, WF12 0QE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425f21bb01b10405e754',
    storeName: 'Yojin Overton',
    city: 'Overton',
    postcode: 'WF12 0QE',
...
// Product API Service for Yojin Overton
class YojinOvertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Overton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOvertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOvertonProductService };
