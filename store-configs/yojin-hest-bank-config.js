// Configuration for Yojin Hest Bank
// Store ID: 6855427021bb01b10405e790
// Location: Hest Bank, LA2 6BY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427021bb01b10405e790',
    storeName: 'Yojin Hest Bank',
    city: 'Hest Bank',
    postcode: 'LA2 6BY',
...
// Product API Service for Yojin Hest Bank
class YojinHestBankProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hest Bank:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHestBankProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHestBankProductService };
