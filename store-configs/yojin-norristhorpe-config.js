// Configuration for Yojin Norristhorpe
// Store ID: 6855421621bb01b10405e644
// Location: Norristhorpe, WF15 7AW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421621bb01b10405e644',
    storeName: 'Yojin Norristhorpe',
    city: 'Norristhorpe',
    postcode: 'WF15 7AW',
...
// Product API Service for Yojin Norristhorpe
class YojinNorristhorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Norristhorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorristhorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorristhorpeProductService };
