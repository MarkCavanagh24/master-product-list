// Configuration for Yojin South Hiendley
// Store ID: 6855426721bb01b10405e76f
// Location: South Hiendley, S72 9DR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426721bb01b10405e76f',
    storeName: 'Yojin South Hiendley',
    city: 'South Hiendley',
    postcode: 'S72 9DR',
...
// Product API Service for Yojin South Hiendley
class YojinSouthHiendleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin South Hiendley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSouthHiendleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSouthHiendleyProductService };
