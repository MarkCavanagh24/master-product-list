// Configuration for Yojin Salfords
// Store ID: 6855425821bb01b10405e73b
// Location: Salfords, RH1 5LE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425821bb01b10405e73b',
    storeName: 'Yojin Salfords',
    city: 'Salfords',
    postcode: 'RH1 5LE',
...
// Product API Service for Yojin Salfords
class YojinSalfordsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Salfords:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSalfordsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSalfordsProductService };
