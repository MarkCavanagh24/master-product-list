// Configuration for Yojin Linton-on-Ouse
// Store ID: 6855419b21bb01b10405e486
// Location: Linton-on-Ouse, YO30 2AH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419b21bb01b10405e486',
    storeName: 'Yojin Linton-on-Ouse',
    city: 'Linton-on-Ouse',
    postcode: 'YO30 2AH',
...
// Product API Service for Yojin Linton-on-Ouse
class YojinLintononOuseProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Linton-on-Ouse:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLintononOuseProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLintononOuseProductService };
