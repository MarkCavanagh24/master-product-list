// Configuration for Yojin Fountainhead
// Store ID: 6855420e21bb01b10405e629
// Location: Fountainhead, HX3 5AE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420e21bb01b10405e629',
    storeName: 'Yojin Fountainhead',
    city: 'Fountainhead',
    postcode: 'HX3 5AE',
...
// Product API Service for Yojin Fountainhead
class YojinFountainheadProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fountainhead:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFountainheadProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFountainheadProductService };
