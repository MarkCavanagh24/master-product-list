// Configuration for Yojin Kidderminster Foreign
// Store ID: 685541e921bb01b10405e5a5
// Location: Kidderminster Foreign, DY12 1BF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e921bb01b10405e5a5',
    storeName: 'Yojin Kidderminster Foreign',
    city: 'Kidderminster Foreign',
    postcode: 'DY12 1BF',
...
// Product API Service for Yojin Kidderminster Foreign
class YojinKidderminsterForeignProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kidderminster Foreign:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKidderminsterForeignProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKidderminsterForeignProductService };
