// Configuration for Yojin Hurley
// Store ID: 685541ee21bb01b10405e5b6
// Location: Hurley, SL6 6RE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ee21bb01b10405e5b6',
    storeName: 'Yojin Hurley',
    city: 'Hurley',
    postcode: 'SL6 6RE',
...
// Product API Service for Yojin Hurley
class YojinHurleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hurley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHurleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHurleyProductService };
