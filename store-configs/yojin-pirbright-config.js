// Configuration for Yojin Pirbright
// Store ID: 685541ff21bb01b10405e5f4
// Location: Pirbright, GU16 6FJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ff21bb01b10405e5f4',
    storeName: 'Yojin Pirbright',
    city: 'Pirbright',
    postcode: 'GU16 6FJ',
...
// Product API Service for Yojin Pirbright
class YojinPirbrightProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pirbright:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPirbrightProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPirbrightProductService };
