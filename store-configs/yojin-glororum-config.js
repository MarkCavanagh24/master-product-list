// Configuration for Yojin Glororum
// Store ID: 6855419821bb01b10405e479
// Location: Glororum, NE61 6DN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419821bb01b10405e479',
    storeName: 'Yojin Glororum',
    city: 'Glororum',
    postcode: 'NE61 6DN',
...
// Product API Service for Yojin Glororum
class YojinGlororumProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Glororum:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGlororumProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGlororumProductService };
