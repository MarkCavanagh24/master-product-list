// Configuration for Yojin Fryton
// Store ID: 6855426821bb01b10405e772
// Location: Fryton, YO62 4AT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426821bb01b10405e772',
    storeName: 'Yojin Fryton',
    city: 'Fryton',
    postcode: 'YO62 4AT',
...
// Product API Service for Yojin Fryton
class YojinFrytonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fryton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFrytonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFrytonProductService };
