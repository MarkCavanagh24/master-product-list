// Configuration for Yojin Corsley
// Store ID: 6855425521bb01b10405e72f
// Location: Corsley, BA12 7QQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425521bb01b10405e72f',
    storeName: 'Yojin Corsley',
    city: 'Corsley',
    postcode: 'BA12 7QQ',
...
// Product API Service for Yojin Corsley
class YojinCorsleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Corsley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCorsleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCorsleyProductService };
