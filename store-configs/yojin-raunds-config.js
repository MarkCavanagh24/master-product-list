// Configuration for Yojin Raunds
// Store ID: 6855427621bb01b10405e7a7
// Location: Raunds, NN9 6GJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427621bb01b10405e7a7',
    storeName: 'Yojin Raunds',
    city: 'Raunds',
    postcode: 'NN9 6GJ',
...
// Product API Service for Yojin Raunds
class YojinRaundsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Raunds:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRaundsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRaundsProductService };
