// Configuration for Yojin Gallowstree Common
// Store ID: 685541ed21bb01b10405e5b3
// Location: Gallowstree Common, RG4 9HS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ed21bb01b10405e5b3',
    storeName: 'Yojin Gallowstree Common',
    city: 'Gallowstree Common',
    postcode: 'RG4 9HS',
...
// Product API Service for Yojin Gallowstree Common
class YojinGallowstreeCommonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gallowstree Common:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGallowstreeCommonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGallowstreeCommonProductService };
