// Configuration for Yojin Wrangbrook
// Store ID: 6855426721bb01b10405e771
// Location: Wrangbrook, WF9 1LW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426721bb01b10405e771',
    storeName: 'Yojin Wrangbrook',
    city: 'Wrangbrook',
    postcode: 'WF9 1LW',
...
// Product API Service for Yojin Wrangbrook
class YojinWrangbrookProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrangbrook:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWrangbrookProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWrangbrookProductService };
