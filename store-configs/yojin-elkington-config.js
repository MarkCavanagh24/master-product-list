// Configuration for Yojin Elkington
// Store ID: 6855423221bb01b10405e6af
// Location: Elkington, NN6 6HG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423221bb01b10405e6af',
    storeName: 'Yojin Elkington',
    city: 'Elkington',
    postcode: 'NN6 6HG',
...
// Product API Service for Yojin Elkington
class YojinElkingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Elkington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinElkingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinElkingtonProductService };
