// Configuration for Yojin Wrelton
// Store ID: 6855422921bb01b10405e68b
// Location: Wrelton, YO18 8HF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422921bb01b10405e68b',
    storeName: 'Yojin Wrelton',
    city: 'Wrelton',
    postcode: 'YO18 8HF',
...
// Product API Service for Yojin Wrelton
class YojinWreltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wrelton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWreltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWreltonProductService };
