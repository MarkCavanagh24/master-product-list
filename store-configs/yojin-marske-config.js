// Configuration for Yojin Marske
// Store ID: 685541d721bb01b10405e564
// Location: Marske, DL11 7LG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d721bb01b10405e564',
    storeName: 'Yojin Marske',
    city: 'Marske',
    postcode: 'DL11 7LG',
...
// Product API Service for Yojin Marske
class YojinMarskeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Marske:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarskeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarskeProductService };
