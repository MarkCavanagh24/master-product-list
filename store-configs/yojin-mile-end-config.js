// Configuration for Yojin Mile End
// Store ID: 685541f121bb01b10405e5c1
// Location: Mile End, E3 4SE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f121bb01b10405e5c1',
    storeName: 'Yojin Mile End',
    city: 'Mile End',
    postcode: 'E3 4SE',
...
// Product API Service for Yojin Mile End
class YojinMileEndProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mile End:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMileEndProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMileEndProductService };
