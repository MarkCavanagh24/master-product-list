// Configuration for Yojin Blean
// Store ID: 6855420421bb01b10405e605
// Location: Blean, CT2 9EU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420421bb01b10405e605',
    storeName: 'Yojin Blean',
    city: 'Blean',
    postcode: 'CT2 9EU',
...
// Product API Service for Yojin Blean
class YojinBleanProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blean:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBleanProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBleanProductService };
