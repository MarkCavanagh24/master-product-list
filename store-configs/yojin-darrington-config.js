// Configuration for Yojin Darrington
// Store ID: 6855426121bb01b10405e759
// Location: Darrington, WF8 3HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426121bb01b10405e759',
    storeName: 'Yojin Darrington',
    city: 'Darrington',
    postcode: 'WF8 3HZ',
...
// Product API Service for Yojin Darrington
class YojinDarringtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Darrington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDarringtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDarringtonProductService };
