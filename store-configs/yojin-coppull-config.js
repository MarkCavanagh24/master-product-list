// Configuration for Yojin Coppull
// Store ID: 6855426321bb01b10405e763
// Location: Coppull, PR7 4BJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426321bb01b10405e763',
    storeName: 'Yojin Coppull',
    city: 'Coppull',
    postcode: 'PR7 4BJ',
...
// Product API Service for Yojin Coppull
class YojinCoppullProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Coppull:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCoppullProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCoppullProductService };
