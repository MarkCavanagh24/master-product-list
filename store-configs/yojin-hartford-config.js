// Configuration for Yojin Hartford
// Store ID: 6855427721bb01b10405e7ab
// Location: Hartford, PE29 1PT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427721bb01b10405e7ab',
    storeName: 'Yojin Hartford',
    city: 'Hartford',
    postcode: 'PE29 1PT',
...
// Product API Service for Yojin Hartford
class YojinHartfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hartford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHartfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHartfordProductService };
