// Configuration for Yojin Windsor
// Store ID: 685541f921bb01b10405e5df
// Location: Windsor, SL4 2JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f921bb01b10405e5df',
    storeName: 'Yojin Windsor',
    city: 'Windsor',
    postcode: 'SL4 2JG',
...
// Product API Service for Yojin Windsor
class YojinWindsorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Windsor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWindsorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWindsorProductService };
