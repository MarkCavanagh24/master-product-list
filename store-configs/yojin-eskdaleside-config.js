// Configuration for Yojin Eskdaleside
// Store ID: 685541d621bb01b10405e560
// Location: Eskdaleside, YO22 5EX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d621bb01b10405e560',
    storeName: 'Yojin Eskdaleside',
    city: 'Eskdaleside',
    postcode: 'YO22 5EX',
...
// Product API Service for Yojin Eskdaleside
class YojinEskdalesideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Eskdaleside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEskdalesideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEskdalesideProductService };
