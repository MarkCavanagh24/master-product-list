// Configuration for Yojin Sutton
// Store ID: 6855423621bb01b10405e6bc
// Location: Sutton, CB6 2PX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423621bb01b10405e6bc',
    storeName: 'Yojin Sutton',
    city: 'Sutton',
    postcode: 'CB6 2PX',
...
// Product API Service for Yojin Sutton
class YojinSuttonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sutton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSuttonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSuttonProductService };
