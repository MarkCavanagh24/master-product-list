// Configuration for Yojin Withersdale Street
// Store ID: 6855423821bb01b10405e6c4
// Location: Withersdale Street, IP20 0JB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423821bb01b10405e6c4',
    storeName: 'Yojin Withersdale Street',
    city: 'Withersdale Street',
    postcode: 'IP20 0JB',
...
// Product API Service for Yojin Withersdale Street
class YojinWithersdaleStreetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Withersdale Street:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWithersdaleStreetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWithersdaleStreetProductService };
