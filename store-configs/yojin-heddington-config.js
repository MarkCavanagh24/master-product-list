// Configuration for Yojin Heddington
// Store ID: 6855428721bb01b10405e7e4
// Location: Heddington, SN11 0PG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428721bb01b10405e7e4',
    storeName: 'Yojin Heddington',
    city: 'Heddington',
    postcode: 'SN11 0PG',
...
// Product API Service for Yojin Heddington
class YojinHeddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heddington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeddingtonProductService };
