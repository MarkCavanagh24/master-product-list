// Configuration for Yojin Gledhow
// Store ID: 685541bc21bb01b10405e500
// Location: Gledhow, LS8 4DD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bc21bb01b10405e500',
    storeName: 'Yojin Gledhow',
    city: 'Gledhow',
    postcode: 'LS8 4DD',
...
// Product API Service for Yojin Gledhow
class YojinGledhowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gledhow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGledhowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGledhowProductService };
