// Configuration for Yojin Skipton
// Store ID: 6855419f21bb01b10405e494
// Location: Skipton, BD23 2EQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419f21bb01b10405e494',
    storeName: 'Yojin Skipton',
    city: 'Skipton',
    postcode: 'BD23 2EQ',
...
// Product API Service for Yojin Skipton
class YojinSkiptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skipton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkiptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkiptonProductService };
