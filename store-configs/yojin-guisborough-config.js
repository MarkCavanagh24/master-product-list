// Configuration for Yojin Guisborough
// Store ID: 685541b421bb01b10405e4e2
// Location: Guisborough, TS14 7DA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b421bb01b10405e4e2',
    storeName: 'Yojin Guisborough',
    city: 'Guisborough',
    postcode: 'TS14 7DA',
...
// Product API Service for Yojin Guisborough
class YojinGuisboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Guisborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGuisboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGuisboroughProductService };
