// Configuration for Yojin Millington
// Store ID: 685541a221bb01b10405e49f
// Location: Millington, YO42 1SL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a221bb01b10405e49f',
    storeName: 'Yojin Millington',
    city: 'Millington',
    postcode: 'YO42 1SL',
...
// Product API Service for Yojin Millington
class YojinMillingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Millington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMillingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMillingtonProductService };
