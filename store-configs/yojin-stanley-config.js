// Configuration for Yojin Stanley
// Store ID: 6855425a21bb01b10405e741
// Location: Stanley, WF3 4LU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425a21bb01b10405e741',
    storeName: 'Yojin Stanley',
    city: 'Stanley',
    postcode: 'WF3 4LU',
...
// Product API Service for Yojin Stanley
class YojinStanleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stanley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStanleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStanleyProductService };
