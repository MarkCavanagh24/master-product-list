// Configuration for Yojin Lanchester
// Store ID: 6855418a21bb01b10405e448
// Location: Lanchester, DH7 0NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418a21bb01b10405e448',
    storeName: 'Yojin Lanchester',
    city: 'Lanchester',
    postcode: 'DH7 0NJ',
...
// Product API Service for Yojin Lanchester
class YojinLanchesterProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lanchester:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLanchesterProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLanchesterProductService };
