// Configuration for Yojin Whitley
// Store ID: 6855425b21bb01b10405e745
// Location: Whitley, WF11 8FG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425b21bb01b10405e745',
    storeName: 'Yojin Whitley',
    city: 'Whitley',
    postcode: 'WF11 8FG',
...
// Product API Service for Yojin Whitley
class YojinWhitleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whitley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhitleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhitleyProductService };
