// Configuration for Yojin Bagby
// Store ID: 6855422c21bb01b10405e698
// Location: Bagby, YO7 3AE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422c21bb01b10405e698',
    storeName: 'Yojin Bagby',
    city: 'Bagby',
    postcode: 'YO7 3AE',
...
// Product API Service for Yojin Bagby
class YojinBagbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bagby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBagbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBagbyProductService };
