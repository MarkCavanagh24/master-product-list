// Configuration for Yojin Acomb
// Store ID: 685541a121bb01b10405e49b
// Location: Acomb, YO24 4LH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a121bb01b10405e49b',
    storeName: 'Yojin Acomb',
    city: 'Acomb',
    postcode: 'YO24 4LH',
...
// Product API Service for Yojin Acomb
class YojinAcombProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Acomb:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAcombProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAcombProductService };
