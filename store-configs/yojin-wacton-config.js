// Configuration for Yojin Wacton
// Store ID: 6855422221bb01b10405e671
// Location: Wacton, NR15 2UN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422221bb01b10405e671',
    storeName: 'Yojin Wacton',
    city: 'Wacton',
    postcode: 'NR15 2UN',
...
// Product API Service for Yojin Wacton
class YojinWactonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wacton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWactonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWactonProductService };
