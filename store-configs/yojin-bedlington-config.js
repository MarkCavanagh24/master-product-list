// Configuration for Yojin Bedlington
// Store ID: 6855419821bb01b10405e47a
// Location: Bedlington, NE22 6DX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419821bb01b10405e47a',
    storeName: 'Yojin Bedlington',
    city: 'Bedlington',
    postcode: 'NE22 6DX',
...
// Product API Service for Yojin Bedlington
class YojinBedlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bedlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBedlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBedlingtonProductService };
