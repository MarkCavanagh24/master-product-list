// Configuration for Yojin Burston and Shimpling
// Store ID: 685541e721bb01b10405e59d
// Location: Burston and Shimpling, NR16 1PB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e721bb01b10405e59d',
    storeName: 'Yojin Burston and Shimpling',
    city: 'Burston and Shimpling',
    postcode: 'NR16 1PB',
...
// Product API Service for Yojin Burston and Shimpling
class YojinBurstonandShimplingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burston and Shimpling:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurstonandShimplingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurstonandShimplingProductService };
