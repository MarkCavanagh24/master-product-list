// Configuration for Yojin Wensley
// Store ID: 685541de21bb01b10405e57c
// Location: Wensley, DL8 4JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541de21bb01b10405e57c',
    storeName: 'Yojin Wensley',
    city: 'Wensley',
    postcode: 'DL8 4JD',
...
// Product API Service for Yojin Wensley
class YojinWensleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wensley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWensleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWensleyProductService };
