// Configuration for Yojin Harome
// Store ID: 6855422d21bb01b10405e69a
// Location: Harome, YO62 5JQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422d21bb01b10405e69a',
    storeName: 'Yojin Harome',
    city: 'Harome',
    postcode: 'YO62 5JQ',
...
// Product API Service for Yojin Harome
class YojinHaromeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harome:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaromeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaromeProductService };
