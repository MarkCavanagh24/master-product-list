// Configuration for Yojin Whalley
// Store ID: 685541ba21bb01b10405e4f7
// Location: Whalley, BB7 9XH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ba21bb01b10405e4f7',
    storeName: 'Yojin Whalley',
    city: 'Whalley',
    postcode: 'BB7 9XH',
...
// Product API Service for Yojin Whalley
class YojinWhalleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whalley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhalleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhalleyProductService };
