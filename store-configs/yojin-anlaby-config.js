// Configuration for Yojin Anlaby
// Store ID: 6855421221bb01b10405e635
// Location: Anlaby, HU10 7ER

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421221bb01b10405e635',
    storeName: 'Yojin Anlaby',
    city: 'Anlaby',
    postcode: 'HU10 7ER',
...
// Product API Service for Yojin Anlaby
class YojinAnlabyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Anlaby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAnlabyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAnlabyProductService };
