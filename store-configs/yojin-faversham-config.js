// Configuration for Yojin Faversham
// Store ID: 6855420421bb01b10405e604
// Location: Faversham, ME13 8XF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420421bb01b10405e604',
    storeName: 'Yojin Faversham',
    city: 'Faversham',
    postcode: 'ME13 8XF',
...
// Product API Service for Yojin Faversham
class YojinFavershamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Faversham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFavershamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFavershamProductService };
