// Configuration for Yojin Gravelly Hill
// Store ID: 685541cb21bb01b10405e536
// Location: Gravelly Hill, B23 6GE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cb21bb01b10405e536',
    storeName: 'Yojin Gravelly Hill',
    city: 'Gravelly Hill',
    postcode: 'B23 6GE',
...
// Product API Service for Yojin Gravelly Hill
class YojinGravellyHillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gravelly Hill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGravellyHillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGravellyHillProductService };
