// Configuration for Yojin Eccleston
// Store ID: 6855425e21bb01b10405e74e
// Location: Eccleston, PR7 5RP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425e21bb01b10405e74e',
    storeName: 'Yojin Eccleston',
    city: 'Eccleston',
    postcode: 'PR7 5RP',
...
// Product API Service for Yojin Eccleston
class YojinEcclestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Eccleston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEcclestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEcclestonProductService };
