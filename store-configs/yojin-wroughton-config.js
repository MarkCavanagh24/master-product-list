// Configuration for Yojin Wroughton
// Store ID: 685541ed21bb01b10405e5b2
// Location: Wroughton, SN4 0RQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ed21bb01b10405e5b2',
    storeName: 'Yojin Wroughton',
    city: 'Wroughton',
    postcode: 'SN4 0RQ',
...
// Product API Service for Yojin Wroughton
class YojinWroughtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wroughton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWroughtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWroughtonProductService };
