// Configuration for Yojin Harrowgate Village
// Store ID: 685541ae21bb01b10405e4cb
// Location: Harrowgate Village, DL1 3NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ae21bb01b10405e4cb',
    storeName: 'Yojin Harrowgate Village',
    city: 'Harrowgate Village',
    postcode: 'DL1 3NB',
...
// Product API Service for Yojin Harrowgate Village
class YojinHarrowgateVillageProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Harrowgate Village:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHarrowgateVillageProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHarrowgateVillageProductService };
