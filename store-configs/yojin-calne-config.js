// Configuration for Yojin Calne
// Store ID: 6855424621bb01b10405e6f5
// Location: Calne, SN11 0AB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424621bb01b10405e6f5',
    storeName: 'Yojin Calne',
    city: 'Calne',
    postcode: 'SN11 0AB',
...
// Product API Service for Yojin Calne
class YojinCalneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Calne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCalneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCalneProductService };
