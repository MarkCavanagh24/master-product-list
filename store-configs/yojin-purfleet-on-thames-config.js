// Configuration for Yojin Purfleet-on-Thames
// Store ID: 6855424121bb01b10405e6e5
// Location: Purfleet-on-Thames, RM19 1QU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424121bb01b10405e6e5',
    storeName: 'Yojin Purfleet-on-Thames',
    city: 'Purfleet-on-Thames',
    postcode: 'RM19 1QU',
...
// Product API Service for Yojin Purfleet-on-Thames
class YojinPurfleetonThamesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Purfleet-on-Thames:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPurfleetonThamesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPurfleetonThamesProductService };
