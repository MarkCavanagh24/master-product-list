// Configuration for Yojin Bedworth
// Store ID: 6855421c21bb01b10405e65a
// Location: Bedworth, CV12 0QF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421c21bb01b10405e65a',
    storeName: 'Yojin Bedworth',
    city: 'Bedworth',
    postcode: 'CV12 0QF',
...
// Product API Service for Yojin Bedworth
class YojinBedworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bedworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBedworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBedworthProductService };
