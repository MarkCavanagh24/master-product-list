// Configuration for Yojin Stockton-on-Tees
// Store ID: 685541af21bb01b10405e4ce
// Location: Stockton-on-Tees, TS18 4AQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541af21bb01b10405e4ce',
    storeName: 'Yojin Stockton-on-Tees',
...
// Product API Service for Yojin Stockton-on-Tees
class YojinStocktononTeesProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stockton-on-Tees:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStocktononTeesProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStocktononTeesProductService };
