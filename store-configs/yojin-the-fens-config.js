// Configuration for Yojin The Fens
// Store ID: 685541a821bb01b10405e4b6
// Location: The Fens, TS25 2JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a821bb01b10405e4b6',
    storeName: 'Yojin The Fens',
    city: 'The Fens',
    postcode: 'TS25 2JD',
...
// Product API Service for Yojin The Fens
class YojinTheFensProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin The Fens:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTheFensProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTheFensProductService };
