// Configuration for Yojin Coxlodge
// Store ID: 6855417d21bb01b10405e419
// Location: Coxlodge, NE3 4UX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417d21bb01b10405e419',
    storeName: 'Yojin Coxlodge',
    city: 'Coxlodge',
    postcode: 'NE3 4UX',
...
// Product API Service for Yojin Coxlodge
class YojinCoxlodgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Coxlodge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCoxlodgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCoxlodgeProductService };
