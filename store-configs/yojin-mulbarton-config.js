// Configuration for Yojin Mulbarton
// Store ID: 685541c721bb01b10405e526
// Location: Mulbarton, NR14 8JN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c721bb01b10405e526',
    storeName: 'Yojin Mulbarton',
    city: 'Mulbarton',
    postcode: 'NR14 8JN',
...
// Product API Service for Yojin Mulbarton
class YojinMulbartonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mulbarton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMulbartonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMulbartonProductService };
