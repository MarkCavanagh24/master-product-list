// Configuration for Yojin Stapleton
// Store ID: 685541f621bb01b10405e5d3
// Location: Stapleton, BS16 1BW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f621bb01b10405e5d3',
    storeName: 'Yojin Stapleton',
    city: 'Stapleton',
    postcode: 'BS16 1BW',
...
// Product API Service for Yojin Stapleton
class YojinStapletonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stapleton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStapletonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStapletonProductService };
