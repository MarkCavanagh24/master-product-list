// Configuration for Yojin Kent
// Store ID: 6855425321bb01b10405e725
// Location: Kent, CT1 3EJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425321bb01b10405e725',
    storeName: 'Yojin Kent',
    city: 'Kent',
    postcode: 'CT1 3EJ',
...
// Product API Service for Yojin Kent
class YojinKentProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kent:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKentProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKentProductService };
