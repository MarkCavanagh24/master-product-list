// Configuration for Yojin Great Habton
// Store ID: 6855426821bb01b10405e773
// Location: Great Habton, YO17 6TZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426821bb01b10405e773',
    storeName: 'Yojin Great Habton',
    city: 'Great Habton',
    postcode: 'YO17 6TZ',
...
// Product API Service for Yojin Great Habton
class YojinGreatHabtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Habton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatHabtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatHabtonProductService };
