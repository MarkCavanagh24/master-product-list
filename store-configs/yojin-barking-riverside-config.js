// Configuration for Yojin Barking Riverside
// Store ID: 685541f221bb01b10405e5c3
// Location: Barking Riverside, IG11 0FL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f221bb01b10405e5c3',
    storeName: 'Yojin Barking Riverside',
    city: 'Barking Riverside',
    postcode: 'IG11 0FL',
...
// Product API Service for Yojin Barking Riverside
class YojinBarkingRiversideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Barking Riverside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBarkingRiversideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBarkingRiversideProductService };
