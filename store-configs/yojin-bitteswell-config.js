// Configuration for Yojin Bitteswell
// Store ID: 6855421c21bb01b10405e65d
// Location: Bitteswell, LE17 4LS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421c21bb01b10405e65d',
    storeName: 'Yojin Bitteswell',
    city: 'Bitteswell',
    postcode: 'LE17 4LS',
...
// Product API Service for Yojin Bitteswell
class YojinBitteswellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bitteswell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBitteswellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBitteswellProductService };
