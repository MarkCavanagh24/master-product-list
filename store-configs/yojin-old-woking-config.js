// Configuration for Yojin Old Woking
// Store ID: 685541ff21bb01b10405e5f6
// Location: Old Woking, GU22 9NE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ff21bb01b10405e5f6',
    storeName: 'Yojin Old Woking',
    city: 'Old Woking',
    postcode: 'GU22 9NE',
...
// Product API Service for Yojin Old Woking
class YojinOldWokingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Old Woking:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOldWokingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOldWokingProductService };
