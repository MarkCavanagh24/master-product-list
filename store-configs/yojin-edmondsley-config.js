// Configuration for Yojin Edmondsley
// Store ID: 6855418721bb01b10405e441
// Location: Edmondsley, DH9 6SL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418721bb01b10405e441',
    storeName: 'Yojin Edmondsley',
    city: 'Edmondsley',
    postcode: 'DH9 6SL',
...
// Product API Service for Yojin Edmondsley
class YojinEdmondsleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Edmondsley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEdmondsleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEdmondsleyProductService };
