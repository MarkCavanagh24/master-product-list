// Configuration for Yojin Middlesbrough
// Store ID: 685541b321bb01b10405e4e0
// Location: Middlesbrough, TS8 9EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b321bb01b10405e4e0',
    storeName: 'Yojin Middlesbrough',
    city: 'Middlesbrough',
    postcode: 'TS8 9EF',
...
// Product API Service for Yojin Middlesbrough
class YojinMiddlesbroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Middlesbrough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMiddlesbroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMiddlesbroughProductService };
