// Configuration for Yojin Oxenholme
// Store ID: 685541dd21bb01b10405e579
// Location: Oxenholme, LA8 0LR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dd21bb01b10405e579',
    storeName: 'Yojin Oxenholme',
    city: 'Oxenholme',
    postcode: 'LA8 0LR',
...
// Product API Service for Yojin Oxenholme
class YojinOxenholmeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oxenholme:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOxenholmeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOxenholmeProductService };
