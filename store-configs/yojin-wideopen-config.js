// Configuration for Yojin Wideopen
// Store ID: 6855419a21bb01b10405e481
// Location: Wideopen, NE13 6PX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419a21bb01b10405e481',
    storeName: 'Yojin Wideopen',
    city: 'Wideopen',
    postcode: 'NE13 6PX',
...
// Product API Service for Yojin Wideopen
class YojinWideopenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wideopen:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWideopenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWideopenProductService };
