// Configuration for Yojin Hampton Loade
// Store ID: 6855421921bb01b10405e650
// Location: Hampton Loade, WV15 6HB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421921bb01b10405e650',
    storeName: 'Yojin Hampton Loade',
    city: 'Hampton Loade',
    postcode: 'WV15 6HB',
...
// Product API Service for Yojin Hampton Loade
class YojinHamptonLoadeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hampton Loade:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHamptonLoadeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHamptonLoadeProductService };
