// Configuration for Yojin St. Nicholas
// Store ID: 6855424721bb01b10405e6fb
// Location: St. Nicholas, RG40 5SA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424721bb01b10405e6fb',
    storeName: 'Yojin St. Nicholas',
    city: 'St. Nicholas',
    postcode: 'RG40 5SA',
...
// Product API Service for Yojin St. Nicholas
class YojinStNicholasProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin St. Nicholas:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStNicholasProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStNicholasProductService };
