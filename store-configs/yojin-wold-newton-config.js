// Configuration for Yojin Wold Newton
// Store ID: 6855426e21bb01b10405e78c
// Location: Wold Newton, YO25 3PZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426e21bb01b10405e78c',
    storeName: 'Yojin Wold Newton',
    city: 'Wold Newton',
    postcode: 'YO25 3PZ',
...
// Product API Service for Yojin Wold Newton
class YojinWoldNewtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wold Newton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoldNewtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoldNewtonProductService };
