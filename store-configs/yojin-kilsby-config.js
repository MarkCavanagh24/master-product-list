// Configuration for Yojin Kilsby
// Store ID: 6855423d21bb01b10405e6d6
// Location: Kilsby, NN6 7ES

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423d21bb01b10405e6d6',
    storeName: 'Yojin Kilsby',
    city: 'Kilsby',
    postcode: 'NN6 7ES',
...
// Product API Service for Yojin Kilsby
class YojinKilsbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kilsby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKilsbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKilsbyProductService };
