// Configuration for Yojin Belton
// Store ID: 685541c821bb01b10405e52b
// Location: Belton, NR31 9AA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c821bb01b10405e52b',
    storeName: 'Yojin Belton',
    city: 'Belton',
    postcode: 'NR31 9AA',
...
// Product API Service for Yojin Belton
class YojinBeltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Belton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBeltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBeltonProductService };
