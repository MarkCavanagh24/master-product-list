// Configuration for Yojin Foxham
// Store ID: 685541f721bb01b10405e5d7
// Location: Foxham, SN15 4LS

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f721bb01b10405e5d7',
    storeName: 'Yojin Foxham',
    city: 'Foxham',
    postcode: 'SN15 4LS',
...
// Product API Service for Yojin Foxham
class YojinFoxhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Foxham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFoxhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFoxhamProductService };
