// Configuration for Yojin Newton
// Store ID: 6855423221bb01b10405e6ad
// Location: Newton, CV21 1UA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423221bb01b10405e6ad',
    storeName: 'Yojin Newton',
    city: 'Newton',
    postcode: 'CV21 1UA',
...
// Product API Service for Yojin Newton
class YojinNewtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewtonProductService };
