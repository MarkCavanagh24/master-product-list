// Configuration for Yojin Ashmansworth
// Store ID: 685541fd21bb01b10405e5ee
// Location: Ashmansworth, RG20 9QH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fd21bb01b10405e5ee',
    storeName: 'Yojin Ashmansworth',
    city: 'Ashmansworth',
    postcode: 'RG20 9QH',
...
// Product API Service for Yojin Ashmansworth
class YojinAshmansworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ashmansworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshmansworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshmansworthProductService };
