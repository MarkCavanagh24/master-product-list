// Configuration for Yojin Blacktoft
// Store ID: 6855425c21bb01b10405e749
// Location: Blacktoft, DN14 8HR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425c21bb01b10405e749',
    storeName: 'Yojin Blacktoft',
    city: 'Blacktoft',
    postcode: 'DN14 8HR',
...
// Product API Service for Yojin Blacktoft
class YojinBlacktoftProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blacktoft:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlacktoftProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlacktoftProductService };
