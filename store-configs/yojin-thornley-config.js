// Configuration for Yojin Thornley
// Store ID: 6855419021bb01b10405e45f
// Location: Thornley, DH6 3LY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419021bb01b10405e45f',
    storeName: 'Yojin Thornley',
    city: 'Thornley',
    postcode: 'DH6 3LY',
...
// Product API Service for Yojin Thornley
class YojinThornleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thornley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThornleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThornleyProductService };
