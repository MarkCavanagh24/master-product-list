// Configuration for Yojin Binley
// Store ID: 6855423121bb01b10405e6aa
// Location: Binley, CV3 2PG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423121bb01b10405e6aa',
    storeName: 'Yojin Binley',
    city: 'Binley',
    postcode: 'CV3 2PG',
...
// Product API Service for Yojin Binley
class YojinBinleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Binley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBinleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBinleyProductService };
