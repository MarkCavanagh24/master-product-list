// Configuration for Yojin North Shields
// Store ID: 6855417e21bb01b10405e41b
// Location: North Shields, NE29 7FN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417e21bb01b10405e41b',
    storeName: 'Yojin North Shields',
    city: 'North Shields',
    postcode: 'NE29 7FN',
...
// Product API Service for Yojin North Shields
class YojinNorthShieldsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Shields:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthShieldsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthShieldsProductService };
