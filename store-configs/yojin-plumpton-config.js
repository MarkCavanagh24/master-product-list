// Configuration for Yojin Plumpton
// Store ID: 6855418e21bb01b10405e456
// Location: Plumpton, CA11 9PN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418e21bb01b10405e456',
    storeName: 'Yojin Plumpton',
    city: 'Plumpton',
    postcode: 'CA11 9PN',
...
// Product API Service for Yojin Plumpton
class YojinPlumptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Plumpton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPlumptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPlumptonProductService };
