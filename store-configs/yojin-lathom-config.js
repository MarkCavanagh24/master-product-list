// Configuration for Yojin Lathom
// Store ID: 6855426321bb01b10405e761
// Location: Lathom, L40 4BW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426321bb01b10405e761',
    storeName: 'Yojin Lathom',
    city: 'Lathom',
    postcode: 'L40 4BW',
...
// Product API Service for Yojin Lathom
class YojinLathomProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lathom:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLathomProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLathomProductService };
