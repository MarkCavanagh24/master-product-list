// Configuration for Yojin Scaldwell
// Store ID: 6855423e21bb01b10405e6da
// Location: Scaldwell, NN6 9JT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423e21bb01b10405e6da',
    storeName: 'Yojin Scaldwell',
    city: 'Scaldwell',
    postcode: 'NN6 9JT',
...
// Product API Service for Yojin Scaldwell
class YojinScaldwellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scaldwell:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScaldwellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScaldwellProductService };
