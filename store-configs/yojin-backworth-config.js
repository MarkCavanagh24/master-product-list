// Configuration for Yojin Backworth
// Store ID: 6855419a21bb01b10405e482
// Location: Backworth, NE27 0XQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419a21bb01b10405e482',
    storeName: 'Yojin Backworth',
    city: 'Backworth',
    postcode: 'NE27 0XQ',
...
// Product API Service for Yojin Backworth
class YojinBackworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Backworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBackworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBackworthProductService };
