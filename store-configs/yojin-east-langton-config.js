// Configuration for Yojin East Langton
// Store ID: 685541cf21bb01b10405e543
// Location: East Langton, LE16 7TD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541cf21bb01b10405e543',
    storeName: 'Yojin East Langton',
    city: 'East Langton',
    postcode: 'LE16 7TD',
...
// Product API Service for Yojin East Langton
class YojinEastLangtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Langton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastLangtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastLangtonProductService };
