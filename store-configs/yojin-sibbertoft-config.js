// Configuration for Yojin Sibbertoft
// Store ID: 685541e121bb01b10405e588
// Location: Sibbertoft, LE16 9UJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e121bb01b10405e588',
    storeName: 'Yojin Sibbertoft',
    city: 'Sibbertoft',
    postcode: 'LE16 9UJ',
...
// Product API Service for Yojin Sibbertoft
class YojinSibbertoftProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sibbertoft:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSibbertoftProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSibbertoftProductService };
