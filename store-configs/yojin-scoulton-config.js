// Configuration for Yojin Scoulton
// Store ID: 685541c621bb01b10405e523
// Location: Scoulton, NR9 4NT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c621bb01b10405e523',
    storeName: 'Yojin Scoulton',
    city: 'Scoulton',
    postcode: 'NR9 4NT',
...
// Product API Service for Yojin Scoulton
class YojinScoultonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Scoulton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinScoultonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinScoultonProductService };
