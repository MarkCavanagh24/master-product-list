// Configuration for Yojin East Witton
// Store ID: 6855422621bb01b10405e682
// Location: East Witton, HG4 4PJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422621bb01b10405e682',
    storeName: 'Yojin East Witton',
    city: 'East Witton',
    postcode: 'HG4 4PJ',
...
// Product API Service for Yojin East Witton
class YojinEastWittonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Witton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastWittonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastWittonProductService };
