// Configuration for Yojin Geddington
// Store ID: 685541e221bb01b10405e58c
// Location: Geddington, NN14 1BW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e221bb01b10405e58c',
    storeName: 'Yojin Geddington',
    city: 'Geddington',
    postcode: 'NN14 1BW',
...
// Product API Service for Yojin Geddington
class YojinGeddingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Geddington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGeddingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGeddingtonProductService };
