// Configuration for Yojin Thornborough
// Store ID: 6855422b21bb01b10405e695
// Location: Thornborough, DL8 2NT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422b21bb01b10405e695',
    storeName: 'Yojin Thornborough',
    city: 'Thornborough',
    postcode: 'DL8 2NT',
...
// Product API Service for Yojin Thornborough
class YojinThornboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thornborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThornboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThornboroughProductService };
