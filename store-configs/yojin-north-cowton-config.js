// Configuration for Yojin North Cowton
// Store ID: 685541d521bb01b10405e559
// Location: North Cowton, DL7 0HP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d521bb01b10405e559',
    storeName: 'Yojin North Cowton',
    city: 'North Cowton',
    postcode: 'DL7 0HP',
...
// Product API Service for Yojin North Cowton
class YojinNorthCowtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Cowton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthCowtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthCowtonProductService };
