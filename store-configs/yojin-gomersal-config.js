// Configuration for Yojin Gomersal
// Store ID: 6855420f21bb01b10405e62c
// Location: Gomersal, BD19 4LL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420f21bb01b10405e62c',
    storeName: 'Yojin Gomersal',
    city: 'Gomersal',
    postcode: 'BD19 4LL',
...
// Product API Service for Yojin Gomersal
class YojinGomersalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gomersal:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGomersalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGomersalProductService };
