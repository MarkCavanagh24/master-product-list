// Configuration for Yojin Heywood
// Store ID: 6855426521bb01b10405e768
// Location: Heywood, OL11 5PE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426521bb01b10405e768',
    storeName: 'Yojin Heywood',
    city: 'Heywood',
    postcode: 'OL11 5PE',
...
// Product API Service for Yojin Heywood
class YojinHeywoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Heywood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHeywoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHeywoodProductService };
