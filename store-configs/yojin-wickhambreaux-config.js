// Configuration for Yojin Wickhambreaux
// Store ID: 6855420421bb01b10405e607
// Location: Wickhambreaux, CT3 4BE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420421bb01b10405e607',
    storeName: 'Yojin Wickhambreaux',
    city: 'Wickhambreaux',
    postcode: 'CT3 4BE',
...
// Product API Service for Yojin Wickhambreaux
class YojinWickhambreauxProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wickhambreaux:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWickhambreauxProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWickhambreauxProductService };
