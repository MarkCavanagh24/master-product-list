// Configuration for Yojin Mark
// Store ID: 6855425321bb01b10405e728
// Location: Mark, TA9 4LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425321bb01b10405e728',
    storeName: 'Yojin Mark',
    city: 'Mark',
    postcode: 'TA9 4LJ',
...
// Product API Service for Yojin Mark
class YojinMarkProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mark:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMarkProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMarkProductService };
