// Configuration for Yojin Bishop Monkton
// Store ID: 6855427121bb01b10405e794
// Location: Bishop Monkton, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427121bb01b10405e794',
    storeName: 'Yojin Bishop Monkton',
    city: 'Bishop Monkton',
    postcode: 'N/A',
...
// Product API Service for Yojin Bishop Monkton
class YojinBishopMonktonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bishop Monkton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBishopMonktonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBishopMonktonProductService };
