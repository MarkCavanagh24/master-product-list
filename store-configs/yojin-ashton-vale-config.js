// Configuration for Yojin Ashton Vale
// Store ID: 6855424421bb01b10405e6ef
// Location: Ashton Vale, BS3 2QB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424421bb01b10405e6ef',
    storeName: 'Yojin Ashton Vale',
    city: 'Ashton Vale',
    postcode: 'BS3 2QB',
...
// Product API Service for Yojin Ashton Vale
class YojinAshtonValeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ashton Vale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAshtonValeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAshtonValeProductService };
