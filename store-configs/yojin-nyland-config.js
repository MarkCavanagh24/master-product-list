// Configuration for Yojin Nyland
// Store ID: 6855420521bb01b10405e60a
// Location: Nyland, BS27 3EH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420521bb01b10405e60a',
    storeName: 'Yojin Nyland',
    city: 'Nyland',
    postcode: 'BS27 3EH',
...
// Product API Service for Yojin Nyland
class YojinNylandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Nyland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNylandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNylandProductService };
