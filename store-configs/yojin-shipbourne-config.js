// Configuration for Yojin Shipbourne
// Store ID: 6855425121bb01b10405e71f
// Location: Shipbourne, TN15 0NS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425121bb01b10405e71f',
    storeName: 'Yojin Shipbourne',
    city: 'Shipbourne',
    postcode: 'TN15 0NS',
...
// Product API Service for Yojin Shipbourne
class YojinShipbourneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Shipbourne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinShipbourneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinShipbourneProductService };
