// Configuration for Yojin Sedgefield
// Store ID: 6855419621bb01b10405e474
// Location: Sedgefield, TS22 5NW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419621bb01b10405e474',
    storeName: 'Yojin Sedgefield',
    city: 'Sedgefield',
    postcode: 'TS22 5NW',
...
// Product API Service for Yojin Sedgefield
class YojinSedgefieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sedgefield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSedgefieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSedgefieldProductService };
