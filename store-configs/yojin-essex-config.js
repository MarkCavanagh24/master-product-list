// Configuration for Yojin Essex
// Store ID: 685541f221bb01b10405e5c5
// Location: Essex, RM13 9GW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f221bb01b10405e5c5',
    storeName: 'Yojin Essex',
    city: 'Essex',
    postcode: 'RM13 9GW',
...
// Product API Service for Yojin Essex
class YojinEssexProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Essex:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEssexProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEssexProductService };
