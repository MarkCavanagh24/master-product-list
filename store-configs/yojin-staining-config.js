// Configuration for Yojin Staining
// Store ID: 685541b921bb01b10405e4f3
// Location: Staining, FY3 0AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b921bb01b10405e4f3',
    storeName: 'Yojin Staining',
    city: 'Staining',
    postcode: 'FY3 0AY',
...
// Product API Service for Yojin Staining
class YojinStainingProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Staining:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStainingProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStainingProductService };
