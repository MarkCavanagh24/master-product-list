// Configuration for Yojin Walgrave
// Store ID: 6855423e21bb01b10405e6db
// Location: Walgrave, NN6 9PH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423e21bb01b10405e6db',
    storeName: 'Yojin Walgrave',
    city: 'Walgrave',
    postcode: 'NN6 9PH',
...
// Product API Service for Yojin Walgrave
class YojinWalgraveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Walgrave:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWalgraveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWalgraveProductService };
