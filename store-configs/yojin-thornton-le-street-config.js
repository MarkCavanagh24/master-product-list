// Configuration for Yojin Thornton-le-Street
// Store ID: 6855422821bb01b10405e687
// Location: Thornton-le-Street, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422821bb01b10405e687',
    storeName: 'Yojin Thornton-le-Street',
    city: 'Thornton-le-Street',
    postcode: 'N/A',
...
// Product API Service for Yojin Thornton-le-Street
class YojinThorntonleStreetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thornton-le-Street:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThorntonleStreetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThorntonleStreetProductService };
