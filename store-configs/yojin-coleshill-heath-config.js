// Configuration for Yojin Coleshill Heath
// Store ID: 6855421b21bb01b10405e658
// Location: Coleshill Heath, B37 6TJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421b21bb01b10405e658',
    storeName: 'Yojin Coleshill Heath',
    city: 'Coleshill Heath',
    postcode: 'B37 6TJ',
...
// Product API Service for Yojin Coleshill Heath
class YojinColeshillHeathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Coleshill Heath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinColeshillHeathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinColeshillHeathProductService };
