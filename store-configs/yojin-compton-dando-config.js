// Configuration for Yojin Compton Dando
// Store ID: 6855428621bb01b10405e7de
// Location: Compton Dando, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428621bb01b10405e7de',
    storeName: 'Yojin Compton Dando',
    city: 'Compton Dando',
    postcode: 'N/A',
...
// Product API Service for Yojin Compton Dando
class YojinComptonDandoProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Compton Dando:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinComptonDandoProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinComptonDandoProductService };
