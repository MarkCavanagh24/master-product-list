// Configuration for Yojin Swindon
// Store ID: 685541ec21bb01b10405e5b1
// Location: Swindon, SN4 8QR

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ec21bb01b10405e5b1',
    storeName: 'Yojin Swindon',
    city: 'Swindon',
    postcode: 'SN4 8QR',
...
// Product API Service for Yojin Swindon
class YojinSwindonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Swindon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSwindonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSwindonProductService };
