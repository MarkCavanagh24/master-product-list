// Configuration for Yojin Church Brampton
// Store ID: 6855428221bb01b10405e7d1
// Location: Church Brampton, NN6 8AS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428221bb01b10405e7d1',
    storeName: 'Yojin Church Brampton',
    city: 'Church Brampton',
    postcode: 'NN6 8AS',
...
// Product API Service for Yojin Church Brampton
class YojinChurchBramptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Church Brampton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChurchBramptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChurchBramptonProductService };
