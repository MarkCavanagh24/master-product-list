// Configuration for Yojin Tebay
// Store ID: 685541d421bb01b10405e556
// Location: Tebay, CA10 3TG

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d421bb01b10405e556',
    storeName: 'Yojin Tebay',
    city: 'Tebay',
    postcode: 'CA10 3TG',
...
// Product API Service for Yojin Tebay
class YojinTebayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tebay:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTebayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTebayProductService };
