// Configuration for Yojin Burton Stather
// Store ID: 6855426121bb01b10405e75a
// Location: Burton Stather, DN15 9AB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426121bb01b10405e75a',
    storeName: 'Yojin Burton Stather',
    city: 'Burton Stather',
    postcode: 'DN15 9AB',
...
// Product API Service for Yojin Burton Stather
class YojinBurtonStatherProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burton Stather:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurtonStatherProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurtonStatherProductService };
