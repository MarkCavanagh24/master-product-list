// Configuration for Yojin Cramlington
// Store ID: 6855419821bb01b10405e47c
// Location: Cramlington, NE23 8BJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419821bb01b10405e47c',
    storeName: 'Yojin Cramlington',
    city: 'Cramlington',
    postcode: 'NE23 8BJ',
...
// Product API Service for Yojin Cramlington
class YojinCramlingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cramlington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCramlingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCramlingtonProductService };
