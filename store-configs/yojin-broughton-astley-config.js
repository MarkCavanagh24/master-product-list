// Configuration for Yojin Broughton Astley
// Store ID: 685541ce21bb01b10405e53f
// Location: Broughton Astley, LE9 6NN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ce21bb01b10405e53f',
    storeName: 'Yojin Broughton Astley',
...
// Product API Service for Yojin Broughton Astley
class YojinBroughtonAstleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Broughton Astley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBroughtonAstleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBroughtonAstleyProductService };
