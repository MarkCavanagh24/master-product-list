// Configuration for Yojin Upper Woolhampton
// Store ID: 6855428821bb01b10405e7e7
// Location: Upper Woolhampton, RG7 5FT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428821bb01b10405e7e7',
    storeName: 'Yojin Upper Woolhampton',
    city: 'Upper Woolhampton',
    postcode: 'RG7 5FT',
...
// Product API Service for Yojin Upper Woolhampton
class YojinUpperWoolhamptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Upper Woolhampton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUpperWoolhamptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUpperWoolhamptonProductService };
