// Configuration for Yojin Chester Moor
// Store ID: 6855418b21bb01b10405e44a
// Location: Chester Moor, DH2 3LE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418b21bb01b10405e44a',
    storeName: 'Yojin Chester Moor',
    city: 'Chester Moor',
    postcode: 'DH2 3LE',
...
// Product API Service for Yojin Chester Moor
class YojinChesterMoorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chester Moor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChesterMoorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChesterMoorProductService };
