// Configuration for Yojin Pewsey
// Store ID: 685541fd21bb01b10405e5ec
// Location: Pewsey, SN9 6LZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fd21bb01b10405e5ec',
    storeName: 'Yojin Pewsey',
    city: 'Pewsey',
    postcode: 'SN9 6LZ',
...
// Product API Service for Yojin Pewsey
class YojinPewseyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pewsey:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPewseyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPewseyProductService };
