// Configuration for Yojin North Cove
// Store ID: 685541e821bb01b10405e5a3
// Location: North Cove, NR34 7XE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e821bb01b10405e5a3',
    storeName: 'Yojin North Cove',
    city: 'North Cove',
    postcode: 'NR34 7XE',
...
// Product API Service for Yojin North Cove
class YojinNorthCoveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Cove:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthCoveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthCoveProductService };
