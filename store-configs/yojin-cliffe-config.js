// Configuration for Yojin Cliffe
// Store ID: 6855420b21bb01b10405e61b
// Location: Cliffe, YO8 6PE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420b21bb01b10405e61b',
    storeName: 'Yojin Cliffe',
    city: 'Cliffe',
    postcode: 'YO8 6PE',
...
// Product API Service for Yojin Cliffe
class YojinCliffeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cliffe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCliffeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCliffeProductService };
