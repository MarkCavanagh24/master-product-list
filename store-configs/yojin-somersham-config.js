// Configuration for Yojin Somersham
// Store ID: 6855423521bb01b10405e6bb
// Location: Somersham, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423521bb01b10405e6bb',
    storeName: 'Yojin Somersham',
    city: 'Somersham',
    postcode: 'N/A',
...
// Product API Service for Yojin Somersham
class YojinSomershamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Somersham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSomershamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSomershamProductService };
