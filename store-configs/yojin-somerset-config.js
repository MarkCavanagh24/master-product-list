// Configuration for Yojin Somerset
// Store ID: 6855425421bb01b10405e72a
// Location: Somerset, BA5 2QZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425421bb01b10405e72a',
    storeName: 'Yojin Somerset',
    city: 'Somerset',
    postcode: 'BA5 2QZ',
...
// Product API Service for Yojin Somerset
class YojinSomersetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Somerset:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSomersetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSomersetProductService };
