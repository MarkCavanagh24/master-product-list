// Configuration for Yojin Leyland
// Store ID: 6855421321bb01b10405e639
// Location: Leyland, PR25 1QT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421321bb01b10405e639',
    storeName: 'Yojin Leyland',
    city: 'Leyland',
    postcode: 'PR25 1QT',
...
// Product API Service for Yojin Leyland
class YojinLeylandProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Leyland:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLeylandProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLeylandProductService };
