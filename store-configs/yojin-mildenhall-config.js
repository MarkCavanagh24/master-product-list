// Configuration for Yojin Mildenhall
// Store ID: 6855427a21bb01b10405e7b5
// Location: Mildenhall, IP28 7JQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427a21bb01b10405e7b5',
    storeName: 'Yojin Mildenhall',
    city: 'Mildenhall',
    postcode: 'IP28 7JQ',
...
// Product API Service for Yojin Mildenhall
class YojinMildenhallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mildenhall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMildenhallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMildenhallProductService };
