// Configuration for Yojin High Bentham
// Store ID: 6855426b21bb01b10405e77f
// Location: High Bentham, LA2 7AQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426b21bb01b10405e77f',
    storeName: 'Yojin High Bentham',
    city: 'High Bentham',
    postcode: 'LA2 7AQ',
...
// Product API Service for Yojin High Bentham
class YojinHighBenthamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin High Bentham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHighBenthamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHighBenthamProductService };
