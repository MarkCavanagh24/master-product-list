// Configuration for Yojin Brompton-on-Swale
// Store ID: 685541d821bb01b10405e567
// Location: Brompton-on-Swale, DL10 7HW

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d821bb01b10405e567',
    storeName: 'Yojin Brompton-on-Swale',
    city: 'Brompton-on-Swale',
    postcode: 'DL10 7HW',
...
// Product API Service for Yojin Brompton-on-Swale
class YojinBromptononSwaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brompton-on-Swale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBromptononSwaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBromptononSwaleProductService };
