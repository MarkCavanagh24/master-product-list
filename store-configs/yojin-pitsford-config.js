// Configuration for Yojin Pitsford
// Store ID: 6855428221bb01b10405e7d2
// Location: Pitsford, NN6 9AY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428221bb01b10405e7d2',
    storeName: 'Yojin Pitsford',
    city: 'Pitsford',
    postcode: 'NN6 9AY',
...
// Product API Service for Yojin Pitsford
class YojinPitsfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Pitsford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPitsfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPitsfordProductService };
