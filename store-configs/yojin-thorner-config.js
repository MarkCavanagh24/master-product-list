// Configuration for Yojin Thorner
// Store ID: 685541b721bb01b10405e4ed
// Location: Thorner, LS14 3AL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b721bb01b10405e4ed',
    storeName: 'Yojin Thorner',
    city: 'Thorner',
    postcode: 'LS14 3AL',
...
// Product API Service for Yojin Thorner
class YojinThornerProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Thorner:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinThornerProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinThornerProductService };
