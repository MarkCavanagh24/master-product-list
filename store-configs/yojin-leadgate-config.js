// Configuration for Yojin Leadgate
// Store ID: 6855418721bb01b10405e43f
// Location: Leadgate, DH8 6JS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418721bb01b10405e43f',
    storeName: 'Yojin Leadgate',
    city: 'Leadgate',
    postcode: 'DH8 6JS',
...
// Product API Service for Yojin Leadgate
class YojinLeadgateProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Leadgate:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLeadgateProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLeadgateProductService };
