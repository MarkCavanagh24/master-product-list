// Configuration for Yojin Great Musgrave
// Store ID: 685541b121bb01b10405e4d6
// Location: Great Musgrave, CA17 4PQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b121bb01b10405e4d6',
    storeName: 'Yojin Great Musgrave',
    city: 'Great Musgrave',
    postcode: 'CA17 4PQ',
...
// Product API Service for Yojin Great Musgrave
class YojinGreatMusgraveProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Great Musgrave:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGreatMusgraveProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGreatMusgraveProductService };
