// Configuration for Yojin Maidstone
// Store ID: 6855425221bb01b10405e722
// Location: Maidstone, ME15 7AN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425221bb01b10405e722',
    storeName: 'Yojin Maidstone',
    city: 'Maidstone',
    postcode: 'ME15 7AN',
...
// Product API Service for Yojin Maidstone
class YojinMaidstoneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Maidstone:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMaidstoneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMaidstoneProductService };
