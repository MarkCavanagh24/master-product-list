// Configuration for Yojin East Ayton
// Store ID: 6855422a21bb01b10405e68f
// Location: East Ayton, YO13 9LB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422a21bb01b10405e68f',
    storeName: 'Yojin East Ayton',
    city: 'East Ayton',
    postcode: 'YO13 9LB',
...
// Product API Service for Yojin East Ayton
class YojinEastAytonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Ayton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastAytonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastAytonProductService };
