// Configuration for Yojin Kilburn
// Store ID: 6855422c21bb01b10405e699
// Location: Kilburn, YO7 2AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422c21bb01b10405e699',
    storeName: 'Yojin Kilburn',
    city: 'Kilburn',
    postcode: 'YO7 2AP',
...
// Product API Service for Yojin Kilburn
class YojinKilburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kilburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKilburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKilburnProductService };
