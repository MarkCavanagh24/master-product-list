// Configuration for Yojin Blundeston
// Store ID: 6855421921bb01b10405e64f
// Location: Blundeston, NR32 5AP

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421921bb01b10405e64f',
    storeName: 'Yojin Blundeston',
    city: 'Blundeston',
    postcode: 'NR32 5AP',
...
// Product API Service for Yojin Blundeston
class YojinBlundestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blundeston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlundestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlundestonProductService };
