// Configuration for Yojin Mapledurham
// Store ID: 685541f821bb01b10405e5d9
// Location: Mapledurham, RG4 7TZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f821bb01b10405e5d9',
    storeName: 'Yojin Mapledurham',
    city: 'Mapledurham',
    postcode: 'RG4 7TZ',
...
// Product API Service for Yojin Mapledurham
class YojinMapledurhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Mapledurham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMapledurhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMapledurhamProductService };
