// Configuration for Yojin Wellingborough
// Store ID: 6855428321bb01b10405e7d5
// Location: Wellingborough, NN8 1NQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428321bb01b10405e7d5',
    storeName: 'Yojin Wellingborough',
    city: 'Wellingborough',
    postcode: 'NN8 1NQ',
...
// Product API Service for Yojin Wellingborough
class YojinWellingboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wellingborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWellingboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWellingboroughProductService };
