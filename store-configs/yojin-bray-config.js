// Configuration for Yojin Bray
// Store ID: 685541f921bb01b10405e5dd
// Location: Bray, SL6 3JX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f921bb01b10405e5dd',
    storeName: 'Yojin Bray',
    city: 'Bray',
    postcode: 'SL6 3JX',
...
// Product API Service for Yojin Bray
class YojinBrayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bray:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrayProductService };
