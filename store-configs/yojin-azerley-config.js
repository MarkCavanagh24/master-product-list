// Configuration for Yojin Azerley
// Store ID: 6855422f21bb01b10405e6a4
// Location: Azerley, HG4 3JJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422f21bb01b10405e6a4',
    storeName: 'Yojin Azerley',
    city: 'Azerley',
    postcode: 'HG4 3JJ',
...
// Product API Service for Yojin Azerley
class YojinAzerleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Azerley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAzerleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAzerleyProductService };
