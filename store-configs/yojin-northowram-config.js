// Configuration for Yojin Northowram
// Store ID: 6855420f21bb01b10405e62a
// Location: Northowram, HX3 7EU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420f21bb01b10405e62a',
    storeName: 'Yojin Northowram',
    city: 'Northowram',
    postcode: 'HX3 7EU',
...
// Product API Service for Yojin Northowram
class YojinNorthowramProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Northowram:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthowramProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthowramProductService };
