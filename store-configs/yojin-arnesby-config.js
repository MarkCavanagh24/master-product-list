// Configuration for Yojin Arnesby
// Store ID: 685541ce21bb01b10405e541
// Location: Arnesby, LE8 5WN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ce21bb01b10405e541',
    storeName: 'Yojin Arnesby',
    city: 'Arnesby',
    postcode: 'LE8 5WN',
...
// Product API Service for Yojin Arnesby
class YojinArnesbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Arnesby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinArnesbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinArnesbyProductService };
