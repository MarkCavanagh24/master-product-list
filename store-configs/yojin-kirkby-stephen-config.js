// Configuration for Yojin Kirkby Stephen
// Store ID: 685541b521bb01b10405e4e5
// Location: Kirkby Stephen, CA17 4HH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b521bb01b10405e4e5',
    storeName: 'Yojin Kirkby Stephen',
    city: 'Kirkby Stephen',
    postcode: 'CA17 4HH',
...
// Product API Service for Yojin Kirkby Stephen
class YojinKirkbyStephenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkby Stephen:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkbyStephenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkbyStephenProductService };
