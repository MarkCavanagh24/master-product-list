// Configuration for Yojin Longhill
// Store ID: 6855420c21bb01b10405e621
// Location: Longhill, HU8 9QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420c21bb01b10405e621',
    storeName: 'Yojin Longhill',
    city: 'Longhill',
    postcode: 'HU8 9QJ',
...
// Product API Service for Yojin Longhill
class YojinLonghillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Longhill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLonghillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLonghillProductService };
