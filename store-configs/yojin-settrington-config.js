// Configuration for Yojin Settrington
// Store ID: 6855426e21bb01b10405e789
// Location: Settrington, YO17 8NW

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426e21bb01b10405e789',
    storeName: 'Yojin Settrington',
    city: 'Settrington',
    postcode: 'YO17 8NW',
...
// Product API Service for Yojin Settrington
class YojinSettringtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Settrington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSettringtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSettringtonProductService };
