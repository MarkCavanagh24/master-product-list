// Configuration for Yojin Potto
// Store ID: 685541d621bb01b10405e55d
// Location: Potto, DL6 3AX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d621bb01b10405e55d',
    storeName: 'Yojin Potto',
    city: 'Potto',
    postcode: 'DL6 3AX',
...
// Product API Service for Yojin Potto
class YojinPottoProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Potto:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinPottoProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinPottoProductService };
