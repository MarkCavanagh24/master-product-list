// Configuration for Yojin Abberley
// Store ID: 6855427d21bb01b10405e7c1
// Location: Abberley, WR6 6AS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427d21bb01b10405e7c1',
    storeName: 'Yojin Abberley',
    city: 'Abberley',
    postcode: 'WR6 6AS',
...
// Product API Service for Yojin Abberley
class YojinAbberleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Abberley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAbberleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAbberleyProductService };
