// Configuration for Yojin Rock
// Store ID: 6855423821bb01b10405e6c5
// Location: Rock, DY14 9YF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423821bb01b10405e6c5',
    storeName: 'Yojin Rock',
    city: 'Rock',
    postcode: 'DY14 9YF',
...
// Product API Service for Yojin Rock
class YojinRockProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rock:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRockProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRockProductService };
