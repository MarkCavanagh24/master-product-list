// Configuration for Yojin Becconsall
// Store ID: 6855421221bb01b10405e638
// Location: Becconsall, PR4 6XJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421221bb01b10405e638',
    storeName: 'Yojin Becconsall',
    city: 'Becconsall',
    postcode: 'PR4 6XJ',
...
// Product API Service for Yojin Becconsall
class YojinBecconsallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Becconsall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBecconsallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBecconsallProductService };
