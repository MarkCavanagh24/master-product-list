// Configuration for Yojin Kingswood
// Store ID: 6855420c21bb01b10405e620
// Location: Kingswood, HU7 6EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420c21bb01b10405e620',
    storeName: 'Yojin Kingswood',
    city: 'Kingswood',
    postcode: 'HU7 6EF',
...
// Product API Service for Yojin Kingswood
class YojinKingswoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kingswood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKingswoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKingswoodProductService };
