// Configuration for Yojin Easington
// Store ID: 6855418e21bb01b10405e455
// Location: Easington, SR8 3UH

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418e21bb01b10405e455',
    storeName: 'Yojin Easington',
    city: 'Easington',
    postcode: 'SR8 3UH',
...
// Product API Service for Yojin Easington
class YojinEasingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Easington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEasingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEasingtonProductService };
