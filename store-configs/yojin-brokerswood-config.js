// Configuration for Yojin Brokerswood
// Store ID: 6855420721bb01b10405e60f
// Location: Brokerswood, BA13 4EF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420721bb01b10405e60f',
    storeName: 'Yojin Brokerswood',
    city: 'Brokerswood',
    postcode: 'BA13 4EF',
...
// Product API Service for Yojin Brokerswood
class YojinBrokerswoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brokerswood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrokerswoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrokerswoodProductService };
