// Configuration for Yojin Huby
// Store ID: 6855427121bb01b10405e796
// Location: Huby, YO61 1JE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427121bb01b10405e796',
    storeName: 'Yojin Huby',
    city: 'Huby',
    postcode: 'YO61 1JE',
...
// Product API Service for Yojin Huby
class YojinHubyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Huby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHubyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHubyProductService };
