// Configuration for Yojin Limefield
// Store ID: 6855426421bb01b10405e767
// Location: Limefield, BL9 6PJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426421bb01b10405e767',
    storeName: 'Yojin Limefield',
    city: 'Limefield',
    postcode: 'BL9 6PJ',
...
// Product API Service for Yojin Limefield
class YojinLimefieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Limefield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLimefieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLimefieldProductService };
