// Configuration for Yojin Old Oxted
// Store ID: 6855425021bb01b10405e71d
// Location: Old Oxted, RH8 0NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425021bb01b10405e71d',
    storeName: 'Yojin Old Oxted',
    city: 'Old Oxted',
    postcode: 'RH8 0NJ',
...
// Product API Service for Yojin Old Oxted
class YojinOldOxtedProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Old Oxted:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOldOxtedProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOldOxtedProductService };
