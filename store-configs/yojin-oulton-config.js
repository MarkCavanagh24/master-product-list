// Configuration for Yojin Oulton
// Store ID: 6855421021bb01b10405e62f
// Location: Oulton, LS26 8EX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421021bb01b10405e62f',
    storeName: 'Yojin Oulton',
    city: 'Oulton',
    postcode: 'LS26 8EX',
...
// Product API Service for Yojin Oulton
class YojinOultonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oulton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOultonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOultonProductService };
