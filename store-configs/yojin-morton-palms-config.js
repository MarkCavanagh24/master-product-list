// Configuration for Yojin Morton Palms
// Store ID: 685541b221bb01b10405e4dc
// Location: Morton Palms, DL2 1LY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541b221bb01b10405e4dc',
    storeName: 'Yojin Morton Palms',
    city: 'Morton Palms',
    postcode: 'DL2 1LY',
...
// Product API Service for Yojin Morton Palms
class YojinMortonPalmsProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Morton Palms:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMortonPalmsProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMortonPalmsProductService };
