// Configuration for Yojin Clifton-on-Yore
// Store ID: 6855422721bb01b10405e683
// Location: Clifton-on-Yore, HG4 4AE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422721bb01b10405e683',
    storeName: 'Yojin Clifton-on-Yore',
    city: 'Clifton-on-Yore',
    postcode: 'HG4 4AE',
...
// Product API Service for Yojin Clifton-on-Yore
class YojinCliftononYoreProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Clifton-on-Yore:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCliftononYoreProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCliftononYoreProductService };
