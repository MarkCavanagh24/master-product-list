// Configuration for Yojin Ickham and Well
// Store ID: 6855425321bb01b10405e726
// Location: Ickham and Well, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425321bb01b10405e726',
    storeName: 'Yojin Ickham and Well',
    city: 'Ickham and Well',
    postcode: 'N/A',
...
// Product API Service for Yojin Ickham and Well
class YojinIckhamandWellProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ickham and Well:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIckhamandWellProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIckhamandWellProductService };
