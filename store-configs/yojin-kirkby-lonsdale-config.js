// Configuration for Yojin Kirkby Lonsdale
// Store ID: 6855422a21bb01b10405e692
// Location: Kirkby Lonsdale, LA6 2PQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422a21bb01b10405e692',
    storeName: 'Yojin Kirkby Lonsdale',
...
// Product API Service for Yojin Kirkby Lonsdale
class YojinKirkbyLonsdaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkby Lonsdale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkbyLonsdaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkbyLonsdaleProductService };
