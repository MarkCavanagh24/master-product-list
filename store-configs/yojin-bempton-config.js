// Configuration for Yojin Bempton
// Store ID: 6855426f21bb01b10405e78e
// Location: Bempton, YO15 1DJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426f21bb01b10405e78e',
    storeName: 'Yojin Bempton',
    city: 'Bempton',
    postcode: 'YO15 1DJ',
...
// Product API Service for Yojin Bempton
class YojinBemptonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bempton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBemptonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBemptonProductService };
