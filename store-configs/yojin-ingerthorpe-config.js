// Configuration for Yojin Ingerthorpe
// Store ID: 6855427021bb01b10405e793
// Location: Ingerthorpe, HG3 3PD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427021bb01b10405e793',
    storeName: 'Yojin Ingerthorpe',
    city: 'Ingerthorpe',
    postcode: 'HG3 3PD',
...
// Product API Service for Yojin Ingerthorpe
class YojinIngerthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ingerthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinIngerthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinIngerthorpeProductService };
