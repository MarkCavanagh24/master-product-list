// Configuration for Yojin Burnham-on-Sea
// Store ID: 6855420521bb01b10405e608
// Location: Burnham-on-Sea, TA8 2JU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420521bb01b10405e608',
    storeName: 'Yojin Burnham-on-Sea',
    city: 'Burnham-on-Sea',
    postcode: 'TA8 2JU',
...
// Product API Service for Yojin Burnham-on-Sea
class YojinBurnhamonSeaProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burnham-on-Sea:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnhamonSeaProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnhamonSeaProductService };
