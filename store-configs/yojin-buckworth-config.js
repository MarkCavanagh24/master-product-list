// Configuration for Yojin Buckworth
// Store ID: 6855423521bb01b10405e6b8
// Location: Buckworth, PE28 5XZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423521bb01b10405e6b8',
    storeName: 'Yojin Buckworth',
    city: 'Buckworth',
    postcode: 'PE28 5XZ',
...
// Product API Service for Yojin Buckworth
class YojinBuckworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Buckworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBuckworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBuckworthProductService };
