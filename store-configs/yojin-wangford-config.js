// Configuration for Yojin Wangford
// Store ID: 6855427d21bb01b10405e7c0
// Location: Wangford, NR34 8AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427d21bb01b10405e7c0',
    storeName: 'Yojin Wangford',
    city: 'Wangford',
    postcode: 'NR34 8AG',
...
// Product API Service for Yojin Wangford
class YojinWangfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wangford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWangfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWangfordProductService };
