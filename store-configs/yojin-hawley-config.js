// Configuration for Yojin Hawley
// Store ID: 6855424b21bb01b10405e70a
// Location: Hawley, DA1 1AL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424b21bb01b10405e70a',
    storeName: 'Yojin Hawley',
    city: 'Hawley',
    postcode: 'DA1 1AL',
...
// Product API Service for Yojin Hawley
class YojinHawleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hawley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHawleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHawleyProductService };
