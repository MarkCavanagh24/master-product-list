// Configuration for Yojin Kirkby Fleetham
// Store ID: 685541dc21bb01b10405e573
// Location: Kirkby Fleetham, DL7 0SL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541dc21bb01b10405e573',
    storeName: 'Yojin Kirkby Fleetham',
    city: 'Kirkby Fleetham',
    postcode: 'DL7 0SL',
...
// Product API Service for Yojin Kirkby Fleetham
class YojinKirkbyFleethamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kirkby Fleetham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKirkbyFleethamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKirkbyFleethamProductService };
