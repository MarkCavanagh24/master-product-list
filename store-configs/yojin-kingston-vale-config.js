// Configuration for Yojin Kingston Vale
// Store ID: 6855424921bb01b10405e703
// Location: Kingston Vale, SW15 3PS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424921bb01b10405e703',
    storeName: 'Yojin Kingston Vale',
    city: 'Kingston Vale',
    postcode: 'SW15 3PS',
...
// Product API Service for Yojin Kingston Vale
class YojinKingstonValeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kingston Vale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKingstonValeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKingstonValeProductService };
