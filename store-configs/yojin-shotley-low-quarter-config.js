// Configuration for Yojin Shotley Low Quarter
// Store ID: 6855418421bb01b10405e434
// Location: Shotley Low Quarter, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418421bb01b10405e434',
    storeName: 'Yojin Shotley Low Quarter',
    city: 'Shotley Low Quarter',
    postcode: 'N/A',
...
// Product API Service for Yojin Shotley Low Quarter
class YojinShotleyLowQuarterProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Shotley Low Quarter:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinShotleyLowQuarterProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinShotleyLowQuarterProductService };
