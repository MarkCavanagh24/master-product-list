// Configuration for Yojin Foulridge
// Store ID: 685541a821bb01b10405e4b5
// Location: Foulridge, BB8 7GP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a821bb01b10405e4b5',
    storeName: 'Yojin Foulridge',
    city: 'Foulridge',
    postcode: 'BB8 7GP',
...
// Product API Service for Yojin Foulridge
class YojinFoulridgeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Foulridge:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFoulridgeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFoulridgeProductService };
