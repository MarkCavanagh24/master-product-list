// Configuration for Yojin Bridge Hewick
// Store ID: 6855426c21bb01b10405e783
// Location: Bridge Hewick, HG4 5AZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426c21bb01b10405e783',
    storeName: 'Yojin Bridge Hewick',
    city: 'Bridge Hewick',
    postcode: 'HG4 5AZ',
...
// Product API Service for Yojin Bridge Hewick
class YojinBridgeHewickProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bridge Hewick:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBridgeHewickProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBridgeHewickProductService };
