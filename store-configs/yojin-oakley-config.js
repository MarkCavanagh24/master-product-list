// Configuration for Yojin Oakley
// Store ID: 6855427b21bb01b10405e7ba
// Location: Oakley, IP21 4AR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427b21bb01b10405e7ba',
    storeName: 'Yojin Oakley',
    city: 'Oakley',
    postcode: 'IP21 4AR',
...
// Product API Service for Yojin Oakley
class YojinOakleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oakley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOakleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOakleyProductService };
