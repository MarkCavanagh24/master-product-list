// Configuration for Yojin Catterick Garrison
// Store ID: 685541db21bb01b10405e571
// Location: Catterick Garrison, DL9 3NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541db21bb01b10405e571',
    storeName: 'Yojin Catterick Garrison',
...
// Product API Service for Yojin Catterick Garrison
class YojinCatterickGarrisonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Catterick Garrison:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCatterickGarrisonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCatterickGarrisonProductService };
