// Configuration for Yojin Sancton
// Store ID: 685541be21bb01b10405e507
// Location: Sancton, YO43 4RQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541be21bb01b10405e507',
    storeName: 'Yojin Sancton',
    city: 'Sancton',
    postcode: 'YO43 4RQ',
...
// Product API Service for Yojin Sancton
class YojinSanctonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sancton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSanctonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSanctonProductService };
