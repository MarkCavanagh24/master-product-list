// Configuration for Yojin Halton
// Store ID: 6855427021bb01b10405e791
// Location: Halton, LA6 1HD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427021bb01b10405e791',
    storeName: 'Yojin Halton',
    city: 'Halton',
    postcode: 'LA6 1HD',
...
// Product API Service for Yojin Halton
class YojinHaltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Halton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaltonProductService };
