// Configuration for Yojin Northumberland Heath
// Store ID: 6855424121bb01b10405e6e4
// Location: Northumberland Heath, DA8 3DY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424121bb01b10405e6e4',
    storeName: 'Yojin Northumberland Heath',
    city: 'Northumberland Heath',
    postcode: 'DA8 3DY',
...
// Product API Service for Yojin Northumberland Heath
class YojinNorthumberlandHeathProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Northumberland Heath:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthumberlandHeathProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthumberlandHeathProductService };
