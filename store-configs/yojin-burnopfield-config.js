// Configuration for Yojin Burnopfield
// Store ID: 6855418521bb01b10405e436
// Location: Burnopfield, NE16 6NB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418521bb01b10405e436',
    storeName: 'Yojin Burnopfield',
    city: 'Burnopfield',
    postcode: 'NE16 6NB',
...
// Product API Service for Yojin Burnopfield
class YojinBurnopfieldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burnopfield:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurnopfieldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurnopfieldProductService };
