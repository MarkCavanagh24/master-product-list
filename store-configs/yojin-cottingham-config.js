// Configuration for Yojin Cottingham
// Store ID: 6855420c21bb01b10405e61f
// Location: Cottingham, HU16 5QZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420c21bb01b10405e61f',
    storeName: 'Yojin Cottingham',
    city: 'Cottingham',
    postcode: 'HU16 5QZ',
...
// Product API Service for Yojin Cottingham
class YojinCottinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cottingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCottinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCottinghamProductService };
