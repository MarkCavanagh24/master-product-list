// Configuration for Yojin Milnrow
// Store ID: 6855426521bb01b10405e76a
// Location: Milnrow, OL16 3TQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426521bb01b10405e76a',
    storeName: 'Yojin Milnrow',
    city: 'Milnrow',
    postcode: 'OL16 3TQ',
...
// Product API Service for Yojin Milnrow
class YojinMilnrowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Milnrow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMilnrowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMilnrowProductService };
