// Configuration for Yojin Selside
// Store ID: 685541d721bb01b10405e562
// Location: Selside, LA8 9EE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d721bb01b10405e562',
    storeName: 'Yojin Selside',
    city: 'Selside',
    postcode: 'LA8 9EE',
...
// Product API Service for Yojin Selside
class YojinSelsideProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Selside:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSelsideProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSelsideProductService };
