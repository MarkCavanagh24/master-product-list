// Configuration for Yojin Oakhill
// Store ID: 6855425421bb01b10405e72b
// Location: Oakhill, BA4 4LB

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425421bb01b10405e72b',
    storeName: 'Yojin Oakhill',
    city: 'Oakhill',
    postcode: 'BA4 4LB',
...
// Product API Service for Yojin Oakhill
class YojinOakhillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Oakhill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOakhillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOakhillProductService };
