// Configuration for Yojin Helperby
// Store ID: 6855426d21bb01b10405e785
// Location: Helperby, YO61 2RF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426d21bb01b10405e785',
    storeName: 'Yojin Helperby',
    city: 'Helperby',
    postcode: 'YO61 2RF',
...
// Product API Service for Yojin Helperby
class YojinHelperbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Helperby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHelperbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHelperbyProductService };
