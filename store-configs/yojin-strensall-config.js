// Configuration for Yojin Strensall
// Store ID: 6855419b21bb01b10405e487
// Location: Strensall, YO32 5XZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419b21bb01b10405e487',
    storeName: 'Yojin Strensall',
    city: 'Strensall',
    postcode: 'YO32 5XZ',
...
// Product API Service for Yojin Strensall
class YojinStrensallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Strensall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStrensallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStrensallProductService };
