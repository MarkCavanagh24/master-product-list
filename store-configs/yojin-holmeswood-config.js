// Configuration for Yojin Holmeswood
// Store ID: 6855425d21bb01b10405e74d
// Location: Holmeswood, L40 1TZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425d21bb01b10405e74d',
    storeName: 'Yojin Holmeswood',
    city: 'Holmeswood',
    postcode: 'L40 1TZ',
...
// Product API Service for Yojin Holmeswood
class YojinHolmeswoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Holmeswood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHolmeswoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHolmeswoodProductService };
