// Configuration for Yojin Tottington
// Store ID: 6855426421bb01b10405e766
// Location: Tottington, BL8 3PU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426421bb01b10405e766',
    storeName: 'Yojin Tottington',
    city: 'Tottington',
    postcode: 'BL8 3PU',
...
// Product API Service for Yojin Tottington
class YojinTottingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Tottington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinTottingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinTottingtonProductService };
