// Configuration for Yojin Rushyford
// Store ID: 6855419621bb01b10405e472
// Location: Rushyford, DL17 0PY

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419621bb01b10405e472',
    storeName: 'Yojin Rushyford',
    city: 'Rushyford',
    postcode: 'DL17 0PY',
...
// Product API Service for Yojin Rushyford
class YojinRushyfordProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Rushyford:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinRushyfordProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinRushyfordProductService };
