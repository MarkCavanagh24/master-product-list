// Configuration for Yojin Spencers Wood
// Store ID: 6855428921bb01b10405e7ea
// Location: Spencers Wood, RG7 1PE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428921bb01b10405e7ea',
    storeName: 'Yojin Spencers Wood',
    city: 'Spencers Wood',
    postcode: 'RG7 1PE',
...
// Product API Service for Yojin Spencers Wood
class YojinSpencersWoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Spencers Wood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSpencersWoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSpencersWoodProductService };
