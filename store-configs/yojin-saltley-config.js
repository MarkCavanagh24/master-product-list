// Configuration for Yojin Saltley
// Store ID: 6855421b21bb01b10405e656
// Location: Saltley, B9 4TR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421b21bb01b10405e656',
    storeName: 'Yojin Saltley',
    city: 'Saltley',
    postcode: 'B9 4TR',
...
// Product API Service for Yojin Saltley
class YojinSaltleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Saltley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSaltleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSaltleyProductService };
