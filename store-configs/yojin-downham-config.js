// Configuration for Yojin Downham
// Store ID: 685541e521bb01b10405e597
// Location: Downham, CB6 2GP

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e521bb01b10405e597',
    storeName: 'Yojin Downham',
    city: 'Downham',
    postcode: 'CB6 2GP',
...
// Product API Service for Yojin Downham
class YojinDownhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Downham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDownhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDownhamProductService };
