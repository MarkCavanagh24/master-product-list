// Configuration for Yojin Lazonby
// Store ID: 6855418e21bb01b10405e457
// Location: Lazonby, CA10 1AX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418e21bb01b10405e457',
    storeName: 'Yojin Lazonby',
    city: 'Lazonby',
    postcode: 'CA10 1AX',
...
// Product API Service for Yojin Lazonby
class YojinLazonbyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lazonby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLazonbyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLazonbyProductService };
