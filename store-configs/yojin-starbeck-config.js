// Configuration for Yojin Starbeck
// Store ID: 6855419d21bb01b10405e48c
// Location: Starbeck, HG2 7LA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419d21bb01b10405e48c',
    storeName: 'Yojin Starbeck',
    city: 'Starbeck',
    postcode: 'HG2 7LA',
...
// Product API Service for Yojin Starbeck
class YojinStarbeckProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Starbeck:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStarbeckProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStarbeckProductService };
