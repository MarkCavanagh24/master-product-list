// Configuration for Yojin Huntington
// Store ID: 6855419e21bb01b10405e490
// Location: Huntington, YO32 9YD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419e21bb01b10405e490',
    storeName: 'Yojin Huntington',
    city: 'Huntington',
    postcode: 'YO32 9YD',
...
// Product API Service for Yojin Huntington
class YojinHuntingtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Huntington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHuntingtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHuntingtonProductService };
