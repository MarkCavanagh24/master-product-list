// Configuration for Yojin Bowburn
// Store ID: 6855419021bb01b10405e45e
// Location: Bowburn, DH6 5EE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419021bb01b10405e45e',
    storeName: 'Yojin Bowburn',
    city: 'Bowburn',
    postcode: 'DH6 5EE',
...
// Product API Service for Yojin Bowburn
class YojinBowburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bowburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBowburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBowburnProductService };
