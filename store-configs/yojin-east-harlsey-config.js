// Configuration for Yojin East Harlsey
// Store ID: 685541d921bb01b10405e56b
// Location: East Harlsey, DL6 2EE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d921bb01b10405e56b',
    storeName: 'Yojin East Harlsey',
    city: 'East Harlsey',
    postcode: 'DL6 2EE',
...
// Product API Service for Yojin East Harlsey
class YojinEastHarlseyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin East Harlsey:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEastHarlseyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEastHarlseyProductService };
