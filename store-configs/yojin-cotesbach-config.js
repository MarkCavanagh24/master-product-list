// Configuration for Yojin Cotesbach
// Store ID: 685541e021bb01b10405e585
// Location: Cotesbach, N/A

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e021bb01b10405e585',
    storeName: 'Yojin Cotesbach',
    city: 'Cotesbach',
    postcode: 'N/A',
...
// Product API Service for Yojin Cotesbach
class YojinCotesbachProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cotesbach:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCotesbachProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCotesbachProductService };
