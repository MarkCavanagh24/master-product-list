// Configuration for Yojin Newell Green
// Store ID: 6855424721bb01b10405e6fc
// Location: Newell Green, RG42 6AG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424721bb01b10405e6fc',
    storeName: 'Yojin Newell Green',
    city: 'Newell Green',
    postcode: 'RG42 6AG',
...
// Product API Service for Yojin Newell Green
class YojinNewellGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Newell Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNewellGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNewellGreenProductService };
