// Configuration for Yojin Wood Walton
// Store ID: 685541e421bb01b10405e591
// Location: Wood Walton, PE28 5YU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e421bb01b10405e591',
    storeName: 'Yojin Wood Walton',
    city: 'Wood Walton',
    postcode: 'PE28 5YU',
...
// Product API Service for Yojin Wood Walton
class YojinWoodWaltonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wood Walton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoodWaltonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoodWaltonProductService };
