// Configuration for Yojin Woodmansey
// Store ID: 685541bf21bb01b10405e509
// Location: Woodmansey, HU17 0ZT

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541bf21bb01b10405e509',
    storeName: 'Yojin Woodmansey',
    city: 'Woodmansey',
    postcode: 'HU17 0ZT',
...
// Product API Service for Yojin Woodmansey
class YojinWoodmanseyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Woodmansey:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoodmanseyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoodmanseyProductService };
