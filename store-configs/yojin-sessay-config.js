// Configuration for Yojin Sessay
// Store ID: 6855423021bb01b10405e6a8
// Location: Sessay, YO7 3JF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423021bb01b10405e6a8',
    storeName: 'Yojin Sessay',
    city: 'Sessay',
    postcode: 'YO7 3JF',
...
// Product API Service for Yojin Sessay
class YojinSessayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sessay:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSessayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSessayProductService };
