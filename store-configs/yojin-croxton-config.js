// Configuration for Yojin Croxton
// Store ID: 685541e621bb01b10405e599
// Location: Croxton, IP24 1LJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e621bb01b10405e599',
    storeName: 'Yojin Croxton',
    city: 'Croxton',
    postcode: 'IP24 1LJ',
...
// Product API Service for Yojin Croxton
class YojinCroxtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Croxton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCroxtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCroxtonProductService };
