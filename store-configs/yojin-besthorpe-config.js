// Configuration for Yojin Besthorpe
// Store ID: 6855421821bb01b10405e64b
// Location: Besthorpe, NR17 2LL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421821bb01b10405e64b',
    storeName: 'Yojin Besthorpe',
    city: 'Besthorpe',
    postcode: 'NR17 2LL',
...
// Product API Service for Yojin Besthorpe
class YojinBesthorpeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Besthorpe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBesthorpeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBesthorpeProductService };
