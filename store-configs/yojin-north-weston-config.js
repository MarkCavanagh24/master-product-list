// Configuration for Yojin North Weston
// Store ID: 685541f521bb01b10405e5d0
// Location: North Weston, BS20 6UZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541f521bb01b10405e5d0',
    storeName: 'Yojin North Weston',
    city: 'North Weston',
    postcode: 'BS20 6UZ',
...
// Product API Service for Yojin North Weston
class YojinNorthWestonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Weston:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthWestonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthWestonProductService };
