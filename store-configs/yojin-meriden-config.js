// Configuration for Yojin Meriden
// Store ID: 685541df21bb01b10405e57f
// Location: Meriden, CV7 7JQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541df21bb01b10405e57f',
    storeName: 'Yojin Meriden',
    city: 'Meriden',
    postcode: 'CV7 7JQ',
...
// Product API Service for Yojin Meriden
class YojinMeridenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Meriden:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMeridenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMeridenProductService };
