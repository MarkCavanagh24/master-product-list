// Configuration for Yojin Cowpen
// Store ID: 6855419821bb01b10405e47b
// Location: Cowpen, NE24 5QQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419821bb01b10405e47b',
    storeName: 'Yojin Cowpen',
    city: 'Cowpen',
    postcode: 'NE24 5QQ',
...
// Product API Service for Yojin Cowpen
class YojinCowpenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cowpen:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCowpenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCowpenProductService };
