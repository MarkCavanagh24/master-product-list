// Configuration for Yojin Stokesley
// Store ID: 685541d321bb01b10405e551
// Location: Stokesley, TS9 5FU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d321bb01b10405e551',
    storeName: 'Yojin Stokesley',
    city: 'Stokesley',
    postcode: 'TS9 5FU',
...
// Product API Service for Yojin Stokesley
class YojinStokesleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Stokesley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinStokesleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinStokesleyProductService };
