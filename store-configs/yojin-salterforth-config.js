// Configuration for Yojin Salterforth
// Store ID: 685541a321bb01b10405e4a4
// Location: Salterforth, BB18 6JD

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a321bb01b10405e4a4',
    storeName: 'Yojin Salterforth',
    city: 'Salterforth',
    postcode: 'BB18 6JD',
...
// Product API Service for Yojin Salterforth
class YojinSalterforthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Salterforth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSalterforthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSalterforthProductService };
