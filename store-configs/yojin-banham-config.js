// Configuration for Yojin Banham
// Store ID: 685541e721bb01b10405e59c
// Location: Banham, NR16 2DL

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541e721bb01b10405e59c',
    storeName: 'Yojin Banham',
    city: 'Banham',
    postcode: 'NR16 2DL',
...
// Product API Service for Yojin Banham
class YojinBanhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Banham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBanhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBanhamProductService };
