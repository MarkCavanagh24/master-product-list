// Configuration for Yojin Fulwood
// Store ID: 685541c021bb01b10405e50e
// Location: Fulwood, PR2 8RA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c021bb01b10405e50e',
    storeName: 'Yojin Fulwood',
    city: 'Fulwood',
    postcode: 'PR2 8RA',
...
// Product API Service for Yojin Fulwood
class YojinFulwoodProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Fulwood:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFulwoodProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFulwoodProductService };
