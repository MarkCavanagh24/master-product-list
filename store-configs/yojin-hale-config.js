// Configuration for Yojin Hale
// Store ID: 6855425721bb01b10405e736
// Location: Hale, GU9 9PR

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425721bb01b10405e736',
    storeName: 'Yojin Hale',
    city: 'Hale',
    postcode: 'GU9 9PR',
...
// Product API Service for Yojin Hale
class YojinHaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHaleProductService };
