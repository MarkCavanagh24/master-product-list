// Configuration for Yojin Alkborough
// Store ID: 6855425d21bb01b10405e74a
// Location: Alkborough, DN15 9JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425d21bb01b10405e74a',
    storeName: 'Yojin Alkborough',
    city: 'Alkborough',
    postcode: 'DN15 9JG',
...
// Product API Service for Yojin Alkborough
class YojinAlkboroughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Alkborough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAlkboroughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAlkboroughProductService };
