// Configuration for Yojin Lamesley
// Store ID: 6855418521bb01b10405e438
// Location: Lamesley, DH3 1QJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418521bb01b10405e438',
    storeName: 'Yojin Lamesley',
    city: 'Lamesley',
    postcode: 'DH3 1QJ',
...
// Product API Service for Yojin Lamesley
class YojinLamesleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lamesley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLamesleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLamesleyProductService };
