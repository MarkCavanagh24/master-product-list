// Configuration for Yojin Horbury
// Store ID: 6855425f21bb01b10405e755
// Location: Horbury, WF4 5EG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425f21bb01b10405e755',
    storeName: 'Yojin Horbury',
    city: 'Horbury',
    postcode: 'WF4 5EG',
...
// Product API Service for Yojin Horbury
class YojinHorburyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Horbury:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHorburyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHorburyProductService };
