// Configuration for Yojin Holcombe
// Store ID: 6855425e21bb01b10405e750
// Location: Holcombe, BL8 4NT

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425e21bb01b10405e750',
    storeName: 'Yojin Holcombe',
    city: 'Holcombe',
    postcode: 'BL8 4NT',
...
// Product API Service for Yojin Holcombe
class YojinHolcombeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Holcombe:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHolcombeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHolcombeProductService };
