// Configuration for Yojin Farcet
// Store ID: 685541d121bb01b10405e54a
// Location: Farcet, PE7 3DH

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541d121bb01b10405e54a',
    storeName: 'Yojin Farcet',
    city: 'Farcet',
    postcode: 'PE7 3DH',
...
// Product API Service for Yojin Farcet
class YojinFarcetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Farcet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinFarcetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinFarcetProductService };
