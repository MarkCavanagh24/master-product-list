// Configuration for Yojin North Deighton
// Store ID: 685541a021bb01b10405e498
// Location: North Deighton, LS22 4EY

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a021bb01b10405e498',
    storeName: 'Yojin North Deighton',
    city: 'North Deighton',
    postcode: 'LS22 4EY',
...
// Product API Service for Yojin North Deighton
class YojinNorthDeightonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Deighton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthDeightonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthDeightonProductService };
