// Configuration for Yojin Ufton Nervet
// Store ID: 6855428821bb01b10405e7e8
// Location: Ufton Nervet, RG7 4HF

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428821bb01b10405e7e8',
    storeName: 'Yojin Ufton Nervet',
    city: 'Ufton Nervet',
    postcode: 'RG7 4HF',
...
// Product API Service for Yojin Ufton Nervet
class YojinUftonNervetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Ufton Nervet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinUftonNervetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinUftonNervetProductService };
