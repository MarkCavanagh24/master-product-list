// Configuration for Yojin Eldon
// Store ID: 6855419521bb01b10405e471
// Location: Eldon, DL4 2QX

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419521bb01b10405e471',
    storeName: 'Yojin Eldon',
    city: 'Eldon',
    postcode: 'DL4 2QX',
...
// Product API Service for Yojin Eldon
class YojinEldonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Eldon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEldonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEldonProductService };
