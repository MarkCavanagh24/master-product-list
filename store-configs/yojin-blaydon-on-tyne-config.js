// Configuration for Yojin Blaydon on Tyne
// Store ID: 6855418121bb01b10405e429
// Location: Blaydon on Tyne, NE21 5GG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418121bb01b10405e429',
    storeName: 'Yojin Blaydon on Tyne',
...
// Product API Service for Yojin Blaydon on Tyne
class YojinBlaydononTyneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Blaydon on Tyne:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBlaydononTyneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBlaydononTyneProductService };
