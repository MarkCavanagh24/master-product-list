// Configuration for Yojin Smestow
// Store ID: 685541ca21bb01b10405e531
// Location: Smestow, WV5 8EX

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541ca21bb01b10405e531',
    storeName: 'Yojin Smestow',
    city: 'Smestow',
    postcode: 'WV5 8EX',
...
// Product API Service for Yojin Smestow
class YojinSmestowProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Smestow:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSmestowProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSmestowProductService };
