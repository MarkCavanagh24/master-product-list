// Configuration for Yojin Silverley's Green
// Store ID: 6855427c21bb01b10405e7bd
// Location: Silverley's Green, IP19 0DS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427c21bb01b10405e7bd',
    storeName: 'Yojin Silverley's Green',
...
// Product API Service for Yojin Silverley's Green
class YojinSilverleysGreenProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Silverley's Green:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSilverleysGreenProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSilverleysGreenProductService };
