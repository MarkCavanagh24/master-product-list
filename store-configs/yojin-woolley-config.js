// Configuration for Yojin Woolley
// Store ID: 6855427621bb01b10405e7a9
// Location: Woolley, PE28 0UD

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427621bb01b10405e7a9',
    storeName: 'Yojin Woolley',
    city: 'Woolley',
    postcode: 'PE28 0UD',
...
// Product API Service for Yojin Woolley
class YojinWoolleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Woolley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoolleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoolleyProductService };
