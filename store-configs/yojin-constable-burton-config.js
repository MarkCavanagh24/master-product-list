// Configuration for Yojin Constable Burton
// Store ID: 6855422421bb01b10405e678
// Location: Constable Burton, DL8 5RN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422421bb01b10405e678',
    storeName: 'Yojin Constable Burton',
    city: 'Constable Burton',
    postcode: 'DL8 5RN',
...
// Product API Service for Yojin Constable Burton
class YojinConstableBurtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Constable Burton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinConstableBurtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinConstableBurtonProductService };
