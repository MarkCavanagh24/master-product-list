// Configuration for Yojin Bromham
// Store ID: 6855428721bb01b10405e7e3
// Location: Bromham, SN15 2PS

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428721bb01b10405e7e3',
    storeName: 'Yojin Bromham',
    city: 'Bromham',
    postcode: 'SN15 2PS',
...
// Product API Service for Yojin Bromham
class YojinBromhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bromham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBromhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBromhamProductService };
