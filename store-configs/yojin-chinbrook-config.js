// Configuration for Yojin Chinbrook
// Store ID: 6855424a21bb01b10405e707
// Location: Chinbrook, SE12 0BE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855424a21bb01b10405e707',
    storeName: 'Yojin Chinbrook',
    city: 'Chinbrook',
    postcode: 'SE12 0BE',
...
// Product API Service for Yojin Chinbrook
class YojinChinbrookProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Chinbrook:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinChinbrookProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinChinbrookProductService };
