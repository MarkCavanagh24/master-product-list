// Configuration for Yojin North Northamptonshire
// Store ID: 6855421e21bb01b10405e664
// Location: North Northamptonshire, PE8 4EZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421e21bb01b10405e664',
    storeName: 'Yojin North Northamptonshire',
...
// Product API Service for Yojin North Northamptonshire
class YojinNorthNorthamptonshireProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin North Northamptonshire:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNorthNorthamptonshireProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNorthNorthamptonshireProductService };
