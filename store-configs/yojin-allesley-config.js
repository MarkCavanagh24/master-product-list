// Configuration for Yojin Allesley
// Store ID: 685541df21bb01b10405e580
// Location: Allesley, CV5 9BU

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541df21bb01b10405e580',
    storeName: 'Yojin Allesley',
    city: 'Allesley',
    postcode: 'CV5 9BU',
...
// Product API Service for Yojin Allesley
class YojinAllesleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Allesley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinAllesleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinAllesleyProductService };
