// Configuration for Yojin Cleadon
// Store ID: 6855418221bb01b10405e42d
// Location: Cleadon, SR6 7TG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418221bb01b10405e42d',
    storeName: 'Yojin Cleadon',
    city: 'Cleadon',
    postcode: 'SR6 7TG',
...
// Product API Service for Yojin Cleadon
class YojinCleadonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Cleadon:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCleadonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCleadonProductService };
