// Configuration for Yojin Low Arkendale
// Store ID: 6855419b21bb01b10405e485
// Location: Low Arkendale, HG5 0TQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419b21bb01b10405e485',
    storeName: 'Yojin Low Arkendale',
    city: 'Low Arkendale',
    postcode: 'HG5 0TQ',
...
// Product API Service for Yojin Low Arkendale
class YojinLowArkendaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Low Arkendale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLowArkendaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLowArkendaleProductService };
