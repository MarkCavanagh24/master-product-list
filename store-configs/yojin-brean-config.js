// Configuration for Yojin Brean
// Store ID: 685541fa21bb01b10405e5e2
// Location: Brean, TA8 2RN

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fa21bb01b10405e5e2',
    storeName: 'Yojin Brean',
    city: 'Brean',
    postcode: 'TA8 2RN',
...
// Product API Service for Yojin Brean
class YojinBreanProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brean:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBreanProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBreanProductService };
