// Configuration for Yojin Naseby
// Store ID: 6855423321bb01b10405e6b0
// Location: Naseby, NN6 6DN

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423321bb01b10405e6b0',
    storeName: 'Yojin Naseby',
    city: 'Naseby',
    postcode: 'NN6 6DN',
...
// Product API Service for Yojin Naseby
class YojinNasebyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Naseby:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinNasebyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinNasebyProductService };
