// Configuration for Yojin Wyke
// Store ID: 6855420f21bb01b10405e62b
// Location: Wyke, BD12 9EA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420f21bb01b10405e62b',
    storeName: 'Yojin Wyke',
    city: 'Wyke',
    postcode: 'BD12 9EA',
...
// Product API Service for Yojin Wyke
class YojinWykeProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Wyke:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWykeProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWykeProductService };
