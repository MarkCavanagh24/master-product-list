// Configuration for Yojin Middlestone Moor
// Store ID: 6855419221bb01b10405e467
// Location: Middlestone Moor, DL16 7TU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419221bb01b10405e467',
    storeName: 'Yojin Middlestone Moor',
    city: 'Middlestone Moor',
    postcode: 'DL16 7TU',
...
// Product API Service for Yojin Middlestone Moor
class YojinMiddlestoneMoorProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Middlestone Moor:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMiddlestoneMoorProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMiddlestoneMoorProductService };
