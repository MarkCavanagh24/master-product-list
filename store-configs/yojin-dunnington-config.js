// Configuration for Yojin Dunnington
// Store ID: 685541a121bb01b10405e49d
// Location: Dunnington, YO19 5SE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541a121bb01b10405e49d',
    storeName: 'Yojin Dunnington',
    city: 'Dunnington',
    postcode: 'YO19 5SE',
...
// Product API Service for Yojin Dunnington
class YojinDunningtonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Dunnington:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDunningtonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDunningtonProductService };
