// Configuration for Yojin Gillingham
// Store ID: 6855422221bb01b10405e673
// Location: Gillingham, NR34 0EE

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422221bb01b10405e673',
    storeName: 'Yojin Gillingham',
    city: 'Gillingham',
    postcode: 'NR34 0EE',
...
// Product API Service for Yojin Gillingham
class YojinGillinghamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Gillingham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinGillinghamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinGillinghamProductService };
