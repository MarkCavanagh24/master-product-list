// Configuration for Yojin Denholme Clough
// Store ID: 685541c221bb01b10405e516
// Location: Denholme Clough, BD13 4FE

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c221bb01b10405e516',
    storeName: 'Yojin Denholme Clough',
...
// Product API Service for Yojin Denholme Clough
class YojinDenholmeCloughProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Denholme Clough:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinDenholmeCloughProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinDenholmeCloughProductService };
