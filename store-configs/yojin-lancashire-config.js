// Configuration for Yojin Lancashire
// Store ID: 6855427421bb01b10405e7a0
// Location: Lancashire, LA3 2JU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855427421bb01b10405e7a0',
    storeName: 'Yojin Lancashire',
    city: 'Lancashire',
    postcode: 'LA3 2JU',
...
// Product API Service for Yojin Lancashire
class YojinLancashireProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Lancashire:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLancashireProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLancashireProductService };
