// Configuration for Yojin Crondall
// Store ID: 6855425721bb01b10405e735
// Location: Crondall, GU10 5HL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855425721bb01b10405e735',
    storeName: 'Yojin Crondall',
    city: 'Crondall',
    postcode: 'GU10 5HL',
...
// Product API Service for Yojin Crondall
class YojinCrondallProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Crondall:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinCrondallProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinCrondallProductService };
