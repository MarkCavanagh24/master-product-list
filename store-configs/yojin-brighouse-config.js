// Configuration for Yojin Brighouse
// Store ID: 6855421521bb01b10405e643
// Location: Brighouse, HD6 1QA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855421521bb01b10405e643',
    storeName: 'Yojin Brighouse',
    city: 'Brighouse',
    postcode: 'HD6 1QA',
...
// Product API Service for Yojin Brighouse
class YojinBrighouseProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Brighouse:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBrighouseProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBrighouseProductService };
