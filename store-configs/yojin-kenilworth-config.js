// Configuration for Yojin Kenilworth
// Store ID: 6855423b21bb01b10405e6d0
// Location: Kenilworth, CV8 1NG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855423b21bb01b10405e6d0',
    storeName: 'Yojin Kenilworth',
    city: 'Kenilworth',
    postcode: 'CV8 1NG',
...
// Product API Service for Yojin Kenilworth
class YojinKenilworthProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Kenilworth:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinKenilworthProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinKenilworthProductService };
