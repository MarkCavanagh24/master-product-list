// Configuration for Yojin Overstone
// Store ID: 6855428221bb01b10405e7d3
// Location: Overstone, NN3 7XA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855428221bb01b10405e7d3',
    storeName: 'Yojin Overstone',
    city: 'Overstone',
    postcode: 'NN3 7XA',
...
// Product API Service for Yojin Overstone
class YojinOverstoneProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Overstone:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinOverstoneProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinOverstoneProductService };
