// Configuration for Yojin Easingwold
// Store ID: 6855426d21bb01b10405e787
// Location: Easingwold, YO61 4TL

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855426d21bb01b10405e787',
    storeName: 'Yojin Easingwold',
    city: 'Easingwold',
    postcode: 'YO61 4TL',
...
// Product API Service for Yojin Easingwold
class YojinEasingwoldProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Easingwold:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinEasingwoldProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinEasingwoldProductService };
