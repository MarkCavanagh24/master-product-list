// Configuration for Yojin Moor Monkton
// Store ID: 6855419e21bb01b10405e48e
// Location: Moor Monkton, YO26 8JQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419e21bb01b10405e48e',
    storeName: 'Yojin Moor Monkton',
    city: 'Moor Monkton',
    postcode: 'YO26 8JQ',
...
// Product API Service for Yojin Moor Monkton
class YojinMoorMonktonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Moor Monkton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinMoorMonktonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinMoorMonktonProductService };
