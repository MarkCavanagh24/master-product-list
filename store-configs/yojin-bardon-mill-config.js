// Configuration for Yojin Bardon Mill
// Store ID: 6855417c21bb01b10405e414
// Location: Bardon Mill, NE47 6NJ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855417c21bb01b10405e414',
    storeName: 'Yojin Bardon Mill',
    city: 'Bardon Mill',
    postcode: 'NE47 6NJ',
...
// Product API Service for Yojin Bardon Mill
class YojinBardonMillProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Bardon Mill:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBardonMillProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBardonMillProductService };
