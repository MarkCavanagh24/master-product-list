// Configuration for Yojin Sherburn in Elmet
// Store ID: 6855420a21bb01b10405e619
// Location: Sherburn in Elmet, LS25 9AU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855420a21bb01b10405e619',
    storeName: 'Yojin Sherburn in Elmet',
...
// Product API Service for Yojin Sherburn in Elmet
class YojinSherburninElmetProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Sherburn in Elmet:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSherburninElmetProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSherburninElmetProductService };
