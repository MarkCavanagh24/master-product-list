// Configuration for Yojin Burton-in-Kendal
// Store ID: 6855422e21bb01b10405e6a1
// Location: Burton-in-Kendal, LA6 1JG

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422e21bb01b10405e6a1',
    storeName: 'Yojin Burton-in-Kendal',
    city: 'Burton-in-Kendal',
    postcode: 'LA6 1JG',
...
// Product API Service for Yojin Burton-in-Kendal
class YojinBurtoninKendalProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Burton-in-Kendal:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinBurtoninKendalProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinBurtoninKendalProductService };
