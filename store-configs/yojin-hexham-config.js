// Configuration for Yojin Hexham
// Store ID: 6855418021bb01b10405e424
// Location: Hexham, NE46 1SA

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855418021bb01b10405e424',
    storeName: 'Yojin Hexham',
    city: 'Hexham',
    postcode: 'NE46 1SA',
...
// Product API Service for Yojin Hexham
class YojinHexhamProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Hexham:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinHexhamProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinHexhamProductService };
