// Configuration for Yojin Leyburn
// Store ID: 685541de21bb01b10405e57d
// Location: Leyburn, DL8 5HF

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541de21bb01b10405e57d',
    storeName: 'Yojin Leyburn',
    city: 'Leyburn',
    postcode: 'DL8 5HF',
...
// Product API Service for Yojin Leyburn
class YojinLeyburnProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Leyburn:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinLeyburnProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinLeyburnProductService };
