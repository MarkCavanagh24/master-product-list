// Configuration for Yojin Skipton on Swale
// Store ID: 6855422c21bb01b10405e696
// Location: Skipton on Swale, YO7 4HU

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855422c21bb01b10405e696',
    storeName: 'Yojin Skipton on Swale',
    city: 'Skipton on Swale',
    postcode: 'YO7 4HU',
...
// Product API Service for Yojin Skipton on Swale
class YojinSkiptononSwaleProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Skipton on Swale:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinSkiptononSwaleProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinSkiptononSwaleProductService };
