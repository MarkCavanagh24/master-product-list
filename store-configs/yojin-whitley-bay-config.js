// Configuration for Yojin Whitley Bay
// Store ID: 6855419a21bb01b10405e483
// Location: Whitley Bay, NE25 9HZ

const STORE_CONFIG = {
    // Store Identity
    storeId: '6855419a21bb01b10405e483',
    storeName: 'Yojin Whitley Bay',
    city: 'Whitley Bay',
    postcode: 'NE25 9HZ',
...
// Product API Service for Yojin Whitley Bay
class YojinWhitleyBayProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Whitley Bay:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWhitleyBayProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWhitleyBayProductService };
