// Configuration for Yojin Woolverton
// Store ID: 685541fb21bb01b10405e5e6
// Location: Woolverton, BA2 7RQ

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541fb21bb01b10405e5e6',
    storeName: 'Yojin Woolverton',
    city: 'Woolverton',
    postcode: 'BA2 7RQ',
...
// Product API Service for Yojin Woolverton
class YojinWoolvertonProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Woolverton:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinWoolvertonProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinWoolvertonProductService };
