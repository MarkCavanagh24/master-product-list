// Configuration for Yojin Claverley
// Store ID: 685541c921bb01b10405e52f
// Location: Claverley, WV15 6EA

const STORE_CONFIG = {
    // Store Identity
    storeId: '685541c921bb01b10405e52f',
    storeName: 'Yojin Claverley',
    city: 'Claverley',
    postcode: 'WV15 6EA',
...
// Product API Service for Yojin Claverley
class YojinClaverleyProductService {
    constructor() {
    ...
    async getProducts(page = 1, filters = {}) {
        ...
        try {
            ...
            console.error('Failed to load products for Yojin Claverley:', error);
            throw error;
        }
    }
...
// Usage Example:
// const productService = new YojinClaverleyProductService();
// productService.getProducts().then(data => console.log(data));

module.exports = { STORE_CONFIG, YojinClaverleyProductService };
